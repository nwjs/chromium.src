...
#  
#  This DEPS file corresponds to Chromium 36.0.1980.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@6f364c5b8c1579fb1007a3d7bede2cd03fc88db4',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@268647',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1980@173542',
   'src/breakpad/src':
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13150',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13150',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@80',
   'build':
      '/trunk/tools/build@268805',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1912',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@cc14f104b55a37b55face38116f01ea56c7927b8',
   'src/v8':
      Var("v8") + '/trunk@21152',
