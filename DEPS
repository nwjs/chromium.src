...
#  
#  This DEPS file corresponds to Chromium 31.0.1638.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@f47cdada572e5f47f54cd8ae3a1835b6631c6cd5',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1638@158154',
