...
#  
#  This DEPS file corresponds to Chromium 17.0.943.0
#  
#  
#  
...
deps = {
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@2705',
   ...
   'src/third_party/skia/third_party/glu':
      'http://skia.googlecode.com/svn/trunk/third_party/glu@2705',
   'src/breakpad/src':
   ...
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@2705',
   'build':
      '/trunk/tools/build@110676',
