...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@7b462a2b8564f9f4ad621b36541125cff36515a8',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@0a7f93e74ac93aa92fef7104bbc35ee833394233',
  'src/breakpad/src':
