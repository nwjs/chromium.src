vars = {
  'angle_revision':
    '14389ccf7ea45be0caefa5520db35c5a12971be3',
  'boringssl_revision':
    '209b2562235f7dab66b8260624e7b3c5b00d14a6',
  'buildspec_platforms':
    'all',
  'buildtools_revision':
  ...
  'libvpx_revision':
    'd5c834797554016ff9eee05da9f3e4c1fd4fd819',
  'lighttpd_revision':
    '9dfa55d15937a688a92cbf2b7a8621b0927d06eb',
  'lss_revision':
    '6f97298fe3794e92c8c896a6bc06e0b36e4c3de3',
  'nacl_revision':
    'caa564940c868bafc10dfed531a7a123bd4fa17d',
  'nss_revision':
    'aab0d08a298b29407397fbb1c4219f99e99431ed',
  'openmax_dl_revision':
    '22bb1085a6a0f6f3589a8c3d60ed0a9b82248275',
  'pdfium_revision':
    'd1a588c6ce03425773594381a0966434016813b1',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    'f597c42c50718d5c39769077040de1768c89bbd3',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    '77bf7988b93176f08b325073bb1cad0f436c5769',
  'webkit_revision':
    '817c81ee96b4d35846b9af3cd8be5238a1906bba'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@f0b8022601cf9c3c1a2f7efcea48e2fe81d3b143',
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@caa564940c868bafc10dfed531a7a123bd4fa17d',
  ...
  'src/testing/gtest':
    (Var("chromium_git")) + '/external/googletest.git@00a70a9667d92a4695d84e4fa36b64f611f147da',
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@817c81ee96b4d35846b9af3cd8be5238a1906bba',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@14389ccf7ea45be0caefa5520db35c5a12971be3',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@209b2562235f7dab66b8260624e7b3c5b00d14a6',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@cfe0cc1196882065e4a1cc859e3d56e69088521e',
  ...
  'src/third_party/libvpx':
    (Var("chromium_git")) + '/chromium/deps/libvpx.git@d5c834797554016ff9eee05da9f3e4c1fd4fd819',
  'src/third_party/libwebm/source':
    (Var("chromium_git")) + '/webm/libwebm.git@75a6d2da8b63e0c446ec0ce1ac942c2962d959d7',
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@3a3a89ccd40764579077e93bc303564c873aa7c1',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@d1a588c6ce03425773594381a0966434016813b1',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@f597c42c50718d5c39769077040de1768c89bbd3',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@589fc70fc8b616278a44c300ed45761f8f395d5b',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@77bf7988b93176f08b325073bb1cad0f436c5769'
}
