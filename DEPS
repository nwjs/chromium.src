...
#  
#  This DEPS file corresponds to Chromium 37.0.1994.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@4ed1247ea3bfa05e51607e8ae819817404f80e4d',
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@aabf2a28449fe47dedeee51d3570ff8687ff015f',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@270572',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1994@174089',
   'src/breakpad/src':
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@6f182c12db67a4958fa5103e7602f13bca3ad9b6',
   'src/v8':
      Var("v8") + '/trunk@21152',
