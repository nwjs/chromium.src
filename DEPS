...
#  
#  This DEPS file corresponds to Chromium 36.0.1923.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@74a4c7314f9a639418d1e1074139de1be1d33f9d',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@261264',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1923@170725',
   'src/third_party/icu':
