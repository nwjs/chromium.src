...
#  
#  This DEPS file corresponds to Chromium 31.0.1632.7
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@5c3c178ae49800ca64f5c5e8e469504e861da027',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1632@157880',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11288',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@223474',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@75',
   'src/third_party/libsrtp':
