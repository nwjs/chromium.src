...
#  
#  This DEPS file corresponds to Chromium 36.0.1948.4
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@aaa614c9521c705071737f840f68d1262036bebe',
      'build/third_party/xvfb':
      '/trunk/tools/third_party/xvfb@125214',
      'src/third_party/undoview':
      '/trunk/deps/third_party/undoview@119694',
      'src/third_party/cros_system_api':
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@916c5d850ca4424b1de79e9e1054f34a23ee2e33',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@55cdc945ae481792d7392e1e012c466fb4a1a883',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@264753',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1948@171945',
   'src/breakpad/src':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@264320',
   'src/third_party/swig/Lib':
