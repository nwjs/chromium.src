...
#  
#  This DEPS file corresponds to Chromium 33.0.1718.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@afa4f5fc7f2d69fc5f739ba6e0b92eb784b8cb0c',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1718@162584',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12355',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@236950',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
