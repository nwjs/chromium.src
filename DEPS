...
#  
#  This DEPS file corresponds to Chromium 35.0.1881.13
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@2058',
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@254867',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@75fde3bee12bc3f5dd04ef35de0bdbba09a8fadc',
      'src/third_party/cros_system_api':
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@cca4793e883a03da9d472dbe0712104d49119b00',
      'src/third_party/pyelftools':
      Var("git.chromium.org") + '/chromiumos/third_party/pyelftools.git@bdc1d380acd88d4bfaf47265008091483b0d614e',
      'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@253925',
...
deps = {
   ...
   'src/third_party/libc++/trunk':
      'http://src.chromium.org/llvm-project/libcxx/trunk@197314',
   'src/third_party/skia/include':
      Var("skia") + '/trunk/include@13700',
   'src/third_party/libc++abi/trunk':
      'http://src.chromium.org/llvm-project/libcxxabi/trunk@197063',
   ...
   'src/third_party/brotli/src':
      Var("git.chromium.org") + '/external/font-compression-reference.git@7f848593bd2ec83f4537b6d494a5bf55b9bd4456',
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@330',
   'src/chrome/test/data/perf/third_party/octane':
      Var("octane-benchmark") + '/trunk@19',
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@13700',
   'src/third_party/scons-2.0.1':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@255696',
   'src/third_party/bidichecker':
   ...
   'src/third_party/openmax_dl':
      Var("webrtc") + '/deps/third_party/openmax@5569',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/third_party/clang_format/script':
      'http://src.chromium.org/llvm-project/cfe/trunk/tools/clang-format@202065',
   'src/third_party/WebKit/LayoutTests/w3c/web-platform-tests':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13700',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12835',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@151',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@544',
   'build/scripts/tools/deps2git':
      '/trunk/tools/deps2git@255546',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12835',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@255792',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1860',
   'src/chrome/test/data/perf/canvas_bench':
      '/trunk/deps/canvas_bench@122605',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@255431',
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/trunk/talk@5645',
   'src/third_party/usrsctp/usrsctplib':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1881@168811',
   'src/third_party/icu':
   ...
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@155',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@dd806d645e711260c24bf7a2f061d6db091c3715',
   'src/chrome/browser/resources/pdf/html_office':
      Var("git.chromium.org") + '/chromium/html-office-public.git@9f76cc282c471ae4ff77415384db039fcab2faa8',
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@fa63e947cb3eccf463648d21a05d5002c9b8adfa',
   'src/v8':
      Var("v8") + '/trunk@19696',
   'src/third_party/libwebm/source':
      Var("git.chromium.org") + '/webm/libwebm.git@0f7815b036651e242ec8c2fcfb59fe54f69be1a8',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@255744',
   'src/third_party/swig/Lib':
