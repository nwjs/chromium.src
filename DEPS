...
#  
#  This DEPS file corresponds to Chromium 32.0.1700.106
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1700@165586',
   'src/tools/deps2git':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m32_1700/src@13123',
   'src/third_party/webpagereplay':
