...
#  
#  This DEPS file corresponds to Chromium 33.0.1702.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@36f8dd9d5ca29255c986c987b27b27993129c850',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@233166',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1702@161486',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@5088',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1702/src@233485',
   ...
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1231',
   'src/media/cdm/ppapi/api':
