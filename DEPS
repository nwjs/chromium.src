vars = {
  'angle_revision':
    'd544cc9ff4a48adb2b0013e8abc9b9dd51bc8d18',
  'boringssl_revision':
    '6c22f542f42eccb0de7f43edf27aa1255c7be7e2',
  'buildspec_platforms':
    'all',
  'buildtools_revision':
    'cf8c4332f5c9d0da4b4782d7f0122df74a16819b',
  'chromium_git':
  ...
  'nacl_revision':
    '70e59b1418408063248bbbe2f940894faab4c26a',
  'nss_revision':
    '225bfc39c93dfb7c7d0d1162f81e9bb5cd356c30',
  'openmax_dl_revision':
    '6670e52d32351145a6b6c198dab3f6a536edf3db',
  'pdfium_revision':
    '4a2aa1a90d89b88036b0bff432ffefa183ea80d0',
  'sfntly_revision':
  ...
  'v8_revision':
    'a900c51da4676b9119c1d94c93beb0849b02f028'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@cf8c4332f5c9d0da4b4782d7f0122df74a16819b',
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@70e59b1418408063248bbbe2f940894faab4c26a',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@d544cc9ff4a48adb2b0013e8abc9b9dd51bc8d18',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@6c22f542f42eccb0de7f43edf27aa1255c7be7e2',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@2aff6ec44738e47011076cd94d038e22952b3b85',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@16d7ba3b9dd89648204e1fe279d927e1d41c5fac',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@4a2aa1a90d89b88036b0bff432ffefa183ea80d0',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@2a2bdc698460c38ac9e24ba4abdeefec67bcba37',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@6f757147d5d1b12085acd824a95c21e66d7549fd',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@a900c51da4676b9119c1d94c93beb0849b02f028'
}
