...
#  
#  This DEPS file corresponds to Chromium 35.0.1912.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@f3a955e38b439238f7d48c3053507be3138f1a86',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@259761',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1912@170125',
   'src/third_party/icu':
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@740a2f8daa9cc45c53ecf7333c3ae5aa64c821f8',
   'src/v8':
      Var("v8") + '/trunk@20277',
