...
#  
#  This DEPS file corresponds to Chromium 13.0.782.104
#  
#  
#  
deps_os = {
   ...
   'mac': {
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/branches/chromium/782/WebKitLibraries@91575',
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      'src/third_party/WebKit/Tools/gdb':
         'http://svn.webkit.org/repository/webkit/branches/chromium/782/Tools/gdb@91575',
      'src/third_party/lss':
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/http/tests/xmlhttprequest@91575',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/platform/chromium/fast/workers@91575',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/fast/js/resources@91575',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/platform/chromium-mac/http/tests/workers@91575',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/http/tests/resources@91575',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/filesystem':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/http/tests/filesystem@91575',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/fast/events@91575',
   'src/third_party/bidichecker':
      'http://bidichecker.googlecode.com/svn/trunk/lib@4',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/fast/workers@91575',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/http/tests/workers@91575',
   'src/testing/gmock':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/fast/filesystem/workers@91575',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/platform/chromium-win/storage/domstorage@91575',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@19546',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/fast/filesystem/resources@91575',
   'src/build/util/support':
      '/trunk/deps/support@20411',
   'src/third_party/libjingle/source':
      'http://libjingle.googlecode.com/svn/trunk@63',
   'src':
      '/branches/782/src@93826',
   'src/third_party/WebKit/Tools/DumpRenderTree':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/Tools/DumpRenderTree@91575',
   'src/third_party/hunspell':
      '/trunk/deps/third_party/hunspell@65351',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/appcache':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/http/tests/appcache@91575',
   'src/testing/gtest':
      'http://googletest.googlecode.com/svn/trunk@560',
   'src/v8':
      'http://v8.googlecode.com/svn/branches/3.3@8711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/platform/chromium-win/fast/events@91575',
   ...
   'src/third_party/WebKit/Source':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/Source@91575',
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests@91575',
   'src/third_party/snappy/src':
      'http://snappy.googlecode.com/svn/trunk@37',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/http/tests/websocket/tests@91575',
   'src/chrome/test/data/layout_tests/LayoutTests/media':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/media@91575',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/fast/events':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/platform/chromium-mac/fast/events@91575',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/platform/chromium-mac/storage/domstorage@91575',
   'src/tools/gyp':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/platform/chromium-win/fast/workers@91575',
   'src/third_party/WebKit/Tools/Scripts':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/Tools/Scripts@91575',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/storage/domstorage@91575',
   'src/third_party/icu':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/782/LayoutTests/platform/chromium-win/http/tests/workers@91575',
