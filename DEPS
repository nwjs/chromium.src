  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@47321892c26df281f9456f0a200c336a31059190',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@278490',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2060@176584',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@30e6e2af14e84216b1c113fd7500d0822bc81daa',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13377',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13377',
