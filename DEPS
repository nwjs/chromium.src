...
#  
#  This DEPS file corresponds to Chromium 29.0.1539.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@4666eb83f77cf8815246e31f745d918c6dff3422',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1539@152489',
