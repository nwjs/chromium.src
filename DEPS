...
#  
#  This DEPS file corresponds to Chromium 36.0.1968.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@b35e305e2348af2be22b633cfb25e176601cb821',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@f1a07618f1ad4e1a0301a9eccc5dfde1a720a42a',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@267379',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1968@173059',
   'src/breakpad/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@14458',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13106',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13106',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@267368',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1895',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@66c1861d7bd0ee72150d1f78ad4fb48e0e9cfde6',
