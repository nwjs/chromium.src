...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@9d6ea04cae8e3680d76f9e6ddb72b1d5e05de885',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293930',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@2340dcb02c683885707a24ed6ecd7732c29735dc',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@e8fbd4b6737a83a082f3de3b713a6f48cadd3e37',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@615082de70c7fc18d46d0d1a03b62d0d76b1daa9',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@b0b997f2aefa94b83012d2e8381dba8fc9daacfe',
