...
#  
#  This DEPS file corresponds to Chromium 30.0.1584.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@c88035df36ef598fada14dad6132c447eedf5295',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1584@155378',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10475',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@215143',
   'src/third_party/libsrtp':
