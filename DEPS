...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@1cba7fdd447c6482f4c51e8c4ea613ce3c8b6d31',
    'src/third_party/lss':
  ...
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@8fe116f93f350dcf73c6fe70db893985bf1b91d5',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293357',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@0ac8c786a537e4a619c1fd78bc6532992a1ef542',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@7b98b0fc40ec9bdc379b9d8353bf9b669409757b',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu.git@b0932a04c79198b0fd44282304eb48a5c1850ea3',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@c996f78fd11b4162ba83344d927756e90e8f3582',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@50be7f2fc13d2007067f2f3ee732ddc0d2702b84',
