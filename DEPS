...
#  
#  This DEPS file corresponds to Chromium 32.0.1700.35
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@231937',
   },
   'mac': {
      'src/third_party/GTM':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1700@162803',
