...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@0bf557d77a4b7089750961035c09dc2cda8551a2',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@64b309c35bfddb8382c3e38f1d8ff7efe4098cab',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@322689b2d2888412e4255b264b87b692c41a2ced'
}
