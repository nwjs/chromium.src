...
#  
#  This DEPS file corresponds to Chromium 35.0.1916.69
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1916/public@172278',
      'src/native_client':
      None,
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1916@172278',
   'src/third_party/icu':
