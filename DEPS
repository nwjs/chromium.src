...
#  
#  This DEPS file corresponds to Chromium 34.0.1794.2
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@1992',
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@245298',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@6888043b99e0ea7ec10becd38e5241467c48e8cb',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src':
      '/branches/1794/src@245814',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@949',
   'src/third_party/hunspell':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@245704',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@245112',
   'src/breakpad/src':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1794@165369',
   'src/third_party/icu':
   ...
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@e4a780b1541594fb93be947d077712708f0a7f95',
   'src/third_party/angle':
