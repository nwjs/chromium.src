  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@6ef898bdf40384100b5f3a4899b2de0382409c11',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@271571',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13199',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13199',
  'src/third_party/leveldatabase/src':
    (Var("leveldb")) + '/trunk@80',
  'build':
    '/trunk/tools/build@271891',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@d3a060bd1d6a4f43e9bc7d07f193b0513df4f244',
  'src/third_party/skia/gyp':
    (Var("skia")) + '/trunk/gyp@14765',
  'src/buildtools':
  ...
  'src/third_party/openssl':
    '/trunk/deps/third_party/openssl@270417',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2007@174456',
  'src/third_party/icu':
