vars = {
  'angle_revision':
    '3975ddec952c8910e0854d0b40c0f96955b018fb',
  'boringssl_revision':
    'b0acb7743f6c1e4b8307b5898598be4f13095f49',
  'buildspec_platforms':
    'win-pgo,',
  'buildtools_revision':
    'fa660d47fa1a6c649d5c29e001348447c55709e6',
  'chromium_git':
  ...
  'nacl_revision':
    '22fcd7c6a995b92434432aafe8ba49858bd7f5d3',
  'nss_revision':
    'aab0d08a298b29407397fbb1c4219f99e99431ed',
  'openmax_dl_revision':
    '22bb1085a6a0f6f3589a8c3d60ed0a9b82248275',
  'pdfium_revision':
    '6f0a64a1bf18ab6636404cdfb883897459083a4d',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    '921827bbc78717f514ebd11bf55ac0dd2fe9308c',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    'fffc68e8cae31678d198db13d72f92632b825bf5',
  'webkit_revision':
    'b064da1ddb0040b2fc4bf30a5b1e7e42467e9c86'
}
...
deps = {
  'src/breakpad/src':
    (Var("chromium_git")) + '/external/google-breakpad/src.git@d7e4030ff7d38e0d88d7ca39c1c1222940bfb3b7',
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@fa660d47fa1a6c649d5c29e001348447c55709e6',
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@22fcd7c6a995b92434432aafe8ba49858bd7f5d3',
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@9e70ac5275092339c3469e69170ba2d94e221e4e',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@3975ddec952c8910e0854d0b40c0f96955b018fb',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@b0acb7743f6c1e4b8307b5898598be4f13095f49',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@9602631f8667fd9a96edb157954a0dfadea6b5d2',
  ...
  'src/third_party/libvpx':
    (Var("chromium_git")) + '/chromium/deps/libvpx.git@db3f34772338a7e02fc5a7fb9da4d72de68e71b9',
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@632c50f29cdacb8c5872ce9938444b676b4a0c81',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@921827bbc78717f514ebd11bf55ac0dd2fe9308c',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@407258cf782b0a8c24819835561a0a709ec70873',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@fffc68e8cae31678d198db13d72f92632b825bf5'
}
