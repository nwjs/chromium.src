...
#  
#  This DEPS file corresponds to Chromium 34.0.1827.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@d693be3a49b11718f2d47a9f3350be2945d8561b',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@249277',
   'src/third_party/bidichecker':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13333',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12710',
   'src/third_party/smhasher/src':
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12710',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@78',
   'build':
      '/trunk/tools/build@249558',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1846',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1827@166676',
   'src/third_party/icu':
