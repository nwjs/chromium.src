...
#  
#  This DEPS file corresponds to Chromium 28.0.1494.8
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@197158',
   },
   'mac': {
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/Tools/gdb@149428',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@74c76b1a32e5f44563d9136d3fe5588831b55769',
      'src/third_party/lss':
...
deps = {
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@197097',
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/storage/indexeddb@149428',
   'src/sandbox/linux/seccomp-legacy':
      Var("seccompsandbox") + '/trunk@189',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/http/tests/appcache@149428',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@309',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/platform/chromium-win/http/tests/workers@149428',
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/http/tests/workers@149428',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/fast/workers@149428',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/media@149428',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/webkit/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@181763',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/storage/domstorage@149428',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@74',
   'src/content/test/data/layout_tests/LayoutTests/editing/pasteboard/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/editing/pasteboard/resources@149428',
   'src/tools/deps2git':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@197190',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@197256',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1155',
   'src/third_party/openmax_dl':
      Var("webrtc") + '/deps/third_party/openmax@3720',
   'src/third_party/WebKit/Source':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/Source@149428',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/http/tests/resources@149428',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/platform/chromium-win/fast/workers@149428',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@8890',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11250',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@148',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@3913',
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/fast/filesystem@149428',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11250',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@72',
   'build':
      '/trunk/tools/build@197278',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1611',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/platform/chromium-win/storage/domstorage@149428',
   'build/third_party/lighttpd':
      '/trunk/deps/third_party/lighttpd@58968',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/http/tests/xmlhttprequest@149428',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@189528',
   'src/third_party/WebKit/Tools/Scripts':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/Tools/Scripts@149428',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/platform/chromium-win/fast/events@149428',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/fast/files@149428',
   'src/sdch/open-vcdiff':
      Var("open-vcdiff") + '/trunk@42',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/fast/events@149428',
   'src/third_party/WebKit':
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/Tools/DumpRenderTree@149428',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@511',
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@255',
   'src/third_party/WebKit/LayoutTests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests@149428',
   'src/third_party/swig/Lib':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/http/tests/websocket/tests@149428',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1494/LayoutTests/fast/js/resources@149428',
}
