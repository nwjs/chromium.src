...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@eacf47ac73a62fa704ed2f1641ed4abed877f8a8',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@a7b483f2940c8267c4115b4b47ffbc1d6a9913f3',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@a7a4063c10a3b92dee3fd91787757de5cf4dd127',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@72a40ab98c3ade8f362bba7d7d80783058319e6d',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@2a6fa60658e742dcc972da39c30c2516a2b0cbaf'
}
