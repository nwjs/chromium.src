...
#  
#  This DEPS file corresponds to Chromium 35.0.1883.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@29bb13ddc97665281e72cff7bd4baaaebb37b8b1',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@256049',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1883@168877',
   'src/third_party/icu':
