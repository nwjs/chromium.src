...
#  
#  This DEPS file corresponds to Chromium 34.0.1762.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@05157453881f5878e2e9fc6609dd084f25c8853c',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1762@164351',
