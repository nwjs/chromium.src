...
#  
#  This DEPS file corresponds to Chromium 34.0.1814.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@68a88e3a2d661099d7cd8a843694298964260829',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src':
      '/branches/1814/src@248003',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@976',
   'src/third_party/hunspell':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1814@166139',
   'src/third_party/icu':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@247814',
   'src/third_party/swig/Lib':
