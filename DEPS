...
#  
#  This DEPS file corresponds to Chromium 36.0.1953.0
#  
#  
#  
vars = {
...
deps = {
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13062',
   'src/third_party/libc++/trunk':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@172130',
   'src/third_party/webrtc':
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13062',
