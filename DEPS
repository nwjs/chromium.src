...
deps = {
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@cd771df39b5480c9a7276b7a424e2e05c04fd999',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@fe92576f4acb6e55a7b1eb5eed91d29c86c2e1d1',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@0214eb00b654b212569f540ef95d3e39c618c801',
