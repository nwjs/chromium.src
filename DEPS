...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@92fc2ae58331662ec411a048686cb4801e0a909a',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@edcf607f3f1b9f872031f7e71be6cd2927aeaa29'
}
