...
#  
#  This DEPS file corresponds to Chromium 30.0.1575.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@d6812850f4e2c9cc07044ef9693f640e10512dca',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1575@154893',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10309',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@213576',
   'src/third_party/libsrtp':
