...
#  
#  This DEPS file corresponds to Chromium 7.0.517.36
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/WebCore@69267',
   ...
   'src/v8':
      'http://v8.googlecode.com/svn/branches/2.3@5555',
   'src/breakpad/src':
   ...
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/LayoutTests@69234',
