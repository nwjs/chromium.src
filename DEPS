...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@df1ae4a8975b8a61c79b895384b34852a3ef243b',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@d93816d8f5e296220a1dbd7bc134a950d1761909'
}
