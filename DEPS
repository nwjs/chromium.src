...
#  
#  This DEPS file corresponds to Chromium 31.0.1639.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e9d8fac87c988e6c5a1204f820c9ef0c410fb54b',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1639@158159',
