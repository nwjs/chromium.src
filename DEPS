...
#  
#  This DEPS file corresponds to Chromium 4.1.249.1066
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      '/branches/WebKit/249/LayoutTests/http/tests/resources@45544',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      '/branches/WebKit/249/LayoutTests/storage/domstorage@45544',
   'src/third_party/WebKit/LayoutTests':
      '/branches/WebKit/249/LayoutTests@45544',
   'src/third_party/WebKit':
      '/trunk/deps/third_party/WebKit@27313',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      '/branches/WebKit/249/LayoutTests/fast/events@45544',
   'src/third_party/WebKit/WebKit/chromium':
      '/branches/WebKit/249/WebKit/chromium@45544',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/249/LayoutTests/http/tests/workers@45544',
   ...
   'src/build/util/support':
      '/trunk/deps/support@47490',
   'src/testing/gtest':
      'http://googletest.googlecode.com/svn/trunk@336',
   'src':
      '/branches/249/src@47477',
   'src/third_party/icu':
   ...
   'src/v8':
      'http://v8.googlecode.com/svn/branches/1.3@3773',
}
