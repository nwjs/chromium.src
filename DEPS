...
#  
#  This DEPS file corresponds to Chromium 21.0.1180.51
#  
#  
#  
...
deps_os = {
   ...
   'unix': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/Tools/gdb@122882',
...
deps = {
   ...
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/fast/filesystem/resources@122882',
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/storage/indexeddb@122882',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/media@122882',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/http/tests/appcache@122882',
   'commit-queue':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/http/tests/workers@122882',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/fast/workers@122882',
   'src/third_party/WebKit/Source':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/Source@122882',
   ...
   'src/third_party/WebKit/LayoutTests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests@122882',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/storage/domstorage@122882',
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/platform/chromium/fast/workers@122882',
   'src/tools/deps2git':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/platform/chromium/fast/events@122882',
   'depot_tools':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/platform/chromium-win/http/tests/workers@122882',
   'src/breakpad/src':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/http/tests/resources@122882',
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/platform/chromium-win/fast/workers@122882',
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/platform/chromium-win/storage/domstorage@122882',
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/http/tests/xmlhttprequest@122882',
   ...
   'src/third_party/WebKit/Tools/Scripts':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/Tools/Scripts@122882',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/platform/chromium-win/fast/events@122882',
   ...
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/fast/events@122882',
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/Tools/DumpRenderTree@122882',
   ...
   'src/third_party/WebKit/Tools/TestWebKitAPI':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/Tools/TestWebKitAPI@122882',
   'src/third_party/angle':
      'http://angleproject.googlecode.com/svn/trunk@1046',
   'src/v8':
      'http://v8.googlecode.com/svn/branches/3.11@12128',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@134182',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/http/tests/websocket/tests@122882',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1180/LayoutTests/fast/js/resources@122882',
}
