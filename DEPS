...
#  
#  This DEPS file corresponds to Chromium 29.0.1544.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@110b0783c18dd97abdbb3e3d4bcb215211659e74',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1544@152856',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11573',
   'src/third_party/smhasher/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9694',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@513',
   'build':
      '/trunk/tools/build@207678',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11573',
   'src/third_party/libphonenumber/src/test':
