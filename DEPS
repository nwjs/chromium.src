...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@0a2f71f380533eca84b7ffb7a5d6c96f044c5086',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@34fdcae28e14060672212017a9783415872da3d1',
