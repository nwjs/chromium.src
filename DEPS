...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      (Var("git.chromium.org")) + '/chromium/deps/nss.git@b37fb0be291ca6b0238476fcebe54bae77baf2aa'
  },
  'mac': {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@0760f24bb49535c6631aea6be9ebebde5736b3da',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@cd523ebe2be30f268cdcec2d0b59eba609b9901b',
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@6d24aadb361dc9a914bbe321915972461fe0444c',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@efa2e5d00c218551242fa50931cd81332359a509',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@66b8c06bb76bc1f90adfed11f48cc676fde64dbb',
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@a513e85a22fca048860dcbfcac132b757e524857',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@06b2696801712948b665372a38f96b1f10be6997',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@55f7ba2f1239ae021542c0524b777010a1d885b6',
