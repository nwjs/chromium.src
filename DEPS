...
#  
#  This DEPS file corresponds to Chromium 36.0.1926.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@93aed4b5af0bd970be167b52af23db2930de3d67',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1926@170872',
   'src/breakpad/src':
