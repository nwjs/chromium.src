...
#  
#  This DEPS file corresponds to Chromium 31.0.1621.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@8a30ca612c09316083ede1e68e904028d36c9d5a',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1621@157188',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11050',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@520',
   'build':
      '/trunk/tools/build@221117',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@74',
   'src/third_party/libsrtp':
