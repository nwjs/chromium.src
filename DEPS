...
deps_os = {
  ...
  'unix': {
    ...
    'src/third_party/chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@ebfaba48b76d45a9f8462510d5379ba877ceb847',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293503',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@6dfbdef9003e32790dabb7994a3412dbd4d60d87',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@3954c84f7f635762d194c22b3c15a73f90054286',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@ed47c2dcd9a30eea73c9cf7b7f120f2d089ad938',
