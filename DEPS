...
#  
#  This DEPS file corresponds to Chromium 4.1.249.1063
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      '/branches/WebKit/249/LayoutTests/http/tests/xmlhttprequest@45318',
   'src/third_party/protobuf2/src':
      'http://protobuf.googlecode.com/svn/trunk@219',
   'src/third_party/WebKit/JavaScriptCore':
      '/branches/WebKit/249/JavaScriptCore@45318',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      '/branches/WebKit/249/LayoutTests/fast/js/resources@45318',
   ...
   'src/build/util/support':
      '/trunk/deps/support@45374',
   'src/testing/gtest':
      'http://googletest.googlecode.com/svn/trunk@336',
   'src':
      '/branches/249/src@45301',
   'src/third_party/icu':
