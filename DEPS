...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@b4f3d69b8e18128598b8f62dd6fc7ae0e761cd57',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@470b4fe7aab10c0f64e89d9bb28ce5cfc94c5b20',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@7c50820975f8f51f7bd18a449f1c9cdc23586c11',
  'src/breakpad/src':
