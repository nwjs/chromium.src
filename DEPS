...
#  
#  This DEPS file corresponds to Chromium 34.0.1803.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("native_client") + '/trunk/deps/third_party/gnu_binutils@12630',
      'src/third_party/psyco_win32':
      '/trunk/deps/third_party/psyco_win32@237949',
      'src/third_party/mingw-w64/mingw/bin':
      Var("native_client") + '/trunk/deps/third_party/mingw-w64/mingw/bin@12630',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@c33533fb62922dd5d068717b650905a1cf8c6663',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@25cf2d85072b06f78956ecaacd564ef56a054d65',
...
deps = {
   ...
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@314',
   'src/chrome/test/data/perf/third_party/octane':
      Var("octane-benchmark") + '/trunk@19',
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@13141',
   'src/third_party/scons-2.0.1':
      Var("native_client") + '/trunk/src/third_party/scons-2.0.1@12630',
   'src/third_party/webdriver/pylib':
      Var("selenium") + '/trunk/py@18337',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src':
      '/branches/1803/src@246786',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@975',
   'src/third_party/hunspell':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@246575',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@246728',
   'src/breakpad/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13141',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12642',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@151',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'src/chrome/browser/resources/pdf/html_office':
      Var("git.chromium.org") + '/chromium/html-office-public.git@1d04f3dfbd8bd604190dfb6f5a030d30233ba6ea',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12642',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@78',
   'build':
      '/trunk/tools/build@246780',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1842',
   'src/chrome/test/data/perf/canvas_bench':
      '/trunk/deps/canvas_bench@122605',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@244257',
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/trunk/talk@5397',
   'src/third_party/usrsctp/usrsctplib':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1803@165701',
   'src/third_party/icu':
   ...
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@147',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@b39e8cf08c931e8b695482e1fa154574e6259f46',
   'src/third_party/angle':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@244953',
   'src/third_party/swig/Lib':
