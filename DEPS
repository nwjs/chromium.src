...
#  
#  This DEPS file corresponds to Chromium 30.0.1557.1
#  
#  
#  
vars = {
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@210190',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1557@153592',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9878',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@516',
   'build':
      '/trunk/tools/build@210176',
