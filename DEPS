...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      '/trunk/deps/third_party/nss@271557'
  },
  'mac': {
  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@1382f1000498d5f6ed0451f1488a4d96b0c6c19d',
    ...
    'android': {
      ...
      'src/third_party/android_tools':
        (Var("git.chromium.org")) + '/android_tools.git@7de460f062350105c3eb284cdc6948ff50e1f6e1',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@272033',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@1bac8b901e5e2809eb5931bd55a1370d7c62e25d',
  'src/third_party/skia/gyp':
    (Var("skia")) + '/trunk/gyp@14827',
  'src/buildtools':
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2008@174559',
  'src/third_party/icu':
