...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@614b950a55708a12f329b66b7071823b38d1f1fc',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@8ceabe63bfbd5f17110a8bfee7db606ed564c4bb',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@57d1b6d19d088dd9e170d519a89d161f68a2a999'
}
