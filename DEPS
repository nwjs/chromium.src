...
#  
#  This DEPS file corresponds to Chromium 25.0.1364.56
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Source/Platform/chromium/public@141076',
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Source/WebKit/chromium/public@141076',
   ...
   'unix': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Tools/gdb@141076',
...
deps = {
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/fast/filesystem/resources@141076',
   'src/third_party/skia/include':
      Var("skia") + '/trunk/include@6830',
   'src/third_party/libphonenumber/src/test':
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/storage/indexeddb@141076',
   'src/sandbox/linux/seccomp-legacy':
      Var("seccompsandbox") + '/trunk@189',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/http/tests/appcache@141076',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@251',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium-win/http/tests/workers@141076',
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@6830',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium/fast/events@141076',
   'src/third_party/webdriver/pylib':
      Var("selenium") + '/trunk/py@16922',
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@173178',
   'src':
      '/branches/1364/src@179346',
   'src/third_party/libyuv':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/http/tests/workers@141076',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/fast/workers@141076',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/media@141076',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/webkit/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@173055',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/storage/domstorage@141076',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@63',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium/fast/workers@141076',
   'src/tools/deps2git':
   ...
   'src/third_party/WebKit/Source':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Source@141076',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/http/tests/resources@141076',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium-win/fast/workers@141076',
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium-win/storage/domstorage@141076',
   'build/third_party/lighttpd':
      '/trunk/deps/third_party/lighttpd@58968',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/http/tests/xmlhttprequest@141076',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@169478',
   'src/third_party/WebKit/Tools/Scripts':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Tools/Scripts@141076',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium-win/fast/events@141076',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/fast/files@141076',
   'src/sdch/open-vcdiff':
      Var("open-vcdiff") + '/trunk@42',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/fast/events@141076',
   'src/third_party/WebKit':
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Tools/DumpRenderTree@141076',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@501',
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@192',
   'src/third_party/WebKit/LayoutTests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests@141076',
   'src/third_party/swig/Lib':
      '/trunk/deps/third_party/swig/Lib@69281',
   'src/third_party/WebKit/Tools/TestWebKitAPI':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Tools/TestWebKitAPI@141076',
   'src/third_party/angle':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/http/tests/websocket/tests@141076',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/fast/js/resources@141076',
}
