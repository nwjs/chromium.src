...
#  
#  This DEPS file corresponds to Chromium 29.0.1545.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@9992afec017afcf74fd4554ea3bdd255622a3c84',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@152894',
   ...
   'src/v8':
      Var("v8") + '/trunk@15255',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@207593',
   'src/third_party/sfntly/cpp/src':
