vars = {
  'angle_revision':
    '5ac60fc2a3c0a10f04d9aa945069a68e707a80cb',
  'boringssl_revision':
    '3ac32b1eda0da7a99d9c2b6c605fe50af80ccd90',
  'buildspec_platforms':
    'win-asan,',
  'buildtools_revision':
    '818123dac34899ec230840936fc15b8b2b5556f9',
  'chromium_git':
  ...
  'nacl_revision':
    'a0559c4cc7e9f95b41982a8f4ba10a04173c6c75',
  'nss_revision':
    'a676aa04ff18b30983cac03dede5861b3db62c9d',
  'openmax_dl_revision':
    '6625be0364c8adc1b202b000d1e5010f92e2b6a2',
  'pdfium_revision':
    '628f7053cc646c58c61add247c75bc65ac135327',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    'd1c94a41589c62ffc3a84e51ddf63a623a77658c',
  'swarming_revision':
    'df99a00d96fae932bae824dccba13156bf7eddd0',
  'v8_revision':
    '02daba5cbe8a6b0284a398baa022b29c1e58e2d2'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@818123dac34899ec230840936fc15b8b2b5556f9',
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@a0559c4cc7e9f95b41982a8f4ba10a04173c6c75',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@5ac60fc2a3c0a10f04d9aa945069a68e707a80cb',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@3ac32b1eda0da7a99d9c2b6c605fe50af80ccd90',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@8ee1919cae827e33a3f217366d4a05e64a948615',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@67e7a761483e48f720a388b886b0354225858700',
  ...
  'src/third_party/libsrtp':
    (Var("chromium_git")) + '/chromium/deps/libsrtp.git@b8dd754b4fa05fd4cf1c2e8dc3b1ac976280e41a',
  ...
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@1019e4537fc1bfc6ee505cd1c628b645c7e966b7',
  ...
  'src/third_party/openmax_dl':
    (Var("chromium_git")) + '/external/webrtc/deps/third_party/openmax.git@6625be0364c8adc1b202b000d1e5010f92e2b6a2',
  'src/third_party/opus/src':
    (Var("chromium_git")) + '/chromium/deps/opus.git@cae696156f1e60006e39821e79a1811ae1933c69',
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@628f7053cc646c58c61add247c75bc65ac135327',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@d1c94a41589c62ffc3a84e51ddf63a623a77658c',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@febd8d424cc5ae0ba65a0e1806ed80d76d9e9e5e',
  ...
  'src/tools/swarming_client':
    (Var("chromium_git")) + '/external/swarming.client.git@df99a00d96fae932bae824dccba13156bf7eddd0',
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@02daba5cbe8a6b0284a398baa022b29c1e58e2d2'
}
