vars = {
  ...
  'libvpx_revision':
    'b33794b9132c8c1722206d6676c37177ccbaef2e',
  'lighttpd_revision':
  ...
  'openmax_dl_revision':
    '772999bc2f5e2e7469b1cad0b76b8f96c553edf3',
  'pdfium_revision':
    '6c5afa68ed4e21f9d0bfd1ecc01e824d946c5485',
  'sfntly_revision':
  ...
  'v8_revision':
    '40d687146a2c35b1328f21ea5f3b95b2be4dda52'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@e7111440c07a883b82ffbbe6d26c744dfc6c9673',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@e1e22ac3d7bd583fd61781800409122a245a2aee',
  ...
  'src/third_party/libvpx':
    (Var("chromium_git")) + '/chromium/deps/libvpx.git@b33794b9132c8c1722206d6676c37177ccbaef2e',
  ...
  'src/third_party/openmax_dl':
    (Var("chromium_git")) + '/external/webrtc/deps/third_party/openmax.git@772999bc2f5e2e7469b1cad0b76b8f96c553edf3',
  'src/third_party/opus/src':
    (Var("chromium_git")) + '/chromium/deps/opus.git@cae696156f1e60006e39821e79a1811ae1933c69',
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@6c5afa68ed4e21f9d0bfd1ecc01e824d946c5485',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@c9e190ddac3d193e89e580ea3819a55c28f15e61',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@a6ae030b86e4ab27227ac43ed7d7d976214ffeed',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@40d687146a2c35b1328f21ea5f3b95b2be4dda52'
}
