vars = {
  ...
  'skia_revision':
    'b758bbd84e6d4556376850186252777a1a239f4a',
  'swarming_revision':
    'f71d1a3fbe207d91bb2f0bd96c8821ff90bb7c28',
  'v8_revision':
    'dae3c4abd4ec718ba4964ca191649a74f7c248b0',
  'webkit_revision':
    'b65f74372b76f41c8d45cfd6b5a0b314d133a572'
}
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@e29affb1afa1fc8c70503ee35b1091ea1a20b466',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@df1b109ca587295b6ec2e83e8c6c80de3a09dce8',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@b758bbd84e6d4556376850186252777a1a239f4a',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@47b95c6276e4d174aef09a910e50c1fae26cb50c',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@dae3c4abd4ec718ba4964ca191649a74f7c248b0'
}
