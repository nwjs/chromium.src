...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@21fff74806410395494bac6f7ed128ab07a5840b',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@7ef63c85c5891ca59906e3c783a7f954be3f7f62',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@441e976ecca14a1603bee4211cc821d468367291'
}
