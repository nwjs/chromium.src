  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@8d58804267b4b6d3fb10400c56dcf4a83deb24dc',
      ...
      'src/third_party/chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@22f6c5af84990b8a618b4bce803082b6f63c821d',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291302',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2132@180758',
  'src/third_party/openmax_dl':
    (Var("webrtc")) + '/deps/third_party/openmax@6925',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@1f31e7671721a9f2c204a0e1842961f43e7b53ca',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13637',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@95a2bce6dad6569ec65b547169f4a9d58877a1f4',
  'build':
    '/trunk/tools/build@291319',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13637',
  'src/third_party/icu':
  ...
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@291091',
