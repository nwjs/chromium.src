...
#  
#  This DEPS file corresponds to Chromium 35.0.1908.4
#  
#  
#  
vars = {
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@258989',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1908@169907',
   'src/third_party/icu':
