vars = {
  'angle_revision':
    '06c5a6463645447aed78a045a8c20876600ff204',
  'boringssl_revision':
  ...
  'nacl_revision':
    'f58755f5fd5dab06899ff2bbae8c959c2c8ecb63',
  'nss_revision':
  ...
  'skia_revision':
    '694307c9f1ade20a3c5f968c248a66b6a2d151a8',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    '8aa6434b5b5309fb2c0c820ef19133cab0b0e944',
  'webkit_revision':
    '448d61e357539002353fd8fa15f31a79ca16685f'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@f58755f5fd5dab06899ff2bbae8c959c2c8ecb63',
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@448d61e357539002353fd8fa15f31a79ca16685f',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@06c5a6463645447aed78a045a8c20876600ff204',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@1b25fa26dbb02cd3e213d150f749693040ecb98d',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@694307c9f1ade20a3c5f968c248a66b6a2d151a8',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@09d15b431fc25892b9500d50fa38972a77164fc8',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@8aa6434b5b5309fb2c0c820ef19133cab0b0e944'
}
