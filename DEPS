  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@422253205a270f1b9451635f12c8c032098be97f',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@288877',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2121@180025',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@6b143b080820c34c9c0f80e5c682939e9ee3879d',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13599',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13599',
