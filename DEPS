...
#  
#  This DEPS file corresponds to Chromium 33.0.1709.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@58f01484052c1ba40fc1a604599738e7af69657a',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@234874',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1709@161983',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@5104',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1709/src@235205',
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@5104',
   'src/third_party/libjpeg_turbo':
      '/trunk/deps/third_party/libjpeg_turbo@228394',
   'src/third_party/pywebsocket/src':
      Var("pywebsocket") + '/trunk/src@662',
   'commit-queue':
      '/trunk/tools/commit-queue@234989',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12260',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@525',
   'build':
      '/trunk/tools/build@235027',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
