...
#  
#  This DEPS file corresponds to Chromium 36.0.1985.6
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1985/public@174087',
      'src/native_client':
      None,
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1985@174087',
   'src/breakpad/src':
