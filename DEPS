vars = {
  'angle_revision':
    '2e5b500c05e2d94626694f463dd842ef0c6252bf',
  'boringssl_revision':
  ...
  'nacl_revision':
    'f14a2194a8dd85de9304c94d8563e24b7cd45bff',
  'nss_revision':
  ...
  'skia_revision':
    '381b26f03bdccac1e3d9055fb4f7855792cfefb0',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    'dd18e392ad0471df87b57ee0735d13a38a86d745',
  'webkit_revision':
    '54eac624e0bcb463985267e08ec88155a138f5a9'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@f14a2194a8dd85de9304c94d8563e24b7cd45bff',
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@54eac624e0bcb463985267e08ec88155a138f5a9',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@2e5b500c05e2d94626694f463dd842ef0c6252bf',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@381b26f03bdccac1e3d9055fb4f7855792cfefb0',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@dd18e392ad0471df87b57ee0735d13a38a86d745'
}
