...
#  
#  This DEPS file corresponds to Chromium 36.0.1967.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@266724',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@b528d97612ff2955ee65574cf69738a68f658199',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@267038',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1967@172985',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1322',
   'src/third_party/openmax_dl':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@14440',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13091',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13091',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@267198',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1895',
   'src/chrome/test/data/perf/canvas_bench':
