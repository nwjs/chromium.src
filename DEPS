vars = {
  'angle_revision':
    'afe44c41cde9be7ca72968f63580cd6afa89c65e',
  'boringssl_revision':
    '43bd18f3b2a0b4ae9a807b432631b4cdb8339a46',
  'buildspec_platforms':
    'win-asan,',
  'buildtools_revision':
  ...
  'skia_revision':
    '74992b579422a5e31fa07705d1f9206e0d919706',
  'swarming_revision':
    '2866a22530cb65feae5d9f64c83636aed5391d06',
  'v8_revision':
    '189672152b0466b14d36ea49081bd23745b5a888',
  'webkit_revision':
    '78cb8320e3f214184d34c4ab48fd0887e5dd66f6'
}
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@a3775419138afe569c6c6b692687c9d14e576a36',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@afe44c41cde9be7ca72968f63580cd6afa89c65e',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@43bd18f3b2a0b4ae9a807b432631b4cdb8339a46',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@942a295c8100046dc3fa315bc2734a38e48eaec9',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@74992b579422a5e31fa07705d1f9206e0d919706',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@4b50880e26ec952201e4d4643e60e5a7bc2d3534',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@189672152b0466b14d36ea49081bd23745b5a888'
}
