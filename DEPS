...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@c646e387feb48aa2a8a78908798fa40379da6ba1',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@4f22bea1de62605d4474d69d995fe5eb9c7112be',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@f0a92899b41845085602939059b4f71393484e09',
  'src/breakpad/src':
