...
#  
#  This DEPS file corresponds to Chromium 32.0.1674.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@fed3e8b1b30b32610862398fe428fe974be756c7',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1674@159933',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@229249',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11833',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@522',
   'build':
      '/trunk/tools/build@229280',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
