...
#  
#  This DEPS file corresponds to Chromium 35.0.1916.124
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1916/public@174108',
      'src/native_client':
      None,
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@890950dfa4b6858a43b094bd817ed3ab480b75be',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/skia/include':
      Var("skia") + '/branches/chrome/m35_13966/include@14599',
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/branches/chrome/m35_13966/gyp@14595',
   'src/third_party/scons-2.0.1':
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.51/webrtc@5913',
   'src/tools/deps2git':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@260297',
   'src/third_party/bidichecker':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m35_13966/src@14599',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12935',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12935',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@260342',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1880',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1916@174108',
   'src/third_party/icu':
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@4b65c53df5487a04a4d0a99d5f2d8abf1f28b0b0',
   'src/v8':
      Var("v8") + '/branches/3.25@21371',
   'src/third_party/libwebm/source':
      Var("git.chromium.org") + '/webm/libwebm.git@0f7815b036651e242ec8c2fcfb59fe54f69be1a8',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@259953',
   'src/third_party/swig/Lib':
