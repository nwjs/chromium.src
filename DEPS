...
deps_os = {
  ...
  'unix': {
    ...
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@c5bdf1006816594881f96840c21deeb90794969b',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@294368',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@96e657d0e103b8358a77ecd913f6086929f792b8',
  ...
  'src/third_party/openmax_dl':
    (Var("git.chromium.org")) + '/external/webrtc/deps/third_party/openmax.git@6658243eab434556ceeb3012dd39d854a39ce54a',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@7cec2889afa8b7f4c6e0ee6bf0ec901d85dd52b8',
  'build/scripts/tools/deps2git':
    '/trunk/tools/deps2git@292856',
  'src/third_party/hunspell_dictionaries':
    (Var("git.chromium.org")) + '/chromium/deps/hunspell_dictionaries.git@4e3f3cced36cf64b8d1821804ddb9fbe2048494e',
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@22906ee04c0e995af57b79ef731948a3292d0c63',
  ...
  'build':
    '/trunk/tools/build@294399',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@4a9b712d5cb4a5ba7a9950128a7219569caf7263',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@524e3bde19d0df76cc9d1c5926345f5d0ec4d3f8',
  'build/third_party/lighttpd':
    '/trunk/deps/third_party/lighttpd@58968',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@d4dd4f79f60bf019625b3a1436979b0a42c892df',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@133128177dd166a117f2cecffe23abdfae823b5e',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@b3571f53f1bd7870ffd293a4bfca6473a21193d2',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu.git@eda9e75b1fa17f57ffa369ee3543a2301b68d0a9',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@065f0d730e12cc7ee8dd88c4992be08fecc58711',
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@ac07e580b221a22c08e9398cd15744870521b364',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@9399e20ec086881723f0a69edd76f53b74e0ac6d',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@763fe7ad8db602969665be93e7f873a5f6d4862e',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@bf0df92964565f819881e78ff3bfb5343e95e130',
