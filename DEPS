...
#  
#  This DEPS file corresponds to Chromium 35.0.1894.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@d0609b2c015602fb59b3680fe193aacc7769210c',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1894@169306',
   'src/third_party/icu':
