...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@5c90dcce4024c3d1ad82f01186547dd38ffe764e',
  ...
  'android': {
    'src/third_party/android_webview_glue/src':
      (Var("git.chromium.org")) + '/external/android_webview_glue.git@a770a09ca3346d8ec7cb4cdff90aaf83c8d2c5ff',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293277',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@f4e0d9eb2d72fe92c30237de978936113143dc16',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@973134d8f0a715488a1b34c054044d17f3af5279',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@8e7c8a13791d5e0cb503898d5a7d1f38471deb69',
  'build/third_party/lighttpd':
    '/trunk/deps/third_party/lighttpd@58968',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@535aff24c308a715751028173e569596bcfe12a7',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@903abf6e324e1e7d256ab71aaa766458930ba02d',
  'src/breakpad/src':
