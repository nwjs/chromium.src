  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@8774897e8a910dad404f09e83e1e8de7eed6b937',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@287057',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2114@179495',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@e2a05d173d49547ed8aa5edc0209941a8941f450',
  'build':
    '/trunk/tools/build@287430',
