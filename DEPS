...
#  
#  This DEPS file corresponds to Chromium 33.0.1722.1
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1722@162806',
   ...
   'src':
      '/branches/1722/src@237673',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@7c543276f087abdd46dc87638d97df93cc805fac',
   'src/third_party/hunspell':
