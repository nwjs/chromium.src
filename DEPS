...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@1bbb44d2dfcd48d0b027629cb7218ea112d57ab2',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292537',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@43b8b36b20ae00e2d78421c4cda1f3f922983a20',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@2a8cf9cfd9a14e9e721d5e514434cec1d82bf294',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@c6bd766c4db9cf60f8e76c137ddf0bf09e82e866',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@2f51c28a975ceaa07ce8f8b2e42ac0f0c5a57802',
