...
#  
#  This DEPS file corresponds to Chromium 37.0.2001.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@229b1ef073b8080ccdd6c03a4fe7ed5e5c9af7ea',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/2001@174241',
   'src/breakpad/src':
