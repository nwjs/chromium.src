  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@97851d3b247ec6896a08e215e77f8b8523d320d8',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@276858',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2047@176077',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@679426c0b4b6568a79a7a69ac4fc9ba248009d19',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@aea50658a1fb5078dbf9406991d7f6d8ec34d465',
  ...
  'src/third_party/libaddressinput/src/testdata':
    (Var("libaddressinput")) + '/trunk/testdata@273',
  'src/testing/gmock':
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13328',
  ...
  'src/third_party/libaddressinput/src/cpp':
    (Var("libaddressinput")) + '/trunk/cpp@273',
  'src/third_party/icu':
