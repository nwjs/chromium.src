  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@c0aed5de171d62b93657f1633935fe31bc89dea3',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@273852',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2024@175221',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@5744bbee6fa65f9d532587b6539fa0f104dda98b',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13251',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13251',
  'src/third_party/leveldatabase/src':
    (Var("leveldb")) + '/trunk@80',
  'build':
    '/trunk/tools/build@274107',
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@83ed7189066fd9b4b9ea15ffc2d4ab6d2da62571',
