...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@26e2eeee2cf9549db37478b28e3d0decadb45fac',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@726cf9038aae3f4dffc79a97645388f32224b22d',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@f4760990c6a0c4a4514a10629a005ee9bc3fc1a1'
}
