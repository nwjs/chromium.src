...
#  
#  This DEPS file corresponds to Chromium 31.0.1624.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@3ecb1068453695cd1fcacb4815c4bb06d857b618',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1624@157408',
