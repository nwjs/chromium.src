...
#  
#  This DEPS file corresponds to Chromium 37.0.1987.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@7a49adf7418db84365c0996b02a686f863a449c3',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@269661',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1987@173838',
   'src/breakpad/src':
