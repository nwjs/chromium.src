...
#  
#  This DEPS file corresponds to Chromium 34.0.1753.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@1bb26d049f107f95c053c3143db0edfe09cef290',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@164136',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12762',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@242014',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
