...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@36a25f13e01c2e98295a2174887b07a39ddd3035',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@9db912c2ac2ab53bc24f2d50a3e5a80162051dcc',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@6859ada2ca24a16ea050ca6b9d6687fafde6c798',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@26d7fad78e9d1c135d7b028ea3baf91276379bca'
}
