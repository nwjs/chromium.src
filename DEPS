...
#  
#  This DEPS file corresponds to Chromium 37.0.1993.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@3d410cad832c5b53665b78b6f5d5fcec186b36f5',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@270564',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1993@174066',
   'src/breakpad/src':
