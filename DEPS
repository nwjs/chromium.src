...
#  
#  This DEPS file corresponds to Chromium 31.0.1637.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@cfe1ddc36d28d89b52808f2fab583002570a94ce',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@224264',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1637@158079',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12177',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12177',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@76',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1735',
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@223771',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@222960',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11364',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@224265',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@214783',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@219831',
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@fc75e21762459c9306fd0c0a060010254d5ad248',
   'src/tools/grit':
