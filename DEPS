...
#  
#  This DEPS file corresponds to Chromium 37.0.1997.4
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@ace93eb1ee0ccfd9566e50c08a51a0f9401a536e',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1997@174226',
   'src/breakpad/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@14757',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13181',
   ...
   'build/scripts/tools/deps2git':
      '/trunk/tools/deps2git@270777',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13181',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@80',
   'build':
      '/trunk/tools/build@271125',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1919',
   'src/chrome/test/data/perf/canvas_bench':
