...
#  
#  This DEPS file corresponds to Chromium 31.0.1636.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@69ca115c047cde724776c2856ec6470d542d928d',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@d8a5bfea861dfbacd9a74275c00561f7bb27d6e3',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@222974',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1636@157999',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4758',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1636/src@224128',
   'src/third_party/hunspell':
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@221184',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11334',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@224009',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
