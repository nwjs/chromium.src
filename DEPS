  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@2e5a5a55069e39d970fcdf4f79dcaa307d958334',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291701',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@110f8a11d9b4a57f1df675746df777bcb67bf4ea',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@b2f7fce9e034c3b6749e75a129e7836df3529706',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu52.git@04330715234f76e3de38ad303a57fb07733aad42',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@c714f377950c6a8a80b90ddca93ad8bd23ce362a',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@1f3591d4c75fc4039dbd120ff1c459b311e976e2',
