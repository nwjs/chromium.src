...
#  
#  This DEPS file corresponds to Chromium 24.0.1312.71
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@ac8c2a7849eedacfde6ac59cd72e81860cd60bd5',
      'src/third_party/lss':
