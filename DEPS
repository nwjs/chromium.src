...
#  
#  This DEPS file corresponds to Chromium 34.0.1838.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@dad40d69872f8188893e10f95b11fd5c5e170743',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@250904',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1838@167064',
   'src/third_party/icu':
