...
#  
#  This DEPS file corresponds to Chromium 34.0.1848.1
#  
#  
#  
vars = {
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@252138',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1848@167449',
   'src/third_party/icu':
