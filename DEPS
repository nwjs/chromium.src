...
#  
#  This DEPS file corresponds to Chromium 32.0.1689.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@3e65992b26596dd8a02f3609458d113e8415d3f4',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@232501',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1689@161217',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@5066',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1689/src@232579',
   ...
   'src/v8':
      Var("v8") + '/trunk@17449',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@228256',
   'src/third_party/sfntly/cpp/src':
