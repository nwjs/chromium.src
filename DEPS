...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2077@177265',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@761b2509d59787a8920b2e98911cff9f88e0eb4e',
