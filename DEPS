...
#  
#  This DEPS file corresponds to Chromium 32.0.1661.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@23efd04a6110b792b1ec6ff8f3e2b8e068fbbe47',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1661@158976',
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@d34a0d1b17422f5b2ec497617f44b9c1877751d6',
   'src/tools/grit':
