...
#  
#  This DEPS file corresponds to Chromium 35.0.1850.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@1b4a7c9ffbf483fff8275a163b6e3e988563f362',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@167498',
   'src/third_party/webrtc':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@252299',
   'src/third_party/bidichecker':
