...
#  
#  This DEPS file corresponds to Chromium 31.0.1608.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@2ae0969cce4995d232e42fcf23d1d574f373369a',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@218239',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1608@156537',
   'src/third_party/cld2':
      Var("cld2") + '/trunk@19',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10851',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@519',
   'build':
      '/trunk/tools/build@218856',
   'src/third_party/libsrtp':
