...
#  
#  This DEPS file corresponds to Chromium 34.0.1761.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@239365',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@54fe3d5ee3ed19a4ce1642ce361ab498e58bcf09',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/chromium/src/third_party/freetype.git@e3b631da8034f7c6ecc6d809cd9e46d306215c32',
...
deps = {
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@12791',
   'src/third_party/webdriver/pylib':
      Var("selenium") + '/trunk/py@18337',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@919',
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@242301',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1761@164346',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@5301',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1761/src@242539',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@f89de358c2edb260e0ca8429c16d1037a4ec4fa4',
   'src/third_party/hunspell':
