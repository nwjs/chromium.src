  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@bb89f8722adc5f1ff21fea90ef5cf4283eebbfb6',
...
deps = {
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@15cf4505166a6c85f9f3c5c78c639e63705b88fa',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@c74410ee6feb3e6fb612fa4a7b68125ee7ae60f3',
  'src/breakpad/src':
