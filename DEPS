vars = {
  'angle_revision':
    '517ccdf820db38043c9af9933ff0f2af343587f0',
  'boringssl_revision':
  ...
  'nacl_revision':
    '9cb3a31796937176950f1727ea5b7778c9861ae5',
  'nss_revision':
  ...
  'skia_revision':
    '759373a9fe73a7883d007254193084a541714b40',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    '71ee0a55128ba504f9f5c582c60b1ae191fa88b0',
  'webkit_revision':
    'd42488bb63a5ac7fd6befd40a9b90fe85cebcc4a'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@9cb3a31796937176950f1727ea5b7778c9861ae5',
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@d42488bb63a5ac7fd6befd40a9b90fe85cebcc4a',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@517ccdf820db38043c9af9933ff0f2af343587f0',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@3c8ac6f186dbfa08618d9a6af6dc0b1233209636',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@cc2323f0d0d626edac4a426097eb38b53ba54848',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@759373a9fe73a7883d007254193084a541714b40',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@225933171b621abcf212a130c3acbb7f9480f320',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@71ee0a55128ba504f9f5c582c60b1ae191fa88b0'
}
