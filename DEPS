...
#  
#  This DEPS file corresponds to Chromium 32.0.1659.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@aad5ce47ca8ae17ccaa42e31c10c8d9a5c16d202',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@ea95f204d2e085fd5507e039b90d620d03c87b5f',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@226611',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1659@158773',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12206',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12206',
   'src/third_party/leveldatabase/src':
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4889',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1659/src@226787',
   'src/third_party/hunspell':
   ...
   'src/v8':
      Var("v8") + '/trunk@17075',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@225010',
   'src/third_party/sfntly/cpp/src':
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@384c0cd561e41cd38aeec69ab8620d1469ee6c3b',
   'src/tools/grit':
