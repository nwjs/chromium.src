...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2030@175502',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@abc073376091e66f705674b825b1247148cb9c24',
  ...
  'src/third_party/libaddressinput/src/testdata':
    (Var("libaddressinput")) + '/trunk/testdata@262',
  'src/testing/gmock':
  ...
  'src/third_party/libaddressinput/src/cpp':
    (Var("libaddressinput")) + '/trunk/cpp@262',
  'src/third_party/icu':
