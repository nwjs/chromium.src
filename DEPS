...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@665d313e13dda88a873bd11b99791adceea8f04b',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291777',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@19b54260b70e697c0dc31e29206cc564d1fbf114',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@937c9c7eb4e06d4d3bc495e129c7b8103a5d6c0f',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu52.git@ff8353094b0b29f2d50059c452d15bbf0a84c0ad',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@ada3a6017e603965f87fa34f6e2fa60379e8d697',
