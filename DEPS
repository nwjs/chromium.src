...
deps = {
  ...
  'src/third_party/webrtc':
    (Var("webrtc")) + '/branches/39/webrtc@7786',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@04ab0eb41f1bb02eb722ce662bd9e6f47cca83a3',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu.git@4c57a795fc3c00c16596dec5fcc8dc6d17042caa',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@f292119a2cbac17743a4a8ffb4a130d00a3c92f6',
  'src/breakpad/src':
