...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@28c929e2b16f2cfaae96eafbdcc26dfe6cabfc4d',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@ea11df0cad9d9f0b539d6aec129477b335785b26'
}
