  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@97992a5c155e16943d3751a9bdd2a69fc2426256',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@277615',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2055@176334',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@4aa000df08f184ac3576d03ba50d6367e05d069b',
  ...
  'src/third_party/libaddressinput/src/testdata':
    (Var("libaddressinput")) + '/trunk/testdata@282',
  'src/testing/gmock':
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13350',
  ...
  'src/third_party/libaddressinput/src/cpp':
    (Var("libaddressinput")) + '/trunk/cpp@282',
  'src/third_party/icu':
