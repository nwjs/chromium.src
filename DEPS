...
#  
#  This DEPS file corresponds to Chromium 34.0.1791.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@2a14f951a57771e7d2e7bb8ae424ab88d8c6604f',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@245530',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1791@165318',
   'src/third_party/icu':
   ...
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@146',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@361bfda6c0e4e2469dd3dab8c2b741639cacb086',
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@95fa672f26db492aee2076b0acb524149d52c68f',
   'src/v8':
      Var("v8") + '/trunk@18634',
