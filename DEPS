...
#  
#  This DEPS file corresponds to Chromium 34.0.1829.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@dd3f77a57a0b44197b07b36580f994700bed08a7',
      'src/third_party/pyelftools':
      Var("git.chromium.org") + '/chromiumos/third_party/pyelftools.git@bdc1d380acd88d4bfaf47265008091483b0d614e',
      'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@249698',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@ed0399e616c48e1096b39d6a23da7d6e850aeae9',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@249612',
   'src/third_party/bidichecker':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13355',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12726',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@151',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@540',
   'build/scripts/tools/deps2git':
      '/trunk/tools/deps2git@249599',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12726',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@78',
   'build':
      '/trunk/tools/build@249898',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1846',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1829@166754',
   'src/third_party/icu':
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@ef26f3bb09eaadb3b99ddd8c89a972dc1e497930',
   'src/v8':
      Var("v8") + '/trunk@19187',
