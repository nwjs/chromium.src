...
#  
#  This DEPS file corresponds to Chromium 33.0.1750.18
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@cbdd21c5ea76aa93ba4619a6d253697765f4de1f',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@fdceb4d0c2314b6fb8f92232c3d458e1c08734fc',
      'src/third_party/lss':
...
deps = {
   'src/third_party/skia/include':
      Var("skia") + '/branches/chrome/m33_1750/include@12932',
   ...
   'src/third_party/brotli/src':
      Var("git.chromium.org") + '/external/font-compression-reference.git@fe79fac8da1ec850d94679705a6f3405153f51dd',
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@314',
   'src/chrome/test/data/perf/third_party/octane':
      Var("octane-benchmark") + '/trunk@19',
   'src/third_party/skia/gyp':
      Var("skia") + '/branches/chrome/m33_1750/gyp@12932',
   'src/third_party/webdriver/pylib':
      Var("selenium") + '/trunk/py@18337',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1806',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@911',
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1750@164524',
   'src/tools/deps2git':
      '/trunk/tools/deps2git@236839',
   'depot_tools':
      '/trunk/tools/depot_tools@241043',
   'src/third_party/bidichecker':
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12556',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12556',
   ...
   'src/v8':
      Var("v8") + '/branches/3.23@18338',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@240222',
   'src/third_party/sfntly/cpp/src':
      Var("sfntly") + '/trunk/cpp/src@228',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1253',
   'src/media/cdm/ppapi/api':
