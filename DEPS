...
#  
#  This DEPS file corresponds to Chromium 34.0.1846.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@30960685ec2c5b42e69437d578ef75a7c3d6ad23',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1846@167344',
   'src/third_party/icu':
