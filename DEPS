...
#  
#  This DEPS file corresponds to Chromium 34.0.1774.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@c1e6b6cb125031370cdfc404b3149892b6636e41',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/brotli/src':
      Var("git.chromium.org") + '/external/font-compression-reference.git@931479d735e1121548c3b07aec866fd772cc4932',
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@314',
   'src/chrome/test/data/perf/third_party/octane':
      Var("octane-benchmark") + '/trunk@19',
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@12926',
   'src/third_party/webdriver/pylib':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@243436',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1774@164656',
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12558',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@151',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12558',
   ...
   'src':
      '/branches/1774/src@243487',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@f1632c7d11ca3d75d61e70de7cefe3c57fcc07b4',
   'src/third_party/hunspell':
