  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@d073d6a519a16bb1dabde051f539ab710438f8c4',
    ...
    'android': {
      ...
      'src/third_party/android_tools':
        (Var("git.chromium.org")) + '/android_tools.git@18728e9dd5dd66d4f5edf1b792e77e2b544a1cb0',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@283250',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2095@178282',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@f459c85457c6f470af3fe096fef2524d5443401a',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@532a6a7ece21ca4ea253a196bb5c61a1861d12a0',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@f620cda6d1661f1b2f3214d17b9a254f5c89225f',
  'build':
    '/trunk/tools/build@283396',
