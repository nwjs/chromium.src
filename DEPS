  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@3b879f0d7f8fc1cbbeee4ae82995deeb92b147f9',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@290683',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2129@180624',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@de218041b99e8f9af0e80b34452b0e8d7f770765',
  ...
  'src/third_party/WebKit/LayoutTests/w3c/web-platform-tests':
    (Var("git.chromium.org")) + '/external/w3c/web-platform-tests.git@fd608375f09b02b54ccba4e99be8365769be43c5',
  ...
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@290056',
