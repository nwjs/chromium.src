...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@59bd05976424f46faf39eb0a15b6ff3f7aa476dc',
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@0acf1b4b3645772d220c720313821bac389751b5',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@f3db7ebd7c09149c6c3180165555ce0543d87efa',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@b061b1e2e98ae688ba697cf368b61a174d38b34a',
