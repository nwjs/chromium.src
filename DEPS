...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@851f733337903a11fbb1e6f1158d043ea7684aac',
  'src/breakpad/src':
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@367545d0b46d2b8a494af69ec086df325d04de11',
