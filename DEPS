...
#  
#  This DEPS file corresponds to Chromium 36.0.1960.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@96ad3f201d2df94664766bd61b2de3c8c5016e21',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1960@172688',
   'src/breakpad/src':
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13078',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13078',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@266294',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1895',
   'src/chrome/test/data/perf/canvas_bench':
