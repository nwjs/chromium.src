...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@b41ebe4bc7dc5c0a2afbc459342329ea0a8187a5',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@6a3faf96567a3e523c1396c08ec62af93524e054',
