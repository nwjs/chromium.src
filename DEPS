...
#  
#  This DEPS file corresponds to Chromium 31.0.1623.2
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1623@157344',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@221358',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11090',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@520',
   'build':
      '/trunk/tools/build@221563',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@74',
   'src/third_party/libsrtp':
