...
#  
#  This DEPS file corresponds to Chromium 32.0.1688.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@0516277e5c05f3ebb7b7508f2b91d21ee7e17bb4',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@232184',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1688@161131',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12041',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@522',
   'build':
      '/trunk/tools/build@232239',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@214783',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@229188',
