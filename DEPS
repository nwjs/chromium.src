...
#  
#  This DEPS file corresponds to Chromium 30.0.1562.4
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@0d59139f7759276771fe0cb1487ece0e037d95a4',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@210949',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1562@153974',
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@208922',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9949',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@210952',
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@210834',
   'src/third_party/libsrtp':
