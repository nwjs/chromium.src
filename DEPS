...
#  
#  This DEPS file corresponds to Chromium 36.0.1984.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@ac34fe5e500ab15f073c8504759fca4ae9a317a5',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@269187',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1984@173762',
   'src/breakpad/src':
