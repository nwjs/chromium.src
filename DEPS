  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@ec2839f179aad23e1999e957dc962eaf0045e9a7',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@277931',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2056@176380',
