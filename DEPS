...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@fc15b11ac6d5b710fcc81b360715036b39fc404f',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@f1e44aba7af6a0d6259bb5c34b96b7031414e5c3',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@c5e3a96b83741115bf25847ed23bc20f0daf55f7'
}
