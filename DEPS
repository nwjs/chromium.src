...
#  
#  This DEPS file corresponds to Chromium 36.0.1977.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@a59fd8637181e266295b4bded5837ebfbaa558a7',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@268466',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1977@173395',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1324',
   'src/third_party/openmax_dl':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@268125',
   'src/third_party/swig/Lib':
