...
#  
#  This DEPS file corresponds to Chromium 32.0.1700.76
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@1811',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@99bce39f55240926a75454bb70998ab9f5ce9f13',
      'src/third_party/pyelftools':
      Var("git.chromium.org") + '/chromiumos/third_party/pyelftools.git@bdc1d380acd88d4bfaf47265008091483b0d614e',
      'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@231572',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e7147669478a47fd5030d0637fca60a2e2622b8a',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@e504b737693e96816b40e6ae80d177352c079c18',
...
deps = {
   'src/third_party/skia/include':
      Var("skia") + '/branches/chrome/m32_1700/include@12701',
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/branches/chrome/m32_1700/gyp@12254',
   'src/third_party/webdriver/pylib':
      Var("selenium") + '/trunk/py@18337',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1779',
   'src/third_party/libyuv':
      Var("libyuv") + '/branches/m32@910',
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1700@164518',
   'src/tools/deps2git':
      '/trunk/tools/deps2git@230538',
   'depot_tools':
      '/trunk/tools/depot_tools@232813',
   'src/third_party/bidichecker':
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12321',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12321',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@5080',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src/third_party/libphonenumber/src/test':
      Var("libphonenumber") + '/trunk/cpp/test@621',
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@970fc6bb4285cd43a3bd6a1651d7bdbf70bc97ec',
   'src':
      '/branches/1700_72/src@244343',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@141ef86f4abf255e578320bfe6e42006c251bc39',
   'src/third_party/hunspell':
      '/trunk/deps/third_party/hunspell@206172',
   'src/testing/gtest':
      Var("googletest") + '/trunk@629',
   'src/v8':
      Var("v8") + '/branches/3.22@18417',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@232686',
   'src/third_party/sfntly/cpp/src':
      Var("sfntly") + '/trunk/cpp/src@228',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1222',
   'src/media/cdm/ppapi/api':
   ...
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/branches/chrome-1700/src@318',
   'src/third_party/opus/src':
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.46/webrtc@5249',
   'src/third_party/libjpeg_turbo':
      '/trunk/deps/third_party/libjpeg_turbo@239591',
   'src/third_party/pywebsocket/src':
      Var("pywebsocket") + '/trunk/src@662',
   'commit-queue':
      '/trunk/tools/commit-queue@232822',
   'build/scripts/command_wrapper/bin':
      '/trunk/tools/command_wrapper/bin@135178',
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m32_1700/src@12701',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@522',
   'build':
      '/trunk/tools/build@232851',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@214783',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@232187',
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@1056',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu46@228516',
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@136',
   'src/third_party/yasm/source/patched-yasm':
...
hooks =  [{'action': ['python', 'src/build/download_nacl_toolchains.py', '--no-arm-trusted', '--keep'], 'pattern': '.', 'name': 'nacltools'}, {'action': ['python', 'src/build/linux/install-arm-sysroot.py', '--linux-only'], 'pattern': '.', 'name': 'sysroot'}, {'action': ['python', 'src/chrome/installer/linux/sysroot_scripts/install-debian.wheezy.sysroot.py', '--linux-only', '--arch=amd64'], 'pattern': '.', 'name': 'sysroot'}, {'action': ['python', 'src/chrome/installer/linux/sysroot_scripts/install-debian.wheezy.sysroot.py', '--linux-only', '--arch=i386'], 'pattern': '.', 'name': 'sysroot'}, {'action': ['python', 'src/tools/clang/scripts/update.py', '--mac-only'], 'pattern': '.', 'name': 'clang'}, {'action': ['python', 'src/build/win/setup_cygwin_mount.py', '--win-only'], 'pattern': '.', 'name': 'cygwin'}, {'action': ['python', 'src/build/util/lastchange.py', '-o', 'src/build/util/LASTCHANGE'], 'pattern': '.', 'name': 'lastchange'}, {'action': ['python', 'src/build/util/lastchange.py', '-s', 'src/third_party/WebKit', '-o', 'src/build/util/LASTCHANGE.blink'], 'pattern': '.', 'name': 'lastchange'}, {'action': ['download_from_google_storage', '--platform=win32', '--directory', '--bucket', 'chromium-gn', 'src/tools/gn/bin/win'], 'pattern': '\\.sha1$', 'name': 'gn_win'}, {'action': ['download_from_google_storage', '--platform="linux*"', '--directory', '--bucket', 'chromium-gn', 'src/tools/gn/bin/linux'], 'pattern': '\\.sha1$', 'name': 'gn_linux'}, {'action': ['python', 'src/build/gyp_chromium'], 'pattern': '.', 'name': 'gyp'}, {'action': ['python', 'src/build/landmines.py'], 'pattern': '.', 'name': 'landmines'}] 
