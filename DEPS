vars = {
  'angle_revision':
    '1220bbbd564adcf82df042318006831efeec4502',
  'boringssl_revision':
  ...
  'nacl_revision':
    'daae284c94f4f5b792281a9c922da15849289c85',
  'nss_revision':
    'aab0d08a298b29407397fbb1c4219f99e99431ed',
  'openmax_dl_revision':
    '37b900ccc45cfab71faf4fd332df15369766b94c',
  'pdfium_revision':
    '9b2741829b8a8c511ef0f2f313ff53d77ac96307',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '6df232d251cefe8f3498a1ae4dad449bafa9ebb3',
  'swarming_revision':
    '8fce79620b04bbe5415ace1103db27505bdc4c06',
  'v8_revision':
    'd8763f7b00ac527534f5182b1028aa7f0868bf5d'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@daae284c94f4f5b792281a9c922da15849289c85',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@1220bbbd564adcf82df042318006831efeec4502',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@2e1af43faf9276fe59c3f56bc8ee2cac7abdbd4c',
  ...
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@ad36ba5c48d4f6d17e3086948d1dd85bc8b4c521',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@9b2741829b8a8c511ef0f2f313ff53d77ac96307',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@6df232d251cefe8f3498a1ae4dad449bafa9ebb3',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@4418cf5bb0a42f7bd314742cabd752ce44ee165d',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@d8763f7b00ac527534f5182b1028aa7f0868bf5d'
}
...
hooks = [
  ...
  },
  {
    'action': [
      ...
      'chromium-libcpp',
      '-s',
      'src/third_party/libc++-static/libc++-static.a.sha1'
    ],
    'pattern':
      '.',
    'name':
