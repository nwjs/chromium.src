...
#  
#  This DEPS file corresponds to Chromium 35.0.1896.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@46a12a8e73307a2e1c7263330f9a18574fc33364',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1896@169355',
   'src/third_party/icu':
