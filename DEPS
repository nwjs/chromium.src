...
#  
#  This DEPS file corresponds to Chromium 34.0.1751.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@799eb1b83e20bbd00662b2feb194430d5baebfed',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@12707',
   'src/third_party/webdriver/pylib':
      Var("selenium") + '/trunk/py@18337',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1806',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@915',
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@164030',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@241400',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12707',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@241457',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
