vars = {
  'angle_revision':
    '02df796f466cee47f42130bd8c7dbad6c72a1662',
  'boringssl_revision':
    '7f15ff53d82a1991d6732d2303eb652b1cf7e023',
  'buildspec_platforms':
    'win-asan,',
  'buildtools_revision':
  ...
  'skia_revision':
    '6531c3619f08cc83aad34883c5f00f6a358c9fad',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    '3046be54d26b2ce21d1e24f7434ba46ff75d0968',
  'webkit_revision':
    'a9dfa33c16123b3f93c8a97da79cb0a59a9d865c'
}
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@35530d8677608d637ca4acb0fd590574c7badbef',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@02df796f466cee47f42130bd8c7dbad6c72a1662',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@7f15ff53d82a1991d6732d2303eb652b1cf7e023',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@6531c3619f08cc83aad34883c5f00f6a358c9fad',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@3046be54d26b2ce21d1e24f7434ba46ff75d0968'
}
