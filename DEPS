...
#  
#  This DEPS file corresponds to Chromium 35.0.1866.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@2204e2fcb6e67fe7922a11ad1c3d0973243322b9',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@254321',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1866@168235',
   'src/third_party/icu':
