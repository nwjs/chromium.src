vars = {
  'angle_revision':
    'dd5c5b79333fdde7858a77d39e91cc3d30b74c9e',
  'boringssl_revision':
    'fde89b43c347155798dee8b1210c2c5faabe25f8',
  'buildspec_platforms':
    'win-pgo,',
  'buildtools_revision':
  ...
  'nacl_revision':
    '296d9ac73190fbd37f699461600e83b16ec0d2b3',
  'nss_revision':
    'a676aa04ff18b30983cac03dede5861b3db62c9d',
  'openmax_dl_revision':
    '7a179b97899cf33d4a12c7ef590176c519016f4d',
  'pdfium_revision':
    '628f7053cc646c58c61add247c75bc65ac135327',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    'c60b310af7635204b8186c616ffdd190d8bf5fe1',
  'swarming_revision':
    'df99a00d96fae932bae824dccba13156bf7eddd0',
  'v8_revision':
    '35e626ccab705fb865846f109826361d230a8cd9'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@296d9ac73190fbd37f699461600e83b16ec0d2b3',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@dd5c5b79333fdde7858a77d39e91cc3d30b74c9e',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@fde89b43c347155798dee8b1210c2c5faabe25f8',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@b92be1202589b4530e348aca9cf2a0dcd1263c6a',
  ...
  'src/third_party/openmax_dl':
    (Var("chromium_git")) + '/external/webrtc/deps/third_party/openmax.git@7a179b97899cf33d4a12c7ef590176c519016f4d',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@c60b310af7635204b8186c616ffdd190d8bf5fe1',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@ebe6f8ed69e4853a78c8c095a0e49ff36bfb54b1',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@35e626ccab705fb865846f109826361d230a8cd9'
}
