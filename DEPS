...
deps_os = {
  ...
  'ios': {
    ...
    'src/third_party/WebKit/public':
      (Var("blink")) + '/branches/chromium/2062/public@178179',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2062@178179',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@b572f072cdffa554098f54cd5f0b0d542abe27d0',
