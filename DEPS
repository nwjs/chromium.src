...
#  
#  This DEPS file corresponds to Chromium 34.0.1816.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@3add443016e009b350be3276eb587523eb974454',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1816@166225',
   'src/third_party/icu':
