...
#  
#  This DEPS file corresponds to Chromium 34.0.1766.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@f96fd9b60a4a04aec373d5d75a4195fb39a76fea',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1766@164369',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@242625',
