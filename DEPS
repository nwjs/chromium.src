...
#  
#  This DEPS file corresponds to Chromium 5.0.375.35
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      '/branches/WebKit/375/LayoutTests/platform/chromium-win/fast/workers@46397',
   'src/build/util/support':
      '/trunk/deps/support@46546',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      '/branches/WebKit/375/LayoutTests/storage/domstorage@46397',
   'src/v8':
      'http://v8.googlecode.com/svn/branches/2.1@4555',
   'src':
      '/branches/375/src@46537',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/375/LayoutTests/http/tests/workers@46397',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      '/branches/WebKit/375/WebKitTools/DumpRenderTree@46397',
   'src/third_party/icu':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      '/branches/WebKit/375/LayoutTests/platform/chromium-win/http/tests/workers@46397',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      '/branches/WebKit/375/LayoutTests/platform/chromium-mac/storage/domstorage@46397',
   'src/third_party/WebKit/LayoutTests':
      '/branches/WebKit/375/LayoutTests@46397',
}
