...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@bd260e6841090c51efa44499469aeb5dd21b5d13',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@f5b6bbf852f42299861751885838052577c9b9c6',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@abe28c2ed90d101b0cb61bef5bdc8b19f630fd15'
}
