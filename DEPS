  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@36a7699446c6a0f98012e80afe7dbf20556b71a5',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@5dc21519ce09553910d58c2738608acf96a9df5f',
  'src/breakpad/src':
