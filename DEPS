...
#  
#  This DEPS file corresponds to Chromium 4.0.249.69
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKitLibraries':
         '/branches/WebKit/249/WebKitLibraries@36110',
      'src/third_party/WebKit/WebKit/mac':
         '/branches/WebKit/249/WebKit/mac@36110',
...
deps = {
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      '/branches/WebKit/249/LayoutTests/fast/events@36110',
   'src/third_party/WebKit/WebKit/chromium':
      '/branches/WebKit/249/WebKit/chromium@36110',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      '/branches/WebKit/249/LayoutTests/http/tests/xmlhttprequest@36110',
   'src/third_party/protobuf2/src':
      'http://protobuf.googlecode.com/svn/trunk@219',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/249/LayoutTests/http/tests/workers@36110',
   'src/tools/gyp':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      '/branches/WebKit/249/LayoutTests/http/tests/resources@36110',
   'src/third_party/WebKit/LayoutTests':
      '/branches/WebKit/249/LayoutTests@36110',
   'src':
      '/branches/249/src@36175',
   'src/third_party/icu':
