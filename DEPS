...
#  
#  This DEPS file corresponds to Chromium 33.0.1714.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@ad9695c161005c615a795a42b599c3787db9e969',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1714@162331',
...
hooks =  [{'action': ['python', 'src/build/download_nacl_toolchains.py', '--no-arm-trusted', '--keep'], 'pattern': '.', 'name': 'nacltools'}, {'action': ['python', 'src/build/linux/install-arm-sysroot.py', '--linux-only'], 'pattern': '.', 'name': 'sysroot'}, {'action': ['python', 'src/chrome/installer/linux/sysroot_scripts/install-debian.wheezy.sysroot.py', '--linux-only', '--arch=amd64'], 'pattern': '.', 'name': 'sysroot'}, {'action': ['python', 'src/chrome/installer/linux/sysroot_scripts/install-debian.wheezy.sysroot.py', '--linux-only', '--arch=i386'], 'pattern': '.', 'name': 'sysroot'}, {'action': ['python', 'src/tools/clang/scripts/update.py', '--mac-only'], 'pattern': '.', 'name': 'clang'}, {'action': ['python', 'src/build/win/setup_cygwin_mount.py', '--win-only'], 'pattern': '.', 'name': 'cygwin'}, {'action': ['python', 'src/build/util/lastchange.py', '-o', 'src/build/util/LASTCHANGE'], 'pattern': '.', 'name': 'lastchange'}, {'action': ['python', 'src/build/util/lastchange.py', '-s', 'src/third_party/WebKit', '-o', 'src/build/util/LASTCHANGE.blink'], 'pattern': '.', 'name': 'lastchange'}, {'action': ['download_from_google_storage', '--platform=win32', '--directory', '--bucket', 'chromium-gn', 'src/tools/gn/bin/win'], 'pattern': '\\.sha1$', 'name': 'gn_win'}, {'action': ['download_from_google_storage', '--platform=darwin', '--directory', '--bucket', 'chromium-gn', 'src/tools/gn/bin/mac'], 'pattern': '\\.sha1$', 'name': 'gn_mac'}, {'action': ['download_from_google_storage', '--platform=linux*', '--directory', '--bucket', 'chromium-gn', 'src/tools/gn/bin/linux'], 'pattern': '\\.sha1$', 'name': 'gn_linux'}, {'action': ['python', 'src/build/gyp_chromium'], 'pattern': '.', 'name': 'gyp'}, {'action': ['python', 'src/build/landmines.py'], 'pattern': '.', 'name': 'landmines'}] 
