...
deps_os = {
  ...
  'unix': {
    ...
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@d2eb139b58ab885610685b199f9f3d05ec892082',
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@46627dde181cc50795ecd4fec764dd577abdc570',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@f6f8050837c3236b8c3aa4cbd83625ed831f4cd0',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@1a45bb0408801eae541d77d2a39a08802e9701dd',
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@5c5e924788fe40f7d6e0a3841ac572de2475e689',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@0eaee17e0e391aa6559937c11e948b831e31d8cf',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@33737cb256a7da2774f28a00aaee76b0df5dbcb8',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@d306f165a462f47c2c0e8f3a0f2b4ae6950f70ed',
