...
deps_os = {
  ...
  'ios': {
    ...
    'src/third_party/WebKit/public':
      (Var("blink")) + '/branches/chromium/2062/public@180870',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2062@180870',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@413546c54f7ab90c8b584a2f7056fabd4f918acf',
  ...
  'src/native_client':
    (Var("native_client")) + '/branches/2062/src/native_client@13656',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/branches/2062/src/native_client/tests/prebuilt@13656',
