...
#  
#  This DEPS file corresponds to Chromium 36.0.1935.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e6a48a721ba93f9304feb2d26cc8c0d6494aa981',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@263142',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1935@171313',
   'src/breakpad/src':
