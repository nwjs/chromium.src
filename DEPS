...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      (Var("git.chromium.org")) + '/chromium/deps/nss.git@e2e35dbd9b41c0e5cb8485f13831cd61eb484196'
  },
  'mac': {
  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@1329fb6337466eabb4cac8a60d56cedc85620083',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291619',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@f0e57d49d0f3a0e43e0db29852ef9779a98505bd',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@76db31a2ca11da4dd45016e964b2e49f39f3dd49',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@3f998aa8b2fd6ea40b7bc9a403bea27e8798c805',
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@2328da46142d2abb4fbe08a6ac056f50e6df0e61',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@172d4941a79a3354b918f85bc9a3ea9c134fc1ad',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@6474a1cfee1cdad45de5cc96960085e1c7daf11c',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@563c46bb2d0e5d5c8b7d2c6c0c50f0283e9087de',
