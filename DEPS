...
#  
#  This DEPS file corresponds to Chromium 4.0.223.0
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKit/mac':
         'http://svn.webkit.org/repository/webkit/trunk/WebKit/mac@49583',
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@49583',
...
deps = {
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/events@49583',
   'src/third_party/WebKit/WebKit/chromium':
      'http://svn.webkit.org/repository/webkit/trunk/WebKit/chromium@49583',
   'src/third_party/pywebsocket':
      'http://pywebsocket.googlecode.com/svn/trunk/src@45',
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/trunk/WebCore@49583',
   'src/breakpad/src':
      'http://google-breakpad.googlecode.com/svn/trunk/src@402',
   'chromeos':
      'svn://chrome-svn/chromeos/trunk/tools/chrome-deps@50',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/workers@49583',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/xmlhttprequest@49583',
   'src/third_party/protobuf2/src':
      'http://protobuf.googlecode.com/svn/trunk@219',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/workers@49583',
   'src/third_party/cros':
      'svn://chrome-svn/chromeos/trunk/src/platform/cros@43',
   'src/tools/gyp':
   ...
   'src/third_party/WebKit/JavaScriptCore':
      'http://svn.webkit.org/repository/webkit/trunk/JavaScriptCore@49583',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/js/resources@49583',
   'src/native_client':
      'http://nativeclient.googlecode.com/svn/trunk/src/native_client@852',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@19546',
   'src/build/util/support':
      '/trunk/deps/support@29186',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/storage/domstorage@49583',
   'src/chrome/tools/test/reference_build':
      '/trunk/deps/reference_builds@25513',
   'src/third_party/chromeos_login_manager':
      'svn://chrome-svn/chromeos/trunk/src/platform/login_manager/chromeos_login_manager@30',
   'src/v8':
      'http://v8.googlecode.com/svn/trunk@3030',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/resources@49583',
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests@49583',
   'src':
      '/trunk/src@29072',
   'src/third_party/icu':
   ...
   'src/third_party/chromeos_login_manager/include':
      'svn://chrome-svn/chromeos/trunk/src/third_party/pam-dev@30',
