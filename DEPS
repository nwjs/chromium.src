...
#  
#  This DEPS file corresponds to Chromium 34.0.1786.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@88675b486f8595db95727d31443a9deee2b261ba',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@244801',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1786@165108',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@244792',
