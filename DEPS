...
#  
#  This DEPS file corresponds to Chromium 3.0.195.36
#  
#  
#  
deps_os = {
...
deps = {
   'src/chrome/test/data/workers/LayoutTests/http/tests/xmlhttprequest':
      '/branches/WebKit/195/LayoutTests/http/tests/xmlhttprequest@31628',
   'src/third_party/WebKit/WebCore':
      '/branches/WebKit/195/WebCore@31628',
   'src/breakpad/src':
   ...
   'src/chrome/test/data/workers/LayoutTests/http/tests/workers':
      '/branches/WebKit/195/LayoutTests/http/tests/workers@31628',
   ...
   'src/chrome/test/data/workers/LayoutTests/http/tests/resources':
      '/branches/WebKit/195/LayoutTests/http/tests/resources@31628',
   'src/tools/gyp':
