...
#  
#  This DEPS file corresponds to Chromium 35.0.1907.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@89abdc9c736007d523fc4cd5d2c3e44c71a59b63',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1907@169852',
   'src/third_party/icu':
