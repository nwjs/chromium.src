...
#  
#  This DEPS file corresponds to Chromium 14.0.796.0
#  
#  
#  
deps_os = {
   'win': {
      ...
      'src/third_party/mingw-w64/mingw/bin':
         'http://src.chromium.org/native_client/trunk/src/third_party/mingw-w64/mingw/bin@5675',
      'src/third_party/nss':
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@89132',
      'src/third_party/lighttpd':
   ...
   'unix': {
      ...
      'src/third_party/cros':
         'http://git.chromium.org/git/cros.git@b8dadccc',
      'src/third_party/WebKit/Tools/gdb':
         'http://svn.webkit.org/repository/webkit/trunk/Tools/gdb@89132',
      'src/third_party/lss':
...
deps = {
   'src/native_client':
      'http://src.chromium.org/native_client/trunk/src/native_client@5679',
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@1613',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/xmlhttprequest@89132',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium/fast/workers@89132',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/js/resources@89132',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/http/tests/workers@89132',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/resources@89132',
   'src/third_party/skia/gpu':
      'http://skia.googlecode.com/svn/trunk/gpu@1613',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/storage/domstorage@89132',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/events@89132',
   'src/third_party/bidichecker':
      'http://bidichecker.googlecode.com/svn/trunk/lib@4',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/workers@89132',
   'src/third_party/WebKit/Source':
      'http://svn.webkit.org/repository/webkit/trunk/Source@89132',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/workers@89132',
   'src/testing/gmock':
      'http://googlemock.googlecode.com/svn/trunk@374',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      'http://src.chromium.org/native_client/trunk/src/native_client/tests/prebuilt@5679',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/filesystem/workers@89132',
   'src/tools/gyp':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/storage/domstorage@89132',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@19546',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/filesystem/resources@89132',
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      'http://svn.webkit.org/repository/webkit/trunk/Tools/DumpRenderTree@89132',
   'src/third_party/hunspell':
      '/trunk/deps/third_party/hunspell@65351',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/appcache':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/appcache@89132',
   'src/testing/gtest':
      'http://googletest.googlecode.com/svn/trunk@560',
   'src/v8':
      'http://v8.googlecode.com/svn/trunk@8294',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@88361',
   'src/third_party/skia/third_party/glu':
      'http://skia.googlecode.com/svn/trunk/third_party/glu@1613',
   'src/breakpad/src':
      'http://google-breakpad.googlecode.com/svn/trunk/src@786',
   'chromeos':
      '/trunk/src/tools/cros.DEPS@89586',
   'src/googleurl':
      'http://google-url.googlecode.com/svn/trunk@157',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/fast/events@89132',
   'src/third_party/leveldb':
      'http://leveldb.googlecode.com/svn/trunk@31',
   'src/third_party/scons-2.0.1':
      'http://src.chromium.org/native_client/trunk/src/third_party/scons-2.0.1@5675',
   'src/third_party/webdriver/python/selenium':
      'http://selenium.googlecode.com/svn/trunk/py/selenium@12107',
   'src/third_party/pylib':
      'http://src.chromium.org/native_client/trunk/src/third_party/pylib@5675',
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests@89132',
   'src/third_party/snappy/src':
      'http://snappy.googlecode.com/svn/trunk@37',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/websocket/tests@89132',
   'src/third_party/webrtc':
      'http://webrtc.googlecode.com/svn/trunk@90',
   'src/chrome/test/data/layout_tests/LayoutTests/media':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/media@89132',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/fast/events@89132',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/storage/domstorage@89132',
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@1613',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/fast/workers@89132',
   'src/third_party/WebKit/Tools/Scripts':
      'http://svn.webkit.org/repository/webkit/trunk/Tools/Scripts@89132',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/filesystem':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/filesystem@89132',
   'src/third_party/icu':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/http/tests/workers@89132',
   'src/third_party/angle':
      'http://angleproject.googlecode.com/svn/trunk@695',
...
hooks =  [{'action': ['python', 'src/build/gyp_chromium'], 'pattern': '.'}, {'action': ['python', 'src/build/download_nacl_irt.py', '--nacl_revision', '5679', '--file_hash', 'x86_32', '06efd9f7182db27a8d17f910dd001230a4032ab5', '--file_hash', 'x86_64', 'ebb81e9511c2deebbbd2bcfd642b1bb25a9c6f44'], 'pattern': '.'}] 
