vars = {
  ...
  'skia_revision':
    '0dacc6708d5db4fbe755d7b1d0716b51fe703058',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    '7a78a35508ae6349c23bb062debb9bc3e6e86776',
  'webkit_revision':
    '15bb4ef225b134af2a844d15c782869c4a169de6'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@4e75a2959c8c77f68890c29c5082e2a67c99de6f',
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@589eeaede4307a8ec68689c4b4ef8881fd4c69cd',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@0b420e23cd618a42ec1ec567a3e8104ea716847e',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@0dacc6708d5db4fbe755d7b1d0716b51fe703058',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@b2f1cafd39a20437784f1d5b309d1ce037307b31',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@7a78a35508ae6349c23bb062debb9bc3e6e86776'
}
