...
#  
#  This DEPS file corresponds to Chromium 34.0.1847.37
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.50/webrtc@5611',
   'src/tools/deps2git':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1847@167989',
   'src/third_party/icu':
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@4df02c1ed5e97dd54576b06964b1da67ea30238e',
   'src/v8':
      Var("v8") + '/branches/3.24@19582',
