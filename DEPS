...
deps = {
  ...
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@c2134737833d56e9d01ca4454e80e04a2a26c686',
  'src/buildtools':
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@e67278f243e8221b7a02d2d72be6c1112ef52614',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@68fcd28fbed59311bccea513b5a1e03081279aa0'
}
