...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@279dba5178327254491418982674bd6b5e14761d',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@6eacfefdedea875056ed9d4a3a7f45047728a148',
