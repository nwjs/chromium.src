...
#  
#  This DEPS file corresponds to Chromium 30.0.1599.13
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1599@156272',
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@74',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.38/webrtc@4552',
   'src/third_party/libjpeg_turbo':
