...
#  
#  This DEPS file corresponds to Chromium 34.0.1830.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@950e41a5a9c532a78ac6ac3383f16392e09b872b',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1830@166768',
   'src/third_party/icu':
