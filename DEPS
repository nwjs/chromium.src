  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@026a36f0f5b6e5a1bc26cca5ef37c174119530ad',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@278190',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2058@176480',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@b59161f0000eb4aca3dcef29f27ffd0fb5a568e5',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13371',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13371',
