...
#  
#  This DEPS file corresponds to Chromium 18.0.967.0
#  
#  
#  
...
deps = {
   ...
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@2824',
   ...
   'src/third_party/skia/third_party/glu':
      'http://skia.googlecode.com/svn/trunk/third_party/glu@2824',
   ...
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@2824',
