...
#  
#  This DEPS file corresponds to Chromium 31.0.1635.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@853294a8338c4e72336839f0958c2c6a4dec1ae4',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1635@157984',
