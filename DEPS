...
#  
#  This DEPS file corresponds to Chromium 34.0.1772.1
#  
#  
#  
vars = {
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@243221',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1772@164551',
