...
#  
#  This DEPS file corresponds to Chromium 30.0.1550.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@dd10d8216938359b91ed768c028dac0bd2cff9ac',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@209040',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1550@153188',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9783',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@515',
   'build':
      '/trunk/tools/build@209060',
