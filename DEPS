...
#  
#  This DEPS file corresponds to Chromium 33.0.1705.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@233722',
   },
   'mac': {
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@f560e2999631c5611f5dbc4ef52d36b8995918b7',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@233983',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1705@161695',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12352',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12352',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@233952',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12182',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@524',
   'build':
      '/trunk/tools/build@234145',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@214783',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@233439',
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@9c318342233f68b915d39c8f1f181b9ef545c4db',
   'src/tools/grit':
