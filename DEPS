...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@16ef18ec3ef9e16240e7ac564bdeed51c6639188',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@ede18442c25632073202aa817272f9b5fbd24687',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@fe66e723f6a575d814e559e9850eb741d2b1c0dd',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@e5ed4dea0043eab9e806f816ed7d9a6d56ce85db',
