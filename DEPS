...
#  
#  This DEPS file corresponds to Chromium 32.0.1700.16
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1700@161955',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m32_1700/src@12254',
   'src/third_party/webpagereplay':
