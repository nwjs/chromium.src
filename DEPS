...
#  
#  This DEPS file corresponds to Chromium 30.0.1554.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@790b57afc871de27e0bdcdaa229794eb185bc121',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@209825',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1554@153467',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9849',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@516',
   'build':
      '/trunk/tools/build@209865',
