...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@a97e034cf5dece4e2e8d0e59415608d6aa443412',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@6e613a81b7fce85ca6278ba4f7461522c2a6ef3c',
