...
#  
#  This DEPS file corresponds to Chromium 35.0.1902.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@257452',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@26a32fcb2afed4a3ec12070388d752dd795dac8e',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@25f309abfacfeaadb205dad2b01597edd151408b',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@157',
   'src':
      '/branches/1902/src@258497',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@985',
   'src/third_party/hunspell':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@258189',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1902@169717',
   'src/third_party/icu':
