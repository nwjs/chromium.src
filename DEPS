...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@89499d76b9616a455dfe8257cef9e4489938ea22',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@2488ae1967a4285abf544c0b9f8e0fb2edfab2da',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@3b1c6cbf162dbe8a4718dacff7ea9bd10fc26594',
