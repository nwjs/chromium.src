...
#  
#  This DEPS file corresponds to Chromium 28.0.1500.28
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/storage/indexeddb@151330',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/http/tests/appcache@151330',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@313',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/platform/chromium-win/http/tests/workers@151330',
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/http/tests/workers@151330',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/fast/workers@151330',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/media@151330',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/webkit/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@181763',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/storage/domstorage@151330',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@74',
   'src/third_party/webrtc':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/http/tests/resources@151330',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/platform/chromium-win/fast/workers@151330',
   ...
   'src/content/test/data/layout_tests/LayoutTests/editing/pasteboard/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/editing/pasteboard/resources@151330',
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/fast/filesystem@151330',
   'src/native_client':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/platform/chromium-win/storage/domstorage@151330',
   'build/third_party/lighttpd':
      '/trunk/deps/third_party/lighttpd@58968',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/http/tests/xmlhttprequest@151330',
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/platform/chromium-win/fast/events@151330',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/fast/files@151330',
   'src/sdch/open-vcdiff':
      Var("open-vcdiff") + '/trunk@42',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/fast/events@151330',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500@151330',
   'src/third_party/icu':
   ...
   'src/v8':
      Var("v8") + '/branches/3.18@14837',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@197977',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/http/tests/websocket/tests@151330',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1500/LayoutTests/fast/js/resources@151330',
}
