  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@89663559344f6360bddecdd3461a67384dd2add7',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2061@176614',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@9efd66b8451f25465abd1027e09a3bcfa7b9c554',
