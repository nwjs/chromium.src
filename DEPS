...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@7a83d9ae22d65d67b47853d43226328e16aff839',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292613',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@99db3b13088827e01cbb6ca212f5cd10f827cf55',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@c6d2d2f03cd79ef4f11effe5485eab1e5fa8a10a',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@b404893cc89fe7419e614abccb1fddf69d308abc',
