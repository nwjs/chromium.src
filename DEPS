...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@29eb68c00c7cfdce0c2731c8051bff3f1b1b09ec',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@4fc48af0d7bec93a911d32330f251386a8adec98',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@35c1d9ec688d02316c7e4bb4beb2fa8d9ef37dbb',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@fa64cdbeef886519a0471d82935050b8b829bd25',
  'src/breakpad/src':
