...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@9c427e14bb43a1296397530574d2877a379fa6e7',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293685',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@3e3b58d57a358e2d52bc23ad2409a95d59310100',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@17875586859e9de41bb271ee219c7113e0e78676',
  ...
  'build':
    '/trunk/tools/build@293731',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@194ec65a55edf24c1976d4265f57e8c90ef5bb2f',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@2a30ccefd0c47608380a1621a983bf46685e5ad9',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@4363ee9b88d6acfcfedfb7510d53ad611dba1fa3',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@3efdae6669030b03a841c8d579655ba1f36b1f87',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@3fdc59b241fdf9dc08d4073a23eb85328340e856',
