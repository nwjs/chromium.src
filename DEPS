  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@9365502c079a6a376b7f6f83556e920146925f64',
    ...
    'android': {
      ...
      'src/third_party/android_tools':
        (Var("git.chromium.org")) + '/android_tools.git@c6e658065e7ad80477390424bb5388da6e936d07',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@276208',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2043@175936',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@5713352a64936428d37a721382d021f4a9002172',
