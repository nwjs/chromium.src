...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@a3c75b031cc61029c3d957a7bce95f83101ebeba',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@1236eaff59c2213cb2ddb73d777987f10d045969',
