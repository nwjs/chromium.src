...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@cc7b849301932388919e3c0e87765718645a2adf',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@a629cbc84a4828e990a9f7a82d9af045935e996c',
  'src/breakpad/src':
