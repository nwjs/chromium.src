...
#  
#  This DEPS file corresponds to Chromium 35.0.1867.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@7869070890bf4fe84949656f76bfda7acc54705e',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1867@168253',
   'src/third_party/icu':
