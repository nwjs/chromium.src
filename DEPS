  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@22b43062cc51937994712fad06c722b28d1d36a0',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@105703b3eee3e0aa988ebc778fba8911fafa1195',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@14ff016b8100e5b34fccac4fcf08b8f2e46b02bd',
