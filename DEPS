...
#  
#  This DEPS file corresponds to Chromium 9.0.574.0
#  
#  
#  
deps_os = {
   'win': {
      ...
      'src/third_party/ffmpeg/binaries/chromium/win/ia32':
         '/trunk/deps/third_party/ffmpeg/binaries/win@65216',
...
deps = {
   ...
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg/source@65216',
