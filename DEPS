...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@6e19265517aa18306c5f93b9a6eeebbcb285c91c',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293199',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@4de8a4dcf70fdaef7ff4e875e6f7c018053491d7',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@c843d4c08d6599a79edd9f299f6ed0e3baabbfc6',
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@57c3d7c9f1f86525f120337b47d6ebd586215e1e',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@5e7bfaf5530837b94fa0c05189c0ab601e3a6355',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@64bec311643752b040741ef8b2d293e75c31218a',
