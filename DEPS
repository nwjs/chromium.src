vars = {
  'angle_revision':
    '9bbfdd63f56ebc70f03b67e7bad8bc64c799b8fa',
  'boringssl_revision':
  ...
  'nacl_revision':
    '8191c1a953ca5896c715cb21e7a24d8c092f925f',
  'nss_revision':
    'aab0d08a298b29407397fbb1c4219f99e99431ed',
  'openmax_dl_revision':
    '22bb1085a6a0f6f3589a8c3d60ed0a9b82248275',
  'pdfium_revision':
    '0de47533e05ce7ca80c48156d50a217993e97288',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    'b607767703ff7898611cf88c1218d5d69535e984',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    '2814c22bb3668cf06cd4002bd921f8e70d0f6111',
  'webkit_revision':
    '2a9b0cf27179ee8b04f55ea64282127f67e43a3a'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@8191c1a953ca5896c715cb21e7a24d8c092f925f',
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@c11f69e73095351545d573ac35761ca369f04804',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@9bbfdd63f56ebc70f03b67e7bad8bc64c799b8fa',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@8c44aaca8597349a70c7e05bace3a846df0a4f38',
  ...
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@a0fca88b1dbaf28658500bfe04bb9f7fbb3b22f2',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@0de47533e05ce7ca80c48156d50a217993e97288',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@b607767703ff7898611cf88c1218d5d69535e984',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@81e601bac2f042b8afd584e6839f575e2fcbd152',
  'src/third_party/yasm/source/patched-yasm':
    (Var("chromium_git")) + '/chromium/deps/yasm/patched-yasm.git@4671120cd8558ce62ee8672ebf3eb6f5216f909b',
  'src/tools/deps2git':
    (Var("chromium_git")) + '/chromium/tools/deps2git.git@f04828eb0b5acd3e7ad983c024870f17f17b06d9',
  'src/tools/grit':
    (Var("chromium_git")) + '/external/grit-i18n.git@1f898f7208b45cdc0127009701054ffee7990188',
  'src/tools/gyp':
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@2814c22bb3668cf06cd4002bd921f8e70d0f6111'
}
