...
#  
#  This DEPS file corresponds to Chromium 9.0.577.0
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKit/mac':
         'http://svn.webkit.org/repository/webkit/trunk/WebKit/mac@71558',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@50870',
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@71558',
...
deps = {
   ...
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/trunk/WebCore@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/workers@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/xmlhttprequest@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium/fast/workers@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/js/resources@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/http/tests/workers@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/resources@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/storage/domstorage@71558',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/events@71558',
   'src/third_party/ots':
      'http://ots.googlecode.com/svn/trunk@35',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/workers@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/fast/workers@71558',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/filesystem/workers@71558',
   'src/tools/gyp':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/storage/domstorage@71558',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@19546',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/filesystem/resources@71558',
   'src/third_party/py/simplejson':
      'http://simplejson.googlecode.com/svn/trunk/simplejson@217',
   'src/build/util/support':
      '/trunk/deps/support@65518',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/storage/domstorage@71558',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/appcache':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/appcache@71558',
   'src/testing/gtest':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/fast/events@71558',
   'src/third_party/WebKit/JavaScriptCore':
      'http://svn.webkit.org/repository/webkit/trunk/JavaScriptCore@71558',
   'src/third_party/speex':
      '/trunk/deps/third_party/speex@56515',
   'src/third_party/libsrtp/src':
      '/trunk/deps/third_party/libsrtp@60080',
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/websocket/tests@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/media':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/media@71558',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/fast/events@71558',
   ...
   'src/third_party/WebKit/WebKit/chromium':
      'http://svn.webkit.org/repository/webkit/trunk/WebKit/chromium@71558',
   ...
   'src/third_party/WebKit/WebKitTools/Scripts':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/Scripts@71558',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg/source@65312',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/DumpRenderTree@71558',
   'src/third_party/icu':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/http/tests/workers@71558',
