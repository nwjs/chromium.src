...
#  
#  This DEPS file corresponds to Chromium 12.0.717.0
#  
#  
#  
deps_os = {
   ...
   'unix': {
      ...
      'src/third_party/cros':
         'http://git.chromium.org/git/cros.git@88971818',
