vars = {
  ...
  'skia_revision':
    '19fb80ed14efbe9762d417fe183def089fa7cb6c',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    '7fb2c3b6db3f889ea95851ca11dcb731b07a7925',
  'webkit_revision':
    '1e9af2f2d8b3e55dd5888a987d2146ea845fa622'
}
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@01c887759e2534b3757dc4e583e12b21995e77ce',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@19fb80ed14efbe9762d417fe183def089fa7cb6c',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@7fb2c3b6db3f889ea95851ca11dcb731b07a7925'
}
