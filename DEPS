...
#  
#  This DEPS file corresponds to Chromium 31.0.1615.0
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@1740',
   ...
   'ios': {
      ...
      None,
      'src/ios_internal/third_party/gtm-http-fetcher/src':
      'http://gtm-http-fetcher.googlecode.com/svn/trunk@109',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@2dd0ae56d3d88aedc921531a3cc7e4c8e91967d9',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@ac0b8f61e8c8def0961f53900504c095d2b71963',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@219121',
   'src/third_party/bidichecker':
   ...
   'src/third_party/cld2':
      Var("cld2") + '/trunk@19',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@156861',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12072',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12072',
   'src/third_party/leveldatabase/src':
