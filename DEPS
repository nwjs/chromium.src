...
#  
#  This DEPS file corresponds to Chromium 6.0.445.1
#  
#  
#  
deps_os = {
   ...
   'unix': {
      'src/third_party/cros':
         'http://src.chromium.org/git/cros.git@941c698c',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@29937',
