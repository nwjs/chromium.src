...
deps = {
  'build':
    (Var("git.chromium.org")) + '/a/chromium/tools/build.git@2e75124b5fecbf50ab4af10d78a73678657b41b6',
  'build/scripts/command_wrapper/bin':
    (Var("git.chromium.org")) + '/a/chromium/tools/command_wrapper/bin.git@2eeebba9a512cae9e4e9312f5ec728dbdad80bd0',
  'build/scripts/gsd_generate_index':
    (Var("git.chromium.org")) + '/a/chromium/tools/gsd_generate_index.git@d2f5d5a5d212d8fb337d751c0351644a6ac83ac8',
  'build/scripts/private/data/reliability':
    (Var("git.chromium.org")) + '/a/chromium/src/chrome/test/data/reliability.git@ba644102a2f81bb33582e9474a10812fef825389',
  'build/scripts/tools/deps2git':
    (Var("git.chromium.org")) + '/a/chromium/tools/deps2git.git@27ce444f50f3c6732982d225d3f4cf67f0979a98',
  'build/third_party/gsutil':
    (Var("git.chromium.org")) + '/a/external/gsutil/src.git@5cba434b828da428a906c8197a23c9ae120d2636',
  'build/third_party/gsutil/boto':
    (Var("git.chromium.org")) + '/a/external/boto.git@98fc59a5896f4ea990a4d527548204fed8f06c64',
  'build/third_party/lighttpd':
    (Var("git.chromium.org")) + '/a/chromium/deps/lighttpd.git@9dfa55d15937a688a92cbf2b7a8621b0927d06eb',
  'depot_tools':
    (Var("git.chromium.org")) + '/a/chromium/tools/depot_tools.git@3f722d1f6358963ad61824e78b97335fb63b1868',
  'src-internal': None,
  'src/breakpad/src':
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@ec2d51e124a58435534985710f421145d10b093e',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@d7ff8da04f9f0449283db45b2ca07660b9d18fc9',
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@fd216c41f7413b7eb4b8009ba26690b37b9a9302',
  'src/third_party/bidichecker':
    (Var("git.chromium.org")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@8a228f5bfe82e8178fc42262a1cc21e82c3f8bf8',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@fe54215b7c0a3d0d544857ea4c3e6785ed3eec8c',
  ...
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@77656a4795275f4a83013b01b301509c5db31b29',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@038b01c081d16e3e3ec3e874c816ee866ab73508',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@473c6c4e8722676153d3449c67094aa55d6f6799',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@7b929e8d526f741f5001f9c79eea0db02c88a188',
  ...
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@29e94a3285ee899d14d5e56a6001682620d3778f',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@ecb5f34dbab5f89979915054292b3945de6e7dcd'
}
...
deps_os = {
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@3c5189b5b05fad7e0bcfb60835bde75d4211964c',
    ...
    'src/third_party/freetype':
      (Var("git.chromium.org")) + '/chromium/src/third_party/freetype.git@d1028db70bea988d1022e4d463de66581c696160',
  ...
  'unix': {
    'build/third_party/xvfb':
      (Var("git.chromium.org")) + '/a/chromium/tools/third_party/xvfb.git@aebb1aadf1422e4d81e831e13746b8f7ae322e07',
    ...
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@3b950126eee9cb1c55ab36c2dd5a89bfb05b5034',
