...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@276493',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2046@176030',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@b0b1aa04ed82a7cb16c7e6a06d92a411d7bd3749',
