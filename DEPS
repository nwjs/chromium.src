...
#  
#  This DEPS file corresponds to Chromium 6.0.472.63
#  
#  
#  
deps_os = {
   'win': {
      ...
      'src/rlz':
         'http://rlz.googlecode.com/svn/branches/chrome472@21',
   },
   'mac': {
      'src/third_party/GTM':
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/472/LayoutTests/http/tests/workers@59685',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      '/branches/WebKit/472/LayoutTests/http/tests/xmlhttprequest@59685',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      '/branches/WebKit/472/LayoutTests/platform/chromium-win/storage/domstorage@59685',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      '/branches/WebKit/472/LayoutTests/platform/chromium-win/fast/workers@59685',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      '/branches/WebKit/472/WebKitTools/DumpRenderTree@59685',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu42@51076',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      '/branches/WebKit/472/LayoutTests/platform/chromium-win/http/tests/workers@59685',
