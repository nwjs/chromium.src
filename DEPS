...
#  
#  This DEPS file corresponds to Chromium 32.0.1676.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@7c2c0b11157738ada63b069b00ec5de9afa17820',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@229245',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1676@160026',
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@228254',
   'src/third_party/opus/src':
