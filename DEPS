  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@669eb5ed489ba2e37516b0403a56ec0b663a6819',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@279207',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2067@176843',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@6fc763e3c2b1e539510cb18ece8b97e183099ab1',
