...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@4c69f08467357fae3e24648d15de6068ff8fb85a',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@e333d39e2e3fa7ddfb49a990619b10ff3e9411d6',
