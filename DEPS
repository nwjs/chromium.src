...
#  
#  This DEPS file corresponds to Chromium 37.0.1991.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@573193c3f838d4b6144b01168a198149e5301118',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1991@174001',
   'src/breakpad/src':
