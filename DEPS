...
#  
#  This DEPS file corresponds to Chromium 37.0.1989.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@c89829c99d6f6c2e1dfa25b47b415f257f6d547a',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@269865',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1989@173929',
   'src/breakpad/src':
