...
#  
#  This DEPS file corresponds to Chromium 17.0.963.29
#  
#  
#  
...
deps_os = {
   ...
   'unix': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/Tools/gdb@104175',
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/fast/workers@104175',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/http/tests/xmlhttprequest@104175',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/platform/chromium-cg-mac/storage/domstorage@104175',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/platform/chromium/fast/workers@104175',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/fast/js/resources@104175',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/http/tests/resources@104175',
   'src/third_party/libyuv':
      'http://libyuv.googlecode.com/svn/trunk@64',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/storage/domstorage@104175',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/fast/events@104175',
   'src/third_party/bidichecker':
      'http://bidichecker.googlecode.com/svn/trunk/lib@4',
   'src/third_party/ots':
      'http://ots.googlecode.com/svn/trunk@74',
   'src/third_party/WebKit/Source':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/Source@104175',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/http/tests/workers@104175',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/platform/chromium-win/fast/workers@104175',
   'src/testing/gmock':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/fast/filesystem/workers@104175',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/platform/chromium-win/storage/domstorage@104175',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@102714',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/fast/filesystem/resources@104175',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/http/tests/appcache@104175',
   'src/testing/gtest':
      'http://googletest.googlecode.com/svn/trunk@560',
   'src/v8':
      'http://v8.googlecode.com/svn/branches/3.7@10317',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/platform/chromium-win/fast/events@104175',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/platform/chromium-cg-mac/fast/events@104175',
   'src/third_party/WebKit/Tools/DumpRenderTree':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/Tools/DumpRenderTree@104175',
   ...
   'src/third_party/WebKit/Tools/Scripts':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/Tools/Scripts@104175',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/filesystem':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/http/tests/filesystem@104175',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/platform/chromium-cg-mac/http/tests/workers@104175',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/LayoutTests/platform/chromium-win/http/tests/workers@104175',
   'src/third_party/WebKit/Tools/TestWebKitAPI':
      Var("webkit_trunk")[:-6] + '/branches/chromium/963/Tools/TestWebKitAPI@104175',
