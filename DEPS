...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@6fae22a7e6a7e0957ffc3015ba8439e9cb164ba2',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@2b8a30b8b575bf00f6c4260d8d093241a6d7f20a'
}
