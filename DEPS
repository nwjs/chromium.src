...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@294077',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@9e447c08deb30b26a2101cb20b8a04aa230f09c4',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@256a568798c0644a9f9c50bc30ed4850500043a8',
  'src/breakpad/src':
