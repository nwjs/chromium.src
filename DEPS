...
#  
#  This DEPS file corresponds to Chromium 34.0.1782.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@bd6a8cd698b3adb0628958b065ecf5363de75518',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@244276',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1782@164946',
   ...
   'src':
      '/branches/1782/src@244460',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@7124e396edf2801f23cf794bb1f08119c491ccf6',
   'src/third_party/hunspell':
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@244188',
