vars = {
  'angle_revision':
    'c5b2ba53591c98d5f1c539dc8fcab6f76cc6318e',
  'boringssl_revision':
    '231cb8214511ea5784dd94a59f3e5f5fb7d39f8e',
  'buildspec_platforms':
    'all',
  'buildtools_revision':
  ...
  'libvpx_revision':
    '0d6551cd1e1359423a7f4af503472d280437e9bb',
  'lighttpd_revision':
    '9dfa55d15937a688a92cbf2b7a8621b0927d06eb',
  'lss_revision':
    '4fc942258fe5509549333b9487ec018e3c8c5b10',
  'nacl_revision':
    'ab6b563f687bc293b87aec47cd27a2f30a995991',
  'nss_revision':
  ...
  'skia_revision':
    '1052f51a7da744b8fd8b7d89e0a3a13725c3e6b2',
  'swarming_revision':
    'f71d1a3fbe207d91bb2f0bd96c8821ff90bb7c28',
  'v8_revision':
    'a3a266a8135e31261e8f41c470445b4e2a51b2dd',
  'webkit_revision':
    'c16050bc8a1f1666592bf399a6731dfe2fbe0900'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@ab6b563f687bc293b87aec47cd27a2f30a995991',
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@c16050bc8a1f1666592bf399a6731dfe2fbe0900',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@c5b2ba53591c98d5f1c539dc8fcab6f76cc6318e',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@231cb8214511ea5784dd94a59f3e5f5fb7d39f8e',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@dc1a60501d508cc469c8dc94305724b153e556e2',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@15e5120c8fa279eaaf113a638288a002172b6abb',
  ...
  'src/third_party/libvpx':
    (Var("chromium_git")) + '/chromium/deps/libvpx.git@0d6551cd1e1359423a7f4af503472d280437e9bb',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@1052f51a7da744b8fd8b7d89e0a3a13725c3e6b2',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@18a924e2f2c783dd18c1f8a47d8be7a4dbc7eae4',
  ...
  'src/tools/swarming_client':
    (Var("chromium_git")) + '/external/swarming.client.git@f71d1a3fbe207d91bb2f0bd96c8821ff90bb7c28',
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@a3a266a8135e31261e8f41c470445b4e2a51b2dd'
}
