...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@ab600d1122490b9b761f9ccbe73eeb6d6f66730b',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@41a193b441e311e6a2b0e7751e523ec886ed17d5',
