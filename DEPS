...
#  
#  This DEPS file corresponds to Chromium 30.0.1599.39
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/branches/chrome/m30_1599/gyp@11196',
   'src/third_party/webdriver/pylib':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1599@157588',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m30_1599/src@11196',
   'src/third_party/webpagereplay':
