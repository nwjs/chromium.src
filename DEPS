...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@3c1363b4249fb9e88b3c7c661e0d0840b19e3d69',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@02a8ca0472f5e686d4f5e1a80330ed4410a0f9a4',
