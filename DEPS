  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@d30fea850f10fbc3608ca11ffc142cdad6a2f5d7',
      'src/third_party/cros_system_api':
        (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@22292bcde6edbbca175f3990bdd9cf32afb69391',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2081@177442',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@e438ddbc7451ec80f953266409fea4695e78c8c2',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@f27448e0a792973906bb608e81d33024bc9dd901',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@e8cda37186d82aea05e67fd9a595a59c2ab7ec18',
  'build/third_party/lighttpd':
    '/trunk/deps/third_party/lighttpd@58968',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@fb782d4369d5ae04f17a2fceef7de5a63e50f07b',
  ...
  'src/third_party/libyuv':
    (Var("libyuv")) + '/trunk@1025',
  'src/third_party/libjingle/source/talk':
    (Var("webrtc")) + '/trunk/talk@6544',
