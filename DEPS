...
#  
#  This DEPS file corresponds to Chromium 33.0.1739.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@cae100dfb608e5a758063ea06019c0eb0cef8b3e',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@240892',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1739@163970',
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12544',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12544',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@5268',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1739/src@240993',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12678',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@240945',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@af640efbfdbe80909016fc623bb65f010a2e551f',
   'src/tools/grit':
