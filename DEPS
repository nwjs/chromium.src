...
#  
#  This DEPS file corresponds to Chromium 36.0.1917.1
#  
#  
#  
vars = {
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@260471',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1917@170425',
   'src/third_party/icu':
