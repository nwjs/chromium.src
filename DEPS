...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      (Var("git.chromium.org")) + '/chromium/deps/nss.git@7b5b6ec41cf9105bd6e1c9a5157982f821282a4c'
  },
  'mac': {
  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@6803cc44772b3e9981bc67853164983cc906fa88',
    ...
    'android': {
      ...
      'src/third_party/android_tools':
        (Var("git.chromium.org")) + '/android_tools.git@7fc902d157a9aed7a2b68adc9c69181b3a43cd58',
      ...
      'src/third_party/android_protobuf/src':
        (Var("git.chromium.org")) + '/external/android_protobuf.git@48ee66d295979372ed0234cefda42385daae8312',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291819',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@26abcf10a4994a0bb13a074d79baa85cd8d67b2c',
  ...
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@5906d1bcdd525d7d00914f1d4e43f7075452c43c',
  'src/testing/gmock':
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@61776de8bd9664c2186b08a36dacafddaa47896c',
  'src/third_party/brotli/src':
    (Var("git.chromium.org")) + '/external/font-compression-reference.git@6cef49677dc4c650ef6e3f56041e0a41803afa8c',
  'src/third_party/cacheinvalidation/src':
    (Var("git.chromium.org")) + '/external/google-cache-invalidation-api/src.git@108f1459d873db13c1914755a79333a09d4c563f',
  'src/third_party/leveldatabase/src':
    (Var("git.chromium.org")) + '/external/leveldb.git@3f77584eb3f9754bbb7079070873ece3f30a1e6b',
  'build':
    '/trunk/tools/build@291817',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@1ff523f4eccd38fb9f73e60dddd895736ce90346',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@ab56c6aeff8ea52a8927a947ec20d19eb4564fc9',
  'build/third_party/lighttpd':
    '/trunk/deps/third_party/lighttpd@58968',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@ea4dc0e322f4c4c3784ace03b47de99184c4cb55',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@e6e40abd9753c50917c1fc47f10c105ebe489e58',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu52.git@89831135d5f76413fcdd3852f8de7f344b3fa40c',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@24f39747b725658cbcf9771be11fc433dbf94d2d',
  'src/breakpad/src':
  ...
  'src/third_party/libjpeg_turbo':
    (Var("git.chromium.org")) + '/chromium/deps/libjpeg_turbo.git@3963fbcd6c16965948a9c081c6e9dce82a938dad',
  'src/testing/gtest':
    (Var("git.chromium.org")) + '/external/googletest.git@4650552ff637bb44ecf7784060091cbed3252211',
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@9aaa825cf89e1bcfece269a453300ebf4a26d64d',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@ceebbcc0cef1bbd2bb672576ccf1133168639346',
