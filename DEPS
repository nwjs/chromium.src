vars = {
  'angle_revision':
    '519a5be2a5b47bf6fd97bc3c619be4a275faacad',
  'boringssl_revision':
    '2deb984187ce8f6c739c780e7fe95e859e93b3da',
  'buildspec_platforms':
    'all',
  'buildtools_revision':
  ...
  'libvpx_revision':
    '19bcff869995b401194074278634e6b5cf391333',
  'lighttpd_revision':
  ...
  'pdfium_revision':
    '905cc10ecd06bcacfefb747cc3370c72772f0e15',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    '41838a019401af6e88afc6039f9de76fbca39ff2',
  'swarming_revision':
    '2866a22530cb65feae5d9f64c83636aed5391d06',
  'v8_revision':
    '02964faee8fc341d9991591ad756761c0e635bff',
  'webkit_revision':
    '368993704a80ae7384b8fc0792aa91fb4cca5ddb'
}
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@368993704a80ae7384b8fc0792aa91fb4cca5ddb',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@519a5be2a5b47bf6fd97bc3c619be4a275faacad',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@2deb984187ce8f6c739c780e7fe95e859e93b3da',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@2da8924915bd6fb7609c518f5b1f63cb606248eb',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@751b2959e80e794fa1f1177ed28fae76f0905b2c',
  ...
  'src/third_party/libvpx':
    (Var("chromium_git")) + '/chromium/deps/libvpx.git@19bcff869995b401194074278634e6b5cf391333',
  'src/third_party/libwebm/source':
    (Var("chromium_git")) + '/webm/libwebm.git@75a6d2da8b63e0c446ec0ce1ac942c2962d959d7',
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@e40384b6d9667401a010b9ef7db16bf56bf5deab',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@905cc10ecd06bcacfefb747cc3370c72772f0e15',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@41838a019401af6e88afc6039f9de76fbca39ff2',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@6e87bbe6a37baa0940d0b28c6e8bae98c839be75',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@02964faee8fc341d9991591ad756761c0e635bff'
}
