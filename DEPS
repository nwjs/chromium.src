...
deps_os = {
  ...
  'unix': {
    ...
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@7d5f30c6bd012260e5266c6e9624f4fed91eb852',
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@3a904a3fff8d8d227b7e3a33e8fecff339e8fda7',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292687',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@5f6094a1eb9bf5bb9fd17ada84a5763de2853eff',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@33edc612a7499f4fc5155a7fd72424021c1d415c',
  'src/breakpad/src':
