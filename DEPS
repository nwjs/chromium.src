...
#  
#  This DEPS file corresponds to Chromium 36.0.1922.1
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1295',
   'src/third_party/openmax_dl':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1922@170657',
   'src/third_party/icu':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@260795',
   'src/third_party/swig/Lib':
