...
#  
#  This DEPS file corresponds to Chromium 7.0.539.0
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKit/mac':
         'http://svn.webkit.org/repository/webkit/trunk/WebKit/mac@68625',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@50870',
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@68625',
...
deps = {
   ...
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/trunk/WebCore@68625',
   'src/third_party/ots':
      'http://ots.googlecode.com/svn/trunk@35',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium/fast/workers@68625',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/js/resources@68625',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/http/tests/workers@68625',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/resources@68625',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/storage/domstorage@68625',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/events@68625',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/workers@68625',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/workers@68625',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/xmlhttprequest@68625',
   'src/tools/gyp':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/storage/domstorage@68625',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/appcache':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/appcache@68625',
   'src/testing/gtest':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/fast/events@68625',
   'src/third_party/WebKit/JavaScriptCore':
      'http://svn.webkit.org/repository/webkit/trunk/JavaScriptCore@68625',
   ...
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests@68625',
   'src/chrome/test/data/layout_tests/LayoutTests/media':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/media@68625',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/fast/events@68625',
   'src/native_client':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/storage/domstorage@68625',
   'src/third_party/WebKit/WebKit/chromium':
      'http://svn.webkit.org/repository/webkit/trunk/WebKit/chromium@68625',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/websocket/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/websocket/tests/workers@68625',
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@599',
   'src/third_party/WebKit/WebKitTools/Scripts':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/Scripts@68625',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/fast/workers@68625',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/DumpRenderTree@68625',
   'src/third_party/icu':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/http/tests/workers@68625',
