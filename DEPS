  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@47ccf3619852f05dfff3895022246640498c1de7',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@281107',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2084@177568',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@3df05015efce95c306fb79c21efc77c79f1ac1ba',
  ...
  'src/third_party/libaddressinput/src/testdata':
    (Var("libaddressinput")) + '/trunk/testdata@297',
  'src/testing/gmock':
  ...
  'build/scripts/tools/deps2git':
    '/trunk/tools/deps2git@279843',
  'src/third_party/hunspell_dictionaries':
    '/trunk/deps/third_party/hunspell_dictionaries@255132',
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13430',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13430',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@91b1004a10faebf968b5ff9a01da3002e18d13dc',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@9d319f0cb5e0850447dbd95b07fed28245fb0b31',
  ...
  'src/third_party/libaddressinput/src/cpp':
    (Var("libaddressinput")) + '/trunk/cpp@297',
  'src/third_party/icu':
  ...
  'src/third_party/snappy/src':
    (Var("snappy")) + '/trunk@80',
  'src/breakpad/src':
    (Var("google-breakpad")) + '/trunk/src@1343',
