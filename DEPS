vars = {
  ...
  'boringssl_revision':
    'ac8302a092e8e232dbabf5a01eff5dd37671b5c8',
  'buildspec_platforms':
    'all',
  'buildtools_revision':
  ...
  'libvpx_revision':
    '0304cef02fe5e94b63e7e78ddb263d91ca32d533',
  'lighttpd_revision':
  ...
  'pdfium_revision':
    '0d0935d3d6603dd7d851b1d5828635230f4c43ca',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    '2bd5d024723f52fc4d1144773ee9922a8c0a1b4d',
  'swarming_revision':
    '49f046853671bbd5ab65509a8049d36ac0224714',
  'v8_revision':
    '4b85d844500bc84536e5f51283a0a58b6af11fbc',
  'webkit_revision':
    '39d49edc755378fe419bbdfee43b0b972a45f7e5'
}
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@39d49edc755378fe419bbdfee43b0b972a45f7e5',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@4a693565dcfaba92f053db5c95e9338eac949245',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@ac8302a092e8e232dbabf5a01eff5dd37671b5c8',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@f150b27fd6bc43fe2a337090345c9c3b4e29eeca',
  ...
  'src/third_party/libvpx':
    (Var("chromium_git")) + '/chromium/deps/libvpx.git@0304cef02fe5e94b63e7e78ddb263d91ca32d533',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@0d0935d3d6603dd7d851b1d5828635230f4c43ca',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@2bd5d024723f52fc4d1144773ee9922a8c0a1b4d',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@8f226a6ee630d0b5a0a83235ed71cef28f4fcfca',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@4b85d844500bc84536e5f51283a0a58b6af11fbc'
}
