  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@d379d3bdff707e860beec4455cd1005598827a4f',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@272343',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13216',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13216',
  'src/third_party/leveldatabase/src':
    (Var("leveldb")) + '/trunk@80',
  'build':
    '/trunk/tools/build@272382',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@951f241bcf22f0095abe2f109adfdd9c19e76d70',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2010@174644',
  'src/third_party/icu':
  ...
  'src/third_party/webpagereplay':
    (Var("git.chromium.org")) + '/external/web-page-replay.git@4edb10429743bf53ef58ec9440e8034ae5f93ff5',
