...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@b858e4e39a503418942aa899b8ee6c9496fd8f36',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293507',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@f8d18743d49493038a761479b7ae55535b9f215d',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@f6ee2a28f6723f4bc6c88791083c49f3f8957328',
  'src/breakpad/src':
