...
#  
#  This DEPS file corresponds to Chromium 6.0.472.50
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/472/LayoutTests/http/tests/workers@57442',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      '/branches/WebKit/472/LayoutTests/http/tests/xmlhttprequest@57442',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      '/branches/WebKit/472/LayoutTests/platform/chromium-win/storage/domstorage@57442',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      '/branches/WebKit/472/LayoutTests/platform/chromium-win/fast/workers@57442',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      '/branches/WebKit/472/WebKitTools/DumpRenderTree@57442',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu42@51076',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      '/branches/WebKit/472/LayoutTests/platform/chromium-win/http/tests/workers@57442',
