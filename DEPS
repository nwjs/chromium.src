...
#  
#  This DEPS file corresponds to Chromium 30.0.1563.0
#  
#  
#  
vars = {
...
deps = {
   ...
   'build':
      '/trunk/tools/build@211280',
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@211201',
   'src/third_party/libsrtp':
