...
#  
#  This DEPS file corresponds to Chromium 35.0.1915.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@fa85ba5988ff3174fdccad4738e94042ead25fcf',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@260078',
   'src/third_party/bidichecker':
