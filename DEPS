...
#  
#  This DEPS file corresponds to Chromium 35.0.1916.44
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1916/public@171511',
      'src/native_client':
      None,
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1916@171511',
   'src/third_party/icu':
