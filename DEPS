...
#  
#  This DEPS file corresponds to Chromium 32.0.1660.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@881fccb2fcb0ee2079bc141fb6c67d5d0d81b1ae',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1660@158870',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11584',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@226893',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
