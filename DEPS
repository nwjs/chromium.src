...
#  
#  This DEPS file corresponds to Chromium 30.0.1568.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@a0c3d2a5ebcaac0ac9600eb05d2b252639eae034',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@212149',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1568@154463',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11774',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11774',
   'src/third_party/leveldatabase/src':
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@210693',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10117',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@212202',
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@212118',
   'src/third_party/libsrtp':
...
include_rules =  ['+base', '+build', '+ipc', '+library_loaders', '+testing', '+third_party/icu/public', '+url', '!googleurl']