...
#  
#  This DEPS file corresponds to Chromium 35.0.1870.12
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@f74f7becdbd1b36c89ca8b46a19853b96c4a89ca',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@254618',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1870@168356',
   'src/third_party/icu':
