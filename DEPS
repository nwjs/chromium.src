...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@68b6504bb10f769e3e65089388c80ff4b1036377',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@a15f36dcece021be03cd6a4e4fe593c8baa96acd',
  'src/breakpad/src':
