...
#  
#  This DEPS file corresponds to Chromium 6.0.433.0
#  
#  
#  
deps_os = {
   ...
   'mac': {
      'src/third_party/WebKit/WebKitLibraries':
         'svn://svn.chromium.org/webkit-readonly/trunk/WebKitLibraries@61029',
      'src/third_party/GTM':
      ...
      'src/third_party/WebKit/WebKit/mac':
         'svn://svn.chromium.org/webkit-readonly/trunk/WebKit/mac@61029',
...
deps = {
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/storage/domstorage@61029',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/fast/events@61029',
   'src/third_party/WebKit/WebKit/chromium':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebKit/chromium@61029',
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@576',
   'src/third_party/ots':
      'http://ots.googlecode.com/svn/trunk@30',
   'src/third_party/WebKit/WebCore':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebCore@61029',
   'src/breakpad/src':
      'http://google-breakpad.googlecode.com/svn/trunk/src@604',
   'chromeos':
      '/trunk/cros_deps@49627',
   'src/third_party/WebKit':
      '/trunk/deps/third_party/WebKit@33467',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/fast/workers@61029',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/websocket/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/websocket/tests/workers@61029',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/fast/events@61029',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/http/tests/xmlhttprequest@61029',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/http/tests/workers@61029',
   ...
   'src/third_party/WebKit/WebKitTools/Scripts':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebKitTools/Scripts@61029',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg/source@49485',
   'src/third_party/WebKit/JavaScriptCore':
      'svn://svn.chromium.org/webkit-readonly/trunk/JavaScriptCore@61029',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/fast/js/resources@61029',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/http/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-mac/http/tests/workers@61029',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/http/tests/resources@61029',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/fast/workers@61029',
   'src/build/util/support':
      '/trunk/deps/support@49631',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-mac/storage/domstorage@61029',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebKitTools/DumpRenderTree@61029',
   'src/testing/gtest':
      'http://googletest.googlecode.com/svn/trunk@408',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/storage/domstorage@61029',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/http/tests/workers@61029',
   'src':
      '/trunk/src@49622',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu42@47106',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium/fast/workers@61029',
   'src/third_party/WebKit/LayoutTests':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests@61029',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/fast/events':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-mac/fast/events@61029',
