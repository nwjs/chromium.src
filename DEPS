...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@647c0d17ce2d8c64766c14b637404a27eaa3de54',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@5fbf2943a9260ed9d637da2e37f4cc20fb54f973',
