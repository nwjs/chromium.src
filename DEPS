...
#  
#  This DEPS file corresponds to Chromium 33.0.1750.21
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1750@164598',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m33_1750/src@12945',
   'src/third_party/webpagereplay':
