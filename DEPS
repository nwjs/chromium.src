...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      (Var("git.chromium.org")) + '/chromium/deps/nss.git@90c5f9a8b8980fe60165813f578bbeb4fe20b18d'
  },
  'mac': {
  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@b7dbc0d3bc22cbff5d6bbef52be945a1cf238568',
      'src/third_party/cros_system_api':
        (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@3a7cfa4ba91518b8dd03282d09996d2f42ec6a2b',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291751',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@332a56a9d8e5d800e3a1fb8aa69c241d0ce59912',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@21e613505562368e7719215f824fa8b3b4be652d',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@e7d8b988423ff1966d64db3ef7ca766296f9b0c1',
  ...
  'src/tools/grit':
    (Var("git.chromium.org")) + '/external/grit-i18n.git@77abf65c1d72af6fb7f9ef6f50cdf29fcf42d0a1',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@f8698ce1dacfdcf804809638483adb702760469c',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@b17ca115237f193f7ee0bdd43431999727598f74',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@a502c749b249df6460326c4e5354f0549cc698d8',
  'src/buildtools':
  ...
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@ad7ab343572a78f80c4e7d96726881d528474ed3',
  'src/third_party/libyuv':
    (Var("git.chromium.org")) + '/external/libyuv.git@455c66b4375d72984b79249616d0a708ad568894',
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@9426b888d5e248adb87c2c2dcb4d4b95e14d1226',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@f105b19434fdeecac2dd2f78fed5b45ed2637ab3',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@56b74bad6d1485bb8e54ca0a9539da9842e695ca',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu52.git@527ea2dd86afa2751a85d1cc4695f9e2e2d18022',
  ...
  'src/third_party/libjpeg_turbo':
    (Var("git.chromium.org")) + '/chromium/deps/libjpeg_turbo.git@2ed5319ce40b0ba2cd9b962713ea0ef775781e69',
  'src/third_party/libsrtp':
    (Var("git.chromium.org")) + '/chromium/deps/libsrtp.git@662d81de5cbf3667f1baaafe051b8b4ab0b12fe2',
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@d71b62088ad094b1187c06c92d1f27fab56aaddb',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@982d14793a8e42d2fa5e6e5e34bede17b4ba67e3',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@6c7aed048ca0a335e02dfee10976c5dc8620783e',
