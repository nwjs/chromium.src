...
#  
#  This DEPS file corresponds to Chromium 30.0.1595.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@3489cd4779c3aa2a2849c317cd9a1b4cdbb5ae7c',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1595@155950',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10669',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@217060',
   'src/third_party/libsrtp':
