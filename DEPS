...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@d8e30dc2d2ed03a629792e42b4afed5d2e091955',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292820',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@2f5cb2fb955234f891655b420187597617e5ab3a',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@dcb6aa9bef3b496069e234ed4dc52d1e8c636776',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@17c668531c119125de3871a120e16b2a9bcaa567',
