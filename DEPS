...
#  
#  This DEPS file corresponds to Chromium 28.0.1473.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@705ea59383ffed988873427b89dd6ef87b982fdb',
      ...
      Var("webkit_trunk")[:-6] + '/trunk/Tools/gdb@147952',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@565bc9a4a3d0e82df6953ac7d3cfb6d057028d46',
      'src/third_party/lss':
...
deps = {
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/platform/chromium/fast/workers@147952',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/files':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/platform/chromium/fast/files@147952',
   'src/third_party/ots':
      Var("ots") + '/trunk@97',
   'src/third_party/sfntly/cpp/src':
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@192327',
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/storage/indexeddb@147952',
   'src/sandbox/linux/seccomp-legacy':
      Var("seccompsandbox") + '/trunk@189',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/http/tests/appcache@147952',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@302',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/platform/chromium-win/http/tests/workers@147952',
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@8567',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/events':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/platform/chromium/fast/events@147952',
   'src/third_party/webdriver/pylib':
      Var("selenium") + '/trunk/py@16922',
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@193231',
   'src':
      '/branches/1473/src@193441',
   'src/third_party/libyuv':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/http/tests/workers@147952',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/fast/workers@147952',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/media@147952',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/webkit/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@181763',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/storage/domstorage@147952',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@63',
   'src/content/test/data/layout_tests/LayoutTests/editing/pasteboard/resources':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/editing/pasteboard/resources@147952',
   'src/tools/deps2git':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@193257',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/chrome/test/data/perf/frame_rate/content':
      '/trunk/deps/frame_rate/content@93671',
   'commit-queue':
      '/trunk/tools/commit-queue@193128',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1139',
   'src/third_party/openmax_dl':
      Var("webrtc") + '/deps/third_party/openmax@3720',
   'src/third_party/WebKit/Source':
      Var("webkit_trunk")[:-6] + '/trunk/Source@147952',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/http/tests/resources@147952',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/platform/chromium-win/fast/workers@147952',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@8567',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11142',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@147',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@3765',
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/fast/filesystem@147952',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11142',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@72',
   'build':
      '/trunk/tools/build@193280',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1606',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/platform/chromium-win/storage/domstorage@147952',
   'build/third_party/lighttpd':
      '/trunk/deps/third_party/lighttpd@58968',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/http/tests/xmlhttprequest@147952',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@189528',
   'src/third_party/WebKit/Tools/Scripts':
      Var("webkit_trunk")[:-6] + '/trunk/Tools/Scripts@147952',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/platform/chromium-win/fast/events@147952',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/fast/files@147952',
   'src/sdch/open-vcdiff':
      Var("open-vcdiff") + '/trunk@42',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/fast/events@147952',
   'src/third_party/WebKit':
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      Var("webkit_trunk")[:-6] + '/trunk/Tools/DumpRenderTree@147952',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@506',
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@251',
   'src/third_party/WebKit/LayoutTests':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests@147952',
   'src/third_party/swig/Lib':
      '/trunk/deps/third_party/swig/Lib@69281',
   'src/third_party/WebKit/Tools/TestWebKitAPI':
      Var("webkit_trunk")[:-6] + '/trunk/Tools/TestWebKitAPI@147952',
   'src/third_party/angle':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/http/tests/websocket/tests@147952',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/trunk/LayoutTests/fast/js/resources@147952',
}
