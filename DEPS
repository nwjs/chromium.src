...
#  
#  This DEPS file corresponds to Chromium 34.0.1828.7
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e24049778accf197597809afe453d1318abee6a9',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1828@166715',
   'src/third_party/icu':
