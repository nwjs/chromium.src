...
#  
#  This DEPS file corresponds to Chromium 25.0.1364.154
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Source/WebKit/chromium/public@144108',
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Source/Platform/chromium/public@144108',
   ...
   'unix': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Tools/gdb@144108',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@20b1a670aecf98f7288707243540ac72635f7ece',
      'src/third_party/lss':
...
deps = {
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/fast/filesystem/resources@144108',
   'src/third_party/skia/include':
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/storage/indexeddb@144108',
   'src/sandbox/linux/seccomp-legacy':
      Var("seccompsandbox") + '/trunk@189',
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/branches/chrome-1364/src@273',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/http/tests/appcache@144108',
   'commit-queue':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium/fast/events@144108',
   'src/third_party/webdriver/pylib':
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Tools/DumpRenderTree@144108',
   'src/third_party/libphonenumber/src/phonenumbers':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/http/tests/workers@144108',
   'src/third_party/WebKit/LayoutTests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests@144108',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/fast/workers@144108',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/media@144108',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/fast/js/resources@144108',
   'src/webkit/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@173055',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/storage/domstorage@144108',
   'src/tools/grit':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium-win/storage/domstorage@144108',
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium-win/http/tests/workers@144108',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1089',
   'src/third_party/WebKit/Source':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Source@144108',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/http/tests/resources@144108',
   'src/third_party/WebKit':
      '/trunk/deps/third_party/WebKit@76115',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium-win/fast/workers@144108',
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/http/tests/websocket/tests@144108',
   'src/third_party/angle':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/http/tests/xmlhttprequest@144108',
   'src/third_party/jsoncpp/source/include':
   ...
   'src/third_party/WebKit/Tools/Scripts':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Tools/Scripts@144108',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium-win/fast/events@144108',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/fast/files@144108',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@251',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/fast/events@144108',
   'src':
      '/branches/1364_152/src@185986',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu46@172827',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/LayoutTests/platform/chromium/fast/workers@144108',
   'src/third_party/webpagereplay':
   ...
   'src/third_party/WebKit/Tools/TestWebKitAPI':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1364/Tools/TestWebKitAPI@144108',
   'src/testing/gtest':
      Var("googletest") + '/trunk@629',
   'src/v8':
      Var("v8") + '/branches/3.15@13742',
   'src/third_party/libvpx':
