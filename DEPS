...
#  
#  This DEPS file corresponds to Chromium 32.0.1681.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@bc2a66edba4954020ddd9599b19ed1186f4ee19c',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1681@160534',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11932',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@522',
   'build':
      '/trunk/tools/build@230897',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
