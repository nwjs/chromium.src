...
#  
#  This DEPS file corresponds to Chromium 34.0.1789.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@466164045bda3178a90060eafc13e50f3fd09e46',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@245134',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1789@165236',
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12611',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@151',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12611',
