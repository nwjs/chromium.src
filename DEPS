...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@294528',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@374a4c3b744e8c77455efa73b139950136f7b374',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@bdd419f9f5b006e913606e7363125942c8ae06bc',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@039921103819f69781247ad8028639e1c4fa108f',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@230d131d173ab2d60291d303177bc04ec3f6e519',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@2c87306660d049be370ce4475f3d30869e5f2796',
