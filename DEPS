...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@4c9e081f3dcaa454f74863eff8a06599cb9e46d8',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293444',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@cf1ea73edc8110ad7e250cc0072585ec58d094b4',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@386764f187d721d9e57591a39903a6f2db7064a5',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@81877037f5101c7b4f6ce0ae7d91afa62a4fb912',
