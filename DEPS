...
#  
#  This DEPS file corresponds to Chromium 32.0.1675.3
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("native_client") + '/trunk/deps/third_party/gnu_binutils@12212',
      'src/third_party/pefile':
      Var("pefile") + '/trunk@63',
      'src/third_party/psyco_win32':
      '/trunk/deps/third_party/psyco_win32@79861',
      'src/third_party/mingw-w64/mingw/bin':
      Var("native_client") + '/trunk/deps/third_party/mingw-w64/mingw/bin@12212',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@16cf2c6c20a57041151ccfa76a1b9494672a910a',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1675@160005',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12277',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12277',
   ...
   'src/third_party/scons-2.0.1':
      Var("native_client") + '/trunk/src/third_party/scons-2.0.1@12212',
