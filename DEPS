  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@cd304692043e9e72156ece47965af4aaed6dee06',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292291',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@6a6567458b303237dd9a528a24829ca849adc1db',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@f4e9ccbec29a745a8b7e6e913b7f7247036b0a09',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@ff7c1a176f6744a819714e89b5a7f5ae7a0b3e77',
  'src/breakpad/src':
