  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@3bd8d49fe8fde28de4f9acec92f7ca01cac56463',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@287832',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2116@179678',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@be21e3432e4cf925fe494efe23edcb457bd05fcb',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@d9ba4f7318979e927c7a3320c5746c25381eae90',
  ...
  'src/third_party/trace-viewer':
    (Var("trace-viewer")) + '/trunk@1445',
  'src/third_party/yasm/source/patched-yasm':
    '/trunk/deps/third_party/yasm/patched-yasm@167605',
  'src/third_party/safe_browsing/testing':
    (Var("google-safe-browsing")) + '/trunk/testing@112',
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@5ab896ad9dffd4a78e3c310de8e3507ded3e3239',
  'build':
    '/trunk/tools/build@287929',
