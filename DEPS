...
#  
#  This DEPS file corresponds to Chromium 33.0.1736.3
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("native_client") + '/trunk/deps/third_party/gnu_binutils@12289',
      'src/third_party/pefile':
      Var("pefile") + '/trunk@63',
      'src/third_party/psyco_win32':
      '/trunk/deps/third_party/psyco_win32@237949',
      'src/third_party/mingw-w64/mingw/bin':
      Var("native_client") + '/trunk/deps/third_party/mingw-w64/mingw/bin@12289',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@6ec61f58f73ae7b2898aaa9386ea3ff7373c02d4',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@239830',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1736@163749',
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12515',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12515',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@5234',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1736/src@240402',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@9cc42c3d4dba35c682535c1d0b4cadca6154853f',
   'src/third_party/hunspell':
   ...
   'src/v8':
      Var("v8") + '/trunk@18251',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@237125',
   'src/third_party/sfntly/cpp/src':
      Var("sfntly") + '/trunk/cpp/src@228',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1247',
   'src/media/cdm/ppapi/api':
   ...
   'src/third_party/scons-2.0.1':
      Var("native_client") + '/trunk/src/third_party/scons-2.0.1@12289',
