...
#  
#  This DEPS file corresponds to Chromium 35.0.1876.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e9fa227a82fa135ccef10fd5b33b0af1e7292a0c',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1876@168700',
   'src/third_party/icu':
