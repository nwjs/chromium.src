...
#  
#  This DEPS file corresponds to Chromium 35.0.1886.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@6dbf6d2f7ccb684e89709790c848aaa03d709a5c',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@256386',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1886@169020',
   'src/third_party/icu':
