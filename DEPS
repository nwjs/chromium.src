...
#  
#  This DEPS file corresponds to Chromium 4.0.299.0
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKit/mac':
         'http://svn.webkit.org/repository/webkit/trunk/WebKit/mac@53313',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@29937',
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@53313',
...
deps = {
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/events@53313',
   'src/third_party/WebKit/WebKit/chromium':
      'http://svn.webkit.org/repository/webkit/trunk/WebKit/chromium@53313',
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@470',
   'src/third_party/ots':
      'http://ots.googlecode.com/svn/trunk@23',
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/trunk/WebCore@53313',
   'src/breakpad/src':
      'http://google-breakpad.googlecode.com/svn/trunk/src@452',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/workers@53313',
   'src/googleurl':
      'http://google-url.googlecode.com/svn/trunk@121',
   'src/chrome/test/data/layout_tests/LayoutTests/websocket/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/websocket/tests/workers@53313',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/workers@53313',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/xmlhttprequest@53313',
   'src/third_party/WebKit/WebKitTools/pywebsocket':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/pywebsocket@53313',
   'src/tools/gyp':
   ...
   'src/third_party/WebKit/JavaScriptCore':
      'http://svn.webkit.org/repository/webkit/trunk/JavaScriptCore@53313',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/js/resources@53313',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/resources@53313',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@19546',
   'src/build/util/support':
      '/trunk/deps/support@36349',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/storage/domstorage@53313',
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@470',
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests@53313',
   'src':
      '/trunk/src@36335',
   'src/third_party/icu':
