...
#  
#  This DEPS file corresponds to Chromium 30.0.1580.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@6f2032b3fd57a3aaf886abb0274fb3a2801f5d96',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@214050',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1580@155069',
   ...
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@374',
   'src':
      '/branches/1580/src@214156',
   'src/third_party/hunspell':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10377',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@214142',
   'src/third_party/libsrtp':
