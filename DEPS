  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@87864946f7e8de5b5955b623c4fa77ca246df30f',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292445',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@7909bb7e2b0b995b5eece17bc20352a41adb7491',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@d2e7dfba212557e2ef7c570c297b00683a603916',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@c28b74ff7a2678b611f4a7ecb3be4f99f15a76fd',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@ed13636ab93755d324d9366b2c41d343ecc5829c',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@1b24b697659b9b933f336238665c835497464a0b',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@68133f52bee4c8f85269c7c597d781b74a43c700',
  ...
  'src/third_party/usrsctp/usrsctplib':
    (Var("git.chromium.org")) + '/external/usrsctplib.git@dfd687bb8ef6224a1e3c38a7de9e79e854b142ad',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@2489e79694d3dca0e6665d9c2417736d241e06e6',
