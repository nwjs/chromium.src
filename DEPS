...
#  
#  This DEPS file corresponds to Chromium 33.0.1710.3
#  
#  
#  
vars = {
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@235149',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1710@162059',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@235270',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12282',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@525',
   'build':
      '/trunk/tools/build@235273',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
