...
#  
#  This DEPS file corresponds to Chromium 32.0.1664.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@3311f96fd21c11ca4f6573344b076f029bbfa0ac',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@9fb7739302ab3cfde43194d974f2c08c92616554',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@227427',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1664@159081',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@227404',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11637',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@227426',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
