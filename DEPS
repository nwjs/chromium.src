...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2125@181063',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@e82b9bc4fcdc4403995307c44a774b6d3ed89b76',
  ...
  'src/third_party/webrtc':
    (Var("webrtc")) + '/branches/38/webrtc@6941',
  ...
  'src/v8':
    (Var("v8")) + '/branches/3.28@23373',
  'src/third_party/pywebsocket/src':
    (Var("pywebsocket")) + '/trunk/src@790',
  'src/third_party/libvpx':
    '/branches/2125/deps/third_party/libvpx@291144',
