...
#  
#  This DEPS file corresponds to Chromium 34.0.1839.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@24094ca56cb0efecd444b9d72414e08c6c4a0cb5',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1839@167093',
   'src/third_party/icu':
