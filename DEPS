...
#  
#  This DEPS file corresponds to Chromium 29.0.1541.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@83083e0e1d223c7bfdf22d56ea59d606fea7cd78',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@d6a4c7e0ee4d53ddc5238dbddfc0417796a70e54',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@206820',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1541@152607',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11545',
   'src/third_party/smhasher/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9604',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@513',
   'build':
      '/trunk/tools/build@206891',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11545',
   'src/third_party/libphonenumber/src/test':
      Var("libphonenumber") + '/trunk/cpp/test@456',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@621',
