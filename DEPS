...
deps = {
  ...
  'depot_tools':
    '/trunk/tools/depot_tools@294950',
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@fa5a6b3449dbe77a107a891b96c0e47387302e2e',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@15308f469a704c45d15567fa69cd94ce07ad0e1b',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@87d5dd90911a0657c27574f78e86b7dfc4ad8b29',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@5777a0adf706cdfc1cb1ba1d5cdbc474d0352d4d',
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@ad0a486b943316caef81084b10fbaa8be70a8956',
  'src/third_party/bidichecker':
    (Var("git.chromium.org")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@ef4962f5a38fd68f0b89b67fc5e13da70e4288f6',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu.git@10834e84d250eb31a73496bfdb7923eaa43ead51',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@d8bca77284d02b80de15a5420c727a3e1385c542',
  'src/third_party/libjpeg_turbo':
    (Var("git.chromium.org")) + '/chromium/deps/libjpeg_turbo.git@9e9058be139a32f2d03eddce97fb15ecca92e6bc',
  ...
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@c600ca703b712ac0d2db719970a1fce6de70fcb4',
  'src/third_party/libyuv':
    (Var("git.chromium.org")) + '/external/libyuv.git@01db3d1d1ddd3f2907a46a41f24add5143b518d5',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@97d10aff654e42c1b7c3d2abf33fbcf8d341799e',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@1899651ffc459f5462aa989cd6d08507947b67e4',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@bd416ea61d3632b93796eba2134fe03185e9e63e',
  ...
  'src/third_party/webpagereplay':
    (Var("git.chromium.org")) + '/external/github.com/chromium/web-page-replay.git@4e4d540a18c099e2ad805696072f95815f313c0e',
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@324d9727cd5cc1f2e3434e82cc9f9d83a486abab',
  ...
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@2a5511bd901f328db10d0b6415c864a5ff59fc81',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@d3c652f04b04725ff110a9016aeb728f60d5e6ba'
}
...
deps_os = {
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@7200281446186c7192cb02f54dc2b38e02d705e5',
  ...
  'unix': {
    ...
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@42cdfaada2ae9183f6479531e24d739cc778c4a8',
