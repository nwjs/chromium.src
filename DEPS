...
#  
#  This DEPS file corresponds to Chromium 35.0.1873.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@2051',
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@253292',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e9a2dbc1cfb906c6705715b0c906f16c76d79530',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@254932',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1873@168493',
   'src/third_party/icu':
