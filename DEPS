  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@1379a9c63f3d6b41d923164bb9e6f0e2a3d9c20e',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2052@176169',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@09b187c9bdc0bb35f455d2df2f0b6a8303f8114a',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@9c1229094e135e155cb213be7d5b2ab9db9c7122',
  'build':
