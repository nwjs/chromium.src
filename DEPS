...
#  
#  This DEPS file corresponds to Chromium 30.0.1599.37
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1599@157551',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m30_1599/src@11183',
   'src/third_party/webpagereplay':
