...
deps = {
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@3ca92ccfcafdf26ff57423211cfa08297e7f9872',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@971564a9c539700b38e1201f28526b9adc9dc422'
}
