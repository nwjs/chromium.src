...
#  
#  This DEPS file corresponds to Chromium 29.0.1547.59
#  
#  
#  
vars = {
...
deps = {
   'src/third_party/skia/include':
      Var("skia") + '/branches/chrome/m29_1547/include@10580',
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/branches/chrome/m29_1547/gyp@10580',
   'src/third_party/webdriver/pylib':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1547@155959',
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@74',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.34/webrtc@4531',
   'src/third_party/libjpeg_turbo':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m29_1547/src@10580',
   'src/third_party/webpagereplay':
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@c7de4feb6b7f98bc9939238283f3a43ad6653901',
   'src/tools/grit':
