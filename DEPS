  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@666d0b9e982af44d6bc5971083a9fd61398b63cd',
    ...
    'android': {
      'src/third_party/android_webview_glue/src':
        (Var("git.chromium.org")) + '/external/android_webview_glue.git@8dc9a9d1217f84a7f9b0554f22a826394eabc856',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291932',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@fbe4136845fd68f583f9f9bfb628706c4b87480b',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@14b5fd823e2a3f0ac702ae297c8315f55820914c',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@61576f53599cf7840d3c4ebab82802b90031adcd',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@5cde6efef585bb2c746fbbea4cbb6708f9a40877',
  ...
  'build':
    '/trunk/tools/build@291950',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@94b57d39a88ceb03e228804eec4b9013c5ea8b4c',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@bbffd5562e33a6cf6f6f1bb5be6cfa30df8f36ec',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@965dd26ef1dfb1c2d5f3da91fad1c73bb73bc5fa',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@12a9940905825e028bebc0bf8d3eddcc65b1933d',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@21231dd8b48c4cf5265570f44c2d6f1e152e9350',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@2c81ceb7f1e1ccf5f304be0646f4c1375941a7f2',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@d95585fb0ec024f6abd96f7b02e0df58019d46af',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@1195796045e1f8bbd1ed311b2cbd8b9d87f2074a',
