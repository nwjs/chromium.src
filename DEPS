...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@29c3da927cbc0c9d1876ae8fa07f4397c4b51562',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@4494522ce20c52187eacbfd8f03d40a8da5af99c',
  'src/breakpad/src':
