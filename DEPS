  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@8650923cf644fb929ee9a67124d765e6f5387cac',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@273002',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2017@174926',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@60c8d24f84105dd341e36a7fc97e25f88ceef309',
