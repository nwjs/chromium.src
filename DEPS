...
#  
#  This DEPS file corresponds to Chromium 5.0.375.112
#  
#  
#  
deps_os = {
   'win': {
      ...
      'src/third_party/ffmpeg/binaries/chromium/win/ia32':
         '/trunk/deps/third_party/ffmpeg/binaries/win@46138',
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      '/branches/WebKit/375/LayoutTests/platform/chromium-win/fast/workers@51048',
   'src/build/util/support':
      '/trunk/deps/support@52051',
   'src/third_party/ffmpeg/source/patched-ffmpeg-mt':
      '/trunk/deps/third_party/ffmpeg/patched-ffmpeg-mt@46138',
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@504',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      '/branches/WebKit/375/LayoutTests/storage/domstorage@51048',
   'src/v8':
      'http://v8.googlecode.com/svn/branches/2.1@4948',
   'src':
      '/branches/375/src@52037',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/375/LayoutTests/http/tests/workers@51048',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      '/branches/WebKit/375/WebKitTools/DumpRenderTree@51048',
   'src/third_party/icu':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      '/branches/WebKit/375/LayoutTests/platform/chromium-win/http/tests/workers@51048',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      '/branches/WebKit/375/LayoutTests/platform/chromium-mac/storage/domstorage@51048',
   'src/third_party/WebKit/LayoutTests':
      '/branches/WebKit/375/LayoutTests@51048',
}
