...
#  
#  This DEPS file corresponds to Chromium 30.0.1567.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@648ba6b8ca5e9cb4af9db84a9b8b6ccbe5cf51f3',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@12031fed473619765037d66a97a55b28933fc6c9',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@211880',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1567@154361',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11754',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11754',
   'src/third_party/leveldatabase/src':
   ...
   'src/v8':
      Var("v8") + '/trunk@15675',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@210966',
   'src/third_party/sfntly/cpp/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10093',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@211884',
