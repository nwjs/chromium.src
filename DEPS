...
deps = {
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@89b71f7a9b25bc752e9e019f869842169c325480',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@a45515e56224c90faf38a15bf22677c05bf0a8a3',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@124260461dfbcd202ca3eb0dbad0e9fb0bb3a5a4'
}
