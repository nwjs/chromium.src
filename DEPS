vars = {
  ...
  'nacl_revision':
    'a0efd24a438fe9f28ba4001f7ebcc3d4549ad96c',
  'nss_revision':
    'aab0d08a298b29407397fbb1c4219f99e99431ed',
  'openmax_dl_revision':
    '22bb1085a6a0f6f3589a8c3d60ed0a9b82248275',
  'pdfium_revision':
    'd1b0a8d9dc71c67b4ce67f148cebc01d66d1d983',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    '18a240d15ca132fab01ba179bd1165d6a182f1cf',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    '3664a2232f3b18e234cb740a5f2f93a5d2de1889',
  'webkit_revision':
    'e20000509ca99476232b53c1d44382a83fd15ab4'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@5215ee866bc3e8eb4a7f124212845abf4029e60b',
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@a0efd24a438fe9f28ba4001f7ebcc3d4549ad96c',
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@20e216ec0e0329bdf207d4c1d71c7b2264418bf7',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@d1b0a8d9dc71c67b4ce67f148cebc01d66d1d983',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@18a240d15ca132fab01ba179bd1165d6a182f1cf',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@3664a2232f3b18e234cb740a5f2f93a5d2de1889'
}
