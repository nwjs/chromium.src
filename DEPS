...
deps_os = {
  ...
  'ios': {
    ...
    'src/third_party/WebKit/public':
      (Var("blink")) + '/branches/chromium/2062/public@176858',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2062@176858',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@6b8f1ba1ef71a762e961c3a8bc8b344c88990a04',
