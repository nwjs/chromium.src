vars = {
  ...
  'buildspec_platforms':
    'all',
  'buildtools_revision':
    '5fc8d3943e163ee627c8af50366c700c0325bba2',
  'chromium_git':
  ...
  'pdfium_revision':
    '24c1eec13f277f27cb27edfb3d191e8bd2223e7c',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '2da1a854b0836001533aa29ade89d87f420cbbc3',
  'swarming_revision':
    'e4c0e242eeec361886ed2b89591a505ebe24db43',
  'v8_revision':
    '7214263979a391156a8e6f968fb9759a87b56309'
}
...
deps = {
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@49460575f3cf8e99012eea942d46369d249d37f0',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@24c1eec13f277f27cb27edfb3d191e8bd2223e7c',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@2da1a854b0836001533aa29ade89d87f420cbbc3',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@8b3854ad414184f379b3f3ca7d1754dc506ce6f9',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@7214263979a391156a8e6f968fb9759a87b56309'
}
