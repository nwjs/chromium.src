  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@3bf7b6e9a829db65656b6c18302afb6c38e0f1b7',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2085@177754',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@6815011292f0a130db2b35ca0f862b246769f3b8',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@f37f5121888fbfdb494650daa14ee872a0261c51',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13441',
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@916ba1fc49098855f8ddd08edd41484d36d84e08',
  ...
  'src/third_party/libyuv':
    (Var("libyuv")) + '/trunk@1028',
  'src/third_party/libjingle/source/talk':
    (Var("webrtc")) + '/trunk/talk@6586',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@cb46ea1bca55b448a7a54db2086c6f736f05c35f',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@8af663956519f7302284c0c36b413c0495986e14',
