...
#  
#  This DEPS file corresponds to Chromium 22.0.1205.0
#  
#  
#  
...
deps = {
   ...
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@4552',
   ...
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@4552',
   'src/tools/grit':
