...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@398907b9402abbb329e6a9552534d4d27c884b5f',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@af2bd098eef11053de71edb84898867f983c4d4b',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@19ea8c6314a1e78d61cbefd185bbb307fe076504'
}
