...
#  
#  This DEPS file corresponds to Chromium 4.0.290.0
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@465',
   'src/third_party/ots':
   ...
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@465',
