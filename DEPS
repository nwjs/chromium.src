...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@001db8599e1f2e2749a5ee65ee83821b0bde569b',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@e72bc08ac3b27617dc0e665900d5bb024946e64f',
  'src/breakpad/src':
