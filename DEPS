...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@1c6e19e0a1fc0324a2fb28c81f4d9db1d17a00b8',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@2505d9f7fdc85474a3d1dcfd59af1bdfa07bdf09'
}
