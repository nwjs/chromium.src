...
#  
#  This DEPS file corresponds to Chromium 34.0.1826.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@40f09613ef229f092f60c2dee152051a7088a752',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1826@166652',
   'src/third_party/icu':
