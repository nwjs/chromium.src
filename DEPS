...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@139b79ccf4dcb268ba91948f14da2a3e9450ebd9',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@f5d7e767d02e27e5bcbae5c7dd597fd6800f6421'
}
