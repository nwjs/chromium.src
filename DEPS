...
#  
#  This DEPS file corresponds to Chromium 35.0.1893.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@d42e5f0e9c97d24943511f755549cb94fd1a061d',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@257248',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1893@169295',
   'src/third_party/icu':
