...
#  
#  This DEPS file corresponds to Chromium 36.0.1940.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@0d31d29615c66b6bbe722d5754374b09978452da',
...
deps = {
   ...
   'src/third_party/skia/include':
      Var("skia") + '/trunk/include@14149',
   'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@263283',
   'src/third_party/libc++abi/trunk':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@263544',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1940@171469',
   'src/breakpad/src':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@263116',
   'src/third_party/swig/Lib':
