...
#  
#  This DEPS file corresponds to Chromium 34.0.1810.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@7604d6aab797d0c69908073691e0668e6ba57721',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@247398',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@247456',
   'src/breakpad/src':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1810@165947',
   'src/third_party/icu':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@247061',
   'src/third_party/swig/Lib':
