...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@0a4a4bb763ed6ada323d5a55bd0ab3330b68636f',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@973d1f1f60f2710a268a3165aa4f3460502d4be5',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@a06f1b4e013812cc7ad1d52a0ea49206cafa7b67'
}
