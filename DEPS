...
#  
#  This DEPS file corresponds to Chromium 31.0.1620.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@b451fc7489c18ff5c7587169eeb965640f8cba66',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@220340',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1620@157100',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11015',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@520',
   'build':
      '/trunk/tools/build@220826',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@74',
   'src/third_party/libsrtp':
