...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@cbf502efa307b23993051fa0d96e6546b45eac3c',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@c5add1aa6b24619999c9adc36a4c2de4bc72f376',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@c7956ae2c77b5085e7c757eaf40653b9a49e3acd'
}
