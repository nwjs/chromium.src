...
#  
#  This DEPS file corresponds to Chromium 35.0.1859.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@ce962e15df3228218c55598aa575a9cc658585c2',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1859@167795',
   'src/third_party/icu':
