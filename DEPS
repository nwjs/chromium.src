  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@04455ee52fca1151cd245967ce3d1d45eb5bf595',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2016@174866',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@7dc5172decb2e2fa8885561ff473902f6e16c707',
