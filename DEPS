vars = {
  'angle_revision':
    '6d51c70ccf63a2c5ec240d960ff1bc179d36c92c',
  'boringssl_revision':
  ...
  'libvpx_revision':
    '3fe1b2a14e7693df172ded0fb08a4f1abc9247f4',
  'lighttpd_revision':
    '9dfa55d15937a688a92cbf2b7a8621b0927d06eb',
  'lss_revision':
    '4fc942258fe5509549333b9487ec018e3c8c5b10',
  'nacl_revision':
    '3feb736b8afecd43050c30049d405f824f284836',
  'nss_revision':
    'aab0d08a298b29407397fbb1c4219f99e99431ed',
  'openmax_dl_revision':
    '22bb1085a6a0f6f3589a8c3d60ed0a9b82248275',
  'pdfium_revision':
    'fdc8f439e854a2636e7d22d7104bf08cf5620b0b',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    '6a91ad22a41cd5f5677d9adbfec851f6464f3f0e',
  'swarming_revision':
    '2866a22530cb65feae5d9f64c83636aed5391d06',
  'v8_revision':
    '73455e0d2d59acbcf6f163b3b51e0b851669bb60',
  'webkit_revision':
    '285b3d78f6d139e064a6b21b716597a10fbfb363'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@3feb736b8afecd43050c30049d405f824f284836',
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@994f10b00d0bf3b17172030b3ade869bc268c2d3',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@6d51c70ccf63a2c5ec240d960ff1bc179d36c92c',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@0b9cfee467e309988ebae9e258247a8f69765458',
  ...
  'src/third_party/libvpx':
    (Var("chromium_git")) + '/chromium/deps/libvpx.git@3fe1b2a14e7693df172ded0fb08a4f1abc9247f4',
  'src/third_party/libwebm/source':
    (Var("chromium_git")) + '/webm/libwebm.git@75a6d2da8b63e0c446ec0ce1ac942c2962d959d7',
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@9425c4b01a38863fd0977caae28574a576307f76',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@fdc8f439e854a2636e7d22d7104bf08cf5620b0b',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@6a91ad22a41cd5f5677d9adbfec851f6464f3f0e',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@fe60872ef84de1fc565ffe398fff9067715b6fca',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@73455e0d2d59acbcf6f163b3b51e0b851669bb60'
}
