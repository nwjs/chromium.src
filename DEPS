...
#  
#  This DEPS file corresponds to Chromium 36.0.1937.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@190aa50c51b5cb83e54d580769963a3e9d0a0ff9',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@263439',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1937@171394',
   'src/breakpad/src':
