...
#  
#  This DEPS file corresponds to Chromium 36.0.1983.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@07d259de99a6cdbb36b8f7cfc5dfd51551f1c485',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@269088',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1983@173706',
   'src/breakpad/src':
