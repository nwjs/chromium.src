...
#  
#  This DEPS file corresponds to Chromium 30.0.1553.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@f17a1ddffa04ddcf7ccb1e8de715e91a1453c141',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@209483',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1553@153399',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11645',
   'src/third_party/smhasher/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9832',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@516',
   'build':
      '/trunk/tools/build@209566',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11645',
   'src/third_party/libphonenumber/src/test':
      Var("libphonenumber") + '/trunk/cpp/test@584',
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@653',
