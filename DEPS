...
#  
#  This DEPS file corresponds to Chromium 5.0.375.4
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKit/mac':
         '/branches/WebKit/375/WebKit/mac@44263',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@29937',
      'src/third_party/WebKit/WebKitLibraries':
         '/branches/WebKit/375/WebKitLibraries@44263',
      'src/third_party/lighttpd':
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      '/branches/WebKit/375/LayoutTests/platform/chromium-win/fast/workers@44263',
   'src/build/util/support':
      '/trunk/deps/support@44293',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      '/branches/WebKit/375/LayoutTests/storage/domstorage@44263',
   'src/v8':
      'http://v8.googlecode.com/svn/branches/2.1@4336',
   'src':
      '/branches/375/src@44284',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/375/LayoutTests/http/tests/workers@44263',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      '/branches/WebKit/375/WebKitTools/DumpRenderTree@44263',
   'src/third_party/icu':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      '/branches/WebKit/375/LayoutTests/platform/chromium-win/http/tests/workers@44263',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      '/branches/WebKit/375/LayoutTests/platform/chromium-mac/storage/domstorage@44263',
   'src/third_party/WebKit/LayoutTests':
      '/branches/WebKit/375/LayoutTests@44263',
}
