  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@b3b320e0ec6b45236f13354b1d7d597204192a5e',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2086@177794',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@1c577cd3ee331944b9061ee0eec147b211ee563c',
  ...
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@281854',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@2f1f89d6afefb89aa19257b5c624e3b3eb15203d',
