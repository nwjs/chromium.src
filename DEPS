  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@98d1a85ea3d812a2c374be351f31df06aae7ab32',
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@f6fde175b81db98cd3799ee88714a4c579bb44bd',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@57f20894aee71ca9f78803f5a7545a86fd880ddb',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@81ee51bff1533b46300126d77395e187a38b5b8a',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@096d76564bb962c70bd1f4381a8ed4ae15a4a8c4',
