  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@4da40f737aa48572238f9b449aadbfc48ab51f5b',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@289711',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2124@180320',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@5c4b137592a7937b4d02d72a976fa783f8d3675a',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13613',
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@567f0a9938122289301cc58e0611de39a6af789c',
