...
#  
#  This DEPS file corresponds to Chromium 33.0.1715.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      '/trunk/deps/third_party/openssl@235797',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@66059ed0c74f119295451cfae89394fd94045a06',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/ots':
      Var("ots") + '/trunk@107',
   'src/third_party/libaddressinput/src/testdata':
      Var("libaddressinput") + '/trunk/testdata@146',
   'src/third_party/mesa/src':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@236101',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1715@162436',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12372',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12372',
   ...
   'src/third_party/libaddressinput/src/cpp':
      Var("libaddressinput") + '/trunk/cpp@146',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12308',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@236379',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
