...
#  
#  This DEPS file corresponds to Chromium 30.0.1552.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@db753287c136294bc8b0ebc04a0788a11d39771e',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@209166',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1552@153305',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9798',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@515',
   'build':
      '/trunk/tools/build@209268',
