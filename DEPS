...
#  
#  This DEPS file corresponds to Chromium 32.0.1700.41
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1700@163020',
   'src/tools/deps2git':
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.46/webrtc@5094',
   'src/third_party/libjpeg_turbo':
