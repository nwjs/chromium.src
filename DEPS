...
#  
#  This DEPS file corresponds to Chromium 34.0.1807.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e4acc79c76eb5a0e7c1d3efbd788447d9a70b62e',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@247049',
   'src/third_party/bidichecker':
   ...
   'src/chrome/browser/resources/pdf/html_office':
      Var("git.chromium.org") + '/chromium/html-office-public.git@e7d60b10b04451db34395429134f87d5536912ec',
   'src/native_client':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1807@165818',
   'src/third_party/icu':
