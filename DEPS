...
deps = {
  ...
  'src/third_party/ffmpeg':
    (Var("chromium_git")) + '/chromium/third_party/ffmpeg.git@b9e848bd5382fcefedd1dcca7c6900cc5625f3bf',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@158b345efcad7f6e38fec4501a13cee36752a6a4'
}
