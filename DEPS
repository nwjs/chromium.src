...
#  
#  This DEPS file corresponds to Chromium 31.0.1612.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@58dbd2841ca8f84703e23f314b505fc032c4eef5',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1612@156762',
   'src/third_party/cld2':
      Var("cld2") + '/trunk@19',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@219632',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10909',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@519',
   'build':
      '/trunk/tools/build@219606',
   'src/third_party/libsrtp':
