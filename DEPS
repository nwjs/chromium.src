...
#  
#  This DEPS file corresponds to Chromium 21.0.1140.0
#  
#  
#  
...
deps = {
   ...
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@3970',
   ...
   'src/tools/gyp':
      'http://gyp.googlecode.com/svn/trunk@1381',
   ...
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@3970',
   'src/tools/grit':
