  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@33edd8e27bac3f022808abfd3653d8079d5939be',
      'src/third_party/cros_system_api':
        (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@0637337a705ce7c7a9e27e78a15685ccb1088781',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@285999',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2107@179092',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@e5ad0dde25ffde2f8cf7491240559c999be6ab24',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@6b555c18f93ce9feca87df43eb824118a9c124c5',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13540',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13540',
