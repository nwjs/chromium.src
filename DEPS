...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@f30727bc4d8db1720990f747e229d1bbf0d13d79',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@4e8955b7720a9585b25313d57d140da5ac264d4c',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@be01d6f613685cff206b1fcbadb921f3fe7283d8',
  'src/breakpad/src':
