...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@71e963eb7970784589961cc3f9ae57ab393c3dcd',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292703',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@86e0c964e00691d80f9f92500a6ee5cf83cc1f33',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@10e4626ca30681aaf61420a6151566a70029c32e',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@bfb312d4b40507780e15bfee2e0dc32f1391c4db',
