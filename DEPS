...
#  
#  This DEPS file corresponds to Chromium 34.0.1824.5
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12694',
   'src/third_party/smhasher/src':
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12694',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@78',
   'build':
      '/trunk/tools/build@249002',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1846',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1824@166529',
   'src/third_party/icu':
