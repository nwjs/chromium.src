vars = {
  ...
  'pdfium_revision':
    'c89c6195373b63e99b9cd432c5a181bfb3ad8dbe',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '143fd5547c614704d95ec82ff791ae5211b06f2d',
  'swarming_revision':
    '8fce79620b04bbe5415ace1103db27505bdc4c06',
  'v8_revision':
    '6dbca998bbf43050097affbd5b916a40636fc1de'
}
...
deps = {
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@2e0901b75f44c81665f2c97365f8c59e51942dc7',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@2e833914bbd78cf3db4b3ec7517c296faff84a6f',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@1da435bae87437b4dcfdb9e13e59615ed2cadad5',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@c89c6195373b63e99b9cd432c5a181bfb3ad8dbe',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@143fd5547c614704d95ec82ff791ae5211b06f2d',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@c8b569e0a7ad0b369e15f0197b3a558699ec8efa',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@6dbca998bbf43050097affbd5b916a40636fc1de'
}
