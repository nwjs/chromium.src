...
#  
#  This DEPS file corresponds to Chromium 35.0.1875.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@6791b1d2d0f314730e9b35be6a200e30bedff3b2',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1875@168644',
   'src/third_party/icu':
