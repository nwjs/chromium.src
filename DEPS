...
#  
#  This DEPS file corresponds to Chromium 37.0.1988.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@dad2a03910a2e596e8865f19e737aebdc7073b0a',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1988@173889',
   'src/breakpad/src':
