...
#  
#  This DEPS file corresponds to Chromium 31.0.1651.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@5e4980e1380c5480d3748e1d5fb50704d6f81a2a',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@225058',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1651@158293',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4831',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1651/src@225135',
   'src/third_party/hunspell':
   ...
   'src/v8':
      Var("v8") + '/trunk@16822',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@224839',
   'src/third_party/sfntly/cpp/src':
