...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      '/trunk/deps/third_party/nss@275589'
  },
  'mac': {
  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@f8b30495ab0b455f5721308de17f4a87406a014d',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2038@175755',
