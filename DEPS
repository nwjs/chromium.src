...
#  
#  This DEPS file corresponds to Chromium 33.0.1730.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@3432acdf46b3ac440cc775b65960c8e3c9a80d02',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@163217',
