...
#  
#  This DEPS file corresponds to Chromium 30.0.1581.5
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@1627',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@93281fa6a9fa1af48aae02d0a9c142a4450af51e',
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@295836580061cb441c11ee3b2a6c7225ecf9ebbb',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@214fb6506eda13715edd74087adf367a29809a3c',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@eda719cf5bf102f38b17fe4f583fbc5fde581be6',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@214247',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1581@155132',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11830',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11830',
   'src/third_party/leveldatabase/src':
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4414',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1581/src@215308',
   'src/third_party/hunspell':
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@213621',
   ...
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@784',
   'build/scripts/command_wrapper/bin':
      '/trunk/tools/command_wrapper/bin@135178',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu46@213354',
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@9b344317b2ced9123da6e0e55aeb75e8abca84c5',
   'src/tools/grit':
...
include_rules =  ['+base', '+build', '+ipc', '+library_loaders', '+testing', '+third_party/icu/source/common/unicode', '+third_party/icu/source/i18n/unicode', '+url', '!googleurl']