...
#  
#  This DEPS file corresponds to Chromium 7.0.517.2
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/WebCore@66913',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/LayoutTests/fast/events@66913',
   ...
   'src/v8':
      'http://v8.googlecode.com/svn/branches/2.3@5418',
   'src/breakpad/src':
   ...
   'src/third_party/WebKit/JavaScriptCore':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/JavaScriptCore@66913',
   ...
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/LayoutTests@66913',
   ...
   'src/third_party/WebKit/WebKit/chromium':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/WebKit/chromium@66913',
