...
#  
#  This DEPS file corresponds to Chromium 33.0.1724.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@24247928ffd0d8fc291e7a5e3873dce5a1b3dcc0',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1724@162928',
