...
#  
#  This DEPS file corresponds to Chromium 31.0.1600.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@c5736e8a33f69c62d90ad44665bdc9004c0c3235',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1600@156071',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10680',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@217370',
   'src/third_party/libsrtp':
