...
#  
#  This DEPS file corresponds to Chromium 31.0.1606.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@a051c4f9479e4fb98fd86c1693c40c3f71ee6c46',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1606@156363',
   'src/third_party/cld2':
      Var("cld2") + '/trunk@19',
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12013',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12013',
   'src/third_party/leveldatabase/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10765',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@519',
   'build':
      '/trunk/tools/build@218413',
   'src/third_party/libsrtp':
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@6d3511e0dfa9160bb70988bf5e3c03f5edecce19',
   'src/tools/grit':
