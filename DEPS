...
#  
#  This DEPS file corresponds to Chromium 36.0.1943.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@5f6a47786408789bc4622a34b491c0a9d0a69c68',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@337c589e84ecd08de7169e2555d6205368e881ee',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@84ff5f258a86d40ae69ccefde2efa45e52a9808c',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@263978',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1943@171773',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1313',
   'src/third_party/openmax_dl':
   ...
   'build':
      '/trunk/tools/build@264195',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1892',
   'src/chrome/test/data/perf/canvas_bench':
      '/trunk/deps/canvas_bench@122605',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@263988',
