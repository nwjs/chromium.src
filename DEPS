  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@ea7688e125f4d69c20b5a06b4c72cb9061b67ec5',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@286931',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2110@179362',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@992c7b03ef7914a18bfd78e965b0b4c99a5f5672',
  ...
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@286315',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@a3d21e2101ea690ee476d63ed221940e762a67e3',
