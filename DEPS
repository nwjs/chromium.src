  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@ca75b2f18c8364c8cf8d9cd181b25e15212428e5',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2122@180135',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@ea13afff6e46d8a969611cdd56c996bfb05a27c1',
  ...
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@288801',
