...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@7140dace7a66b3d05ca0147274a214970657a426',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293549',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@23d432080cb8506bf8e371b1637ce8f2de9c0c05',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@cd1db9e6c937a69f8efb5f73a3fcad14a737c436',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@db844cf4392029269a6dc9d5f8141ef3e531ed8f',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@2e08d2a7aa9d65d269d8c57aba82eb38a8cb0a18',
