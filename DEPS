...
#  
#  This DEPS file corresponds to Chromium 5.0.333.0
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKit/mac':
         'http://svn.webkit.org/repository/webkit/trunk/WebKit/mac@54944',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@29937',
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@54944',
...
deps = {
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/events@54944',
   'src/third_party/WebKit/WebKit/chromium':
      'http://svn.webkit.org/repository/webkit/trunk/WebKit/chromium@54944',
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@490',
   'src/third_party/ots':
      'http://ots.googlecode.com/svn/trunk@26',
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/trunk/WebCore@54944',
   'src/breakpad/src':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/workers@54944',
   'src/googleurl':
      'http://google-url.googlecode.com/svn/trunk@122',
   'src/chrome/test/data/layout_tests/LayoutTests/websocket/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/websocket/tests/workers@54944',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/xmlhttprequest@54944',
   ...
   'src/third_party/WebKit/WebKitTools/pywebsocket':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/pywebsocket@54944',
   'src/tools/gyp':
      'http://gyp.googlecode.com/svn/trunk@785',
   'src/third_party/WebKit/WebKitTools/Scripts':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/Scripts@54944',
   'src/sdch/open-vcdiff':
      'http://open-vcdiff.googlecode.com/svn/trunk@28',
   'src/third_party/WebKit/JavaScriptCore':
      'http://svn.webkit.org/repository/webkit/trunk/JavaScriptCore@54944',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/js/resources@54944',
   'src/native_client':
      'http://nativeclient.googlecode.com/svn/trunk/src/native_client@1511',
   'src/third_party/WebKit/WebKitTools/simplejson':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/simplejson@54944',
   ...
   'src/build/util/support':
      '/trunk/deps/support@39438',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu42@37341',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/storage/domstorage@54944',
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@490',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/resources@54944',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/workers@54944',
   'src':
      '/trunk/src@39394',
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests@54944',
