vars = {
  ...
  'nacl_revision':
    'f84c2ab61585743268db990ee54d097426c309f0',
  'nss_revision':
    'aab0d08a298b29407397fbb1c4219f99e99431ed',
  'openmax_dl_revision':
    '37b900ccc45cfab71faf4fd332df15369766b94c',
  'pdfium_revision':
    'b5cbfb4cd12b6499912367f9a1e11c666157acb8',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '56f152b53f911b578e305d3461fb001585984a67',
  'swarming_revision':
    '3db878084b52a5e4eac0a32095e490e1b6ef9526',
  'v8_revision':
    '10b354c61d860b82bf5bc60a102b64d990758d75'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@f84c2ab61585743268db990ee54d097426c309f0',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@d52c88fc705c8a27efa6599754bfd4bc0404e931',
  ...
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@41c6cc7eb9f0208321ae0f9134a26a34bd31af37',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@b5cbfb4cd12b6499912367f9a1e11c666157acb8',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@56f152b53f911b578e305d3461fb001585984a67',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@0a0cccef9e22de10916d0ccc91db7086cea414fd',
  'src/third_party/yasm/source/patched-yasm':
    (Var("chromium_git")) + '/chromium/deps/yasm/patched-yasm.git@4671120cd8558ce62ee8672ebf3eb6f5216f909b',
  'src/tools/deps2git':
    (Var("chromium_git")) + '/chromium/tools/deps2git.git@f04828eb0b5acd3e7ad983c024870f17f17b06d9',
  'src/tools/grit':
    (Var("chromium_git")) + '/external/grit-i18n.git@4983981a20ff2f1c68a91994cff1eded5b2c494d',
  'src/tools/gyp':
    (Var("chromium_git")) + '/external/gyp.git@01528c7244837168a1c80f06ff60fa5a9793c824',
  'src/tools/page_cycler/acid3':
    (Var("chromium_git")) + '/chromium/deps/acid3.git@6be0a66a1ebd7ebc5abc1b2f405a945f6d871521',
  'src/tools/swarming_client':
    (Var("chromium_git")) + '/external/swarming.client.git@3db878084b52a5e4eac0a32095e490e1b6ef9526',
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@10b354c61d860b82bf5bc60a102b64d990758d75'
}
