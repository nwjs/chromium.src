...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@ada19cd784ba3038aa90405a6319c4ada017c289',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@db7b695d9d9f2f6358fe260b9c39fa7a338363ee'
}
