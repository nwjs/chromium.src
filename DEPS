...
#  
#  This DEPS file corresponds to Chromium 34.0.1825.4
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@9481a478cd2fea24ed70e81372529a613be1410d',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@40ce16481d063c8d42feaafcf1ca49975d20f6ed',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@249216',
   'src/third_party/bidichecker':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13315',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12705',
   'src/third_party/smhasher/src':
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12705',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@78',
   'build':
      '/trunk/tools/build@249230',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1846',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1825@166573',
   'src/third_party/icu':
