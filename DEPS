...
#  
#  This DEPS file corresponds to Chromium 31.0.1613.1
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1613@156817',
   'src/third_party/cld2':
      Var("cld2") + '/trunk@19',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4622',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1613/src@219906',
   'src/third_party/hunspell':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10927',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@519',
   'build':
      '/trunk/tools/build@219874',
   'src/third_party/libsrtp':
