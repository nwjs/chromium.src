vars = {
  'angle_revision':
    'fc1a44a1fe23f100a3164baf90a1b1693748450b',
  'boringssl_revision':
    '6d9e5a74482bb832a6b4d9ae3d20d8f10f250bbd',
  'buildspec_platforms':
    'win-asan,',
  'buildtools_revision':
    'b747a9e091cb8212a62343258406eaf53a6c032e',
  'chromium_git':
  ...
  'skia_revision':
    '95f53fbc5ddf14ddb1e51c7ebced2b80fb069f81',
  'swarming_revision':
    '9cdd76171e517a430a72dcd7d66ade67e109aa00',
  'v8_revision':
    'f8bb4b939a564b536ac829b90074d9b8a5bf455a'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@b747a9e091cb8212a62343258406eaf53a6c032e',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@fc1a44a1fe23f100a3164baf90a1b1693748450b',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@6d9e5a74482bb832a6b4d9ae3d20d8f10f250bbd',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@95f53fbc5ddf14ddb1e51c7ebced2b80fb069f81',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@f8bb4b939a564b536ac829b90074d9b8a5bf455a'
}
