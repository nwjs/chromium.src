...
#  
#  This DEPS file corresponds to Chromium 36.0.1925.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@88eca75e652f047d32a1602afa429081b26beeb1',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@261601',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1925@170817',
   'src/breakpad/src':
   ...
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@4eeada947e2fa4f48100ebb39b740bccabbc7747',
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@261461',
   'src/third_party/swig/Lib':
