  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@c3d006277ce66133723938277baf25224ec2a0a4',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2120@179901',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@0be677d35c7ef1bf8a7a694d1838fa11333d1bec',
  ...
  'src/third_party/libaddressinput/src/testdata':
    (Var("libaddressinput")) + '/trunk/testdata@326',
  'src/testing/gmock':
    (Var("googlemock")) + '/trunk@485',
  'src/tools/grit':
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@33f3e1c4e0d125641524c0a5955594b1c22c804a',
