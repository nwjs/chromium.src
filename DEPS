...
#  
#  This DEPS file corresponds to Chromium 33.0.1720.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@8bf805c78f505b71e8177237dac23ab7891ba619',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@237120',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1720@162667',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12373',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@237226',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
