  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@e2f3eb089c691a965f95390845a4f711a62e79b3',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@285586',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2105@178975',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@d6aeb6dc8fe21066f1a2c4813a4256a3acd3edf5',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@07d49ef5350a95cfd6321226c178d22cc73aebc9',
  ...
  'src/third_party/snappy/src':
    (Var("snappy")) + '/trunk@80',
  'src/breakpad/src':
    (Var("google-breakpad")) + '/trunk/src@1359',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@794bf6e0cea9eca3406a821330be5dde0d014c47',
