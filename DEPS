...
#  
#  This DEPS file corresponds to Chromium 34.0.1793.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e51a265a8e086db136a1efdbabe27758da3a74dc',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1793@165365',
   'src/third_party/icu':
