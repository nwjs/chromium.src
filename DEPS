...
#  
#  This DEPS file corresponds to Chromium 33.0.1721.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@8a25cf98a91545d6692cb25a6d03f41c93293346',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@ff871feb88741a524587ed348504c562b733a6f8',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@237454',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1721@162736',
   ...
   'src':
      '/branches/1721/src@237600',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@e98b112accc431dd4f896d356856c0ffb53b2be2',
   'src/third_party/hunspell':
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@3bc1f246ff86182ceb05dc2d7c55f7c2ab44fd46',
   ...
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@138',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@4e13d48bb3a5253b8cf3c106d21a4d4cf9d1f10d',
   'src/third_party/swig/Lib':
