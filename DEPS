  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@cf8bcb7e3d9c35886e42f05ebd2e9d3472a0258f',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291665',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@ea13daec5f1be438b98845d0527d18bfdd9d69ca',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@5e8dbd31de0dff44aff83295bdfe518477a5a088',
  ...
  'src/tools/grit':
    (Var("git.chromium.org")) + '/external/grit-i18n.git@206c6aa4450db4e961d20f8367f33df42bba6a85',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@cb44d524fdfeb47a4d5b5946efa439a4f857f080',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@ef9d63ec5a38ac6d41c0a3ba0ee9bde42090da54',
  'src/buildtools':
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@02e6ca4c4fc94f72fa7aac326234dfd8a9f61d23',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu52.git@a4ce5bf56788dbb4835a5ef6143384266bbff5f5',
  ...
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@43a3b907eb20bd59c28c6e315b3d9e348ab57ac7'
}
