...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@59373654c08fc962acb726ef9a326bbf6cb84b4b',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@1a6e5472b52511ff605f73d50731f6c0e475a87c',
  'src/breakpad/src':
