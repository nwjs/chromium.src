...
#  
#  This DEPS file corresponds to Chromium 35.0.1878.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@4495b0396180ff85f16221dc55f252a284a1be10',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@168699',
   'src/third_party/webrtc':
