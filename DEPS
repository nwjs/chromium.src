...
#  
#  This DEPS file corresponds to Chromium 31.0.1630.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@5165e8f41a8db0772a84f97db1ad371891b044f3',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1630@157799',
