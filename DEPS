...
deps_os = {
  ...
  'ios': {
    ...
    'src/third_party/WebKit/public':
      (Var("blink")) + '/branches/chromium/2062/public@178617',
    ...
    'android': {
      ...
      'src/breakpad/src':
        (Var("google-breakpad")) + '/branches/chrome_37/src@1353',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2062@178617',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@20ee1baa69715365e53d12ffb0e9d05d8dc0eda6',
  ...
  'src/third_party/webrtc':
    (Var("webrtc")) + '/branches/3.55/webrtc@6655',
  'src/tools/deps2git':
    '/trunk/tools/deps2git@276439',
