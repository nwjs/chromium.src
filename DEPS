...
#  
#  This DEPS file corresponds to Chromium 30.0.1588.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@dae8ddaab7f8dc9e3d79f9e6db4daaf90ba07351',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@215724',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1588@155574',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10524',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@215770',
   'src/third_party/libsrtp':
