...
#  
#  This DEPS file corresponds to Chromium 28.0.1463.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      'http://src.chromium.org/blink/trunk/Source/Platform/chromium/public@147504',
      ...
      'http://src.chromium.org/blink/trunk/Source/WebKit/chromium/public@147504',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@3191a5ed48b982bf6e0ae7f77b9d70c817a4d015',
      ...
      'http://src.chromium.org/blink/trunk/Tools/gdb@147504',
      'build/xvfb':
      ...
      'https://git.chromium.org/chromiumos/chromite.git@3ac0b8c090aaabde0ca9618d7c747b86ce7a79d7',
      'src/third_party/lss':
...
deps = {
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11083',
   'src/third_party/skia/include':
      Var("skia") + '/trunk/include@8500',
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/files':
      'http://src.chromium.org/blink/trunk/LayoutTests/platform/chromium/fast/files@147504',
   'src/third_party/ots':
      Var("ots") + '/trunk@97',
   'src/third_party/sfntly/cpp/src':
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@191052',
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      'http://src.chromium.org/blink/trunk/LayoutTests/storage/indexeddb@147504',
   'src/sandbox/linux/seccomp-legacy':
      Var("seccompsandbox") + '/trunk@189',
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@292',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      'http://src.chromium.org/blink/trunk/LayoutTests/http/tests/appcache@147504',
   'src/third_party/WebKit/Tools/Scripts':
      'http://src.chromium.org/blink/trunk/Tools/Scripts@147504',
   'commit-queue':
      '/trunk/tools/commit-queue@192066',
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@8500',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/events':
      'http://src.chromium.org/blink/trunk/LayoutTests/platform/chromium/fast/events@147504',
   'src/third_party/webdriver/pylib':
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      'http://src.chromium.org/blink/trunk/Tools/DumpRenderTree@147504',
   'src/third_party/libphonenumber/src/phonenumbers':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://src.chromium.org/blink/trunk/LayoutTests/http/tests/workers@147504',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      'http://src.chromium.org/blink/trunk/LayoutTests/fast/workers@147504',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      'http://src.chromium.org/blink/trunk/LayoutTests/media@147504',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/webkit/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@181763',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://src.chromium.org/blink/trunk/LayoutTests/storage/domstorage@147504',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@63',
   'src/tools/grit':
   ...
   'src/content/test/data/layout_tests/LayoutTests/editing/pasteboard/resources':
      'http://src.chromium.org/blink/trunk/LayoutTests/editing/pasteboard/resources@147504',
   'src/tools/deps2git':
      '/trunk/tools/deps2git@181098',
   'src/third_party/libjpeg_turbo':
      '/trunk/deps/third_party/libjpeg_turbo@177737',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'http://src.chromium.org/blink/trunk/LayoutTests/platform/chromium-win/storage/domstorage@147504',
   'src/third_party/pywebsocket/src':
      Var("pywebsocket") + '/trunk/src@662',
   'src/third_party/scons-2.0.1':
      Var("native_client") + '/trunk/src/third_party/scons-2.0.1@11040',
   'src/third_party/WebKit/LayoutTests':
      'http://src.chromium.org/blink/trunk/LayoutTests@147504',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'http://src.chromium.org/blink/trunk/LayoutTests/platform/chromium-win/http/tests/workers@147504',
   'depot_tools':
      '/trunk/tools/depot_tools@192170',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit/Source':
      'http://src.chromium.org/blink/trunk/Source@147504',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://src.chromium.org/blink/trunk/LayoutTests/http/tests/resources@147504',
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@192166',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'http://src.chromium.org/blink/trunk/LayoutTests/platform/chromium/fast/workers@147504',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'http://src.chromium.org/blink/trunk/LayoutTests/platform/chromium-win/fast/workers@147504',
   'build/scripts/gsd_generate_index':
      '/trunk/tools/gsd_generate_index@164784',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@8500',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11083',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@147',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@3704',
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem':
      'http://src.chromium.org/blink/trunk/LayoutTests/fast/filesystem@147504',
   'src/third_party/ffmpeg':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://src.chromium.org/blink/trunk/LayoutTests/http/tests/xmlhttprequest@147504',
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'http://src.chromium.org/blink/trunk/LayoutTests/platform/chromium-win/fast/events@147504',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      'http://src.chromium.org/blink/trunk/LayoutTests/fast/files@147504',
   'build/scripts/command_wrapper/bin':
      '/trunk/tools/command_wrapper/bin@135178',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@302',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      'http://src.chromium.org/blink/trunk/LayoutTests/fast/events@147504',
   'src':
      '/trunk/src@192192',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   ...
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@245',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      'http://src.chromium.org/blink/trunk/LayoutTests/http/tests/websocket/tests@147504',
   'src/third_party/hunspell':
      '/trunk/deps/third_party/hunspell@184822',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://src.chromium.org/blink/trunk/LayoutTests/fast/js/resources@147504',
   'src/third_party/WebKit/Tools/TestWebKitAPI':
      'http://src.chromium.org/blink/trunk/Tools/TestWebKitAPI@147504',
   'src/testing/gtest':
