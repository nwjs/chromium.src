...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      '/trunk/deps/third_party/nss@287121'
  },
  'mac': {
  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@38242c6c77b77bcfb887fa97f3735c3262310370',
      ...
      'src/third_party/chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@5fbc8b1ace4d3541d02d9f6503d4c75877ce3a9b',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@287637',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2115@179560',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@41ebbddd76b747d5fb32c02dda0de3d03a3edda5',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@9755ed3846884c8ba999a4cc1789e49147659635',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13580',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13580',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@4fbd36ec50ff9e15887b948cc075526dd72d1415',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@465c2a84ba709d932040c9e80db508e93c138da6',
  'src/third_party/libphonenumber/src/phonenumbers':
    (Var("libphonenumber")) + '/trunk/cpp/src/phonenumbers@621',
  'src/third_party/openssl':
    '/trunk/deps/third_party/openssl@284247',
  'src/third_party/trace-viewer':
    (Var("trace-viewer")) + '/trunk@1434',
  'src/third_party/yasm/source/patched-yasm':
    '/trunk/deps/third_party/yasm/patched-yasm@167605',
  'src/third_party/safe_browsing/testing':
    (Var("google-safe-browsing")) + '/trunk/testing@112',
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@e43196c4b1f7954f246916fc06f4a248bd6b75ba',
  'build':
    '/trunk/tools/build@287666',
  ...
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@287125',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@533cbee57eec77268ef9f53c4039ec753240fb37',
