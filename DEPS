...
#  
#  This DEPS file corresponds to Chromium 33.0.1737.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@44744d70f0d0d7a9012a99883c0a79fb374d5280',
      'src/third_party/lss':
...
deps = {
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12523',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12523',
   ...
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@9fc05789e32ef5893c710886879d5254f6a828f6',
   'src/third_party/hunspell':
   ...
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1256',
   'src/media/cdm/ppapi/api':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12631',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@240510',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@214783',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@240211',
