...
deps_os = {
  ...
  'unix': {
    ...
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@286cec023e90f54f391fe32bae512f9ec7b4e807',
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@3cfa04aedb6425c738b0c8dcaf8864acc3024e64',
    'src/third_party/lss':
  ...
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@f6e2370dff438125897bb3b3800de1ad7aa62c27',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293963',
  ...
  'src/third_party/openmax_dl':
    (Var("git.chromium.org")) + '/external/webrtc/deps/third_party/openmax.git@81318c19369769ddaff9602936af5c699d8299b9',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@b8d463525878d4592c90f16cfb89db8b78925e39',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@bdad1183d6047cc6a1459a5be167ba0a7325146e',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@e898b135f11c7c119388191c63539250a72b3a28',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@2363d1a72c7d71d91f5bb37cfec87dee68486836',
  ...
  'build':
    '/trunk/tools/build@293985',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@4d7c139b1820c5fcb993868c61f170a02cda8a40',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@592ab9dd91e653f5c2d4f7395267046d229e20c1',
  'build/third_party/lighttpd':
    '/trunk/deps/third_party/lighttpd@58968',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@da0df3fdac6036e862addb1155a2d6c11b6c18d5',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@e361ce8eeec660e034d90a33f43164c7240a21e8',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@7061d1af45752617fafa85e2242dc5b2844650b5',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@4cdb373bda5977743d2bf2c89ab82e2edf571b90',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@738bfa17fac6eb3b0b73d331eed5600ce8616e3b',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@8b488fa5699df266fd0a26a1f643e608cc14347b',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@5cdd30205301c293be6160f778bce981300b5a28',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@8f5e2ebcee628ef02add9b21955402b0c6256624',
