...
#  
#  This DEPS file corresponds to Chromium 36.0.1971.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e2975d28f6496d0376933449159b6b2da0fc9d9d',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@267707',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1971@173209',
   'src/breakpad/src':
   ...
   'src/third_party/webgl/src':
      Var("git.chromium.org") + '/external/khronosgroup/webgl.git@dd5d37f23dcbdba91f1cf623ba10b2c0ea78ea38',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@14492',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13115',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13115',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@267789',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1900',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@267596',
   'src/third_party/swig/Lib':
