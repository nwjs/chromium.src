...
#  
#  This DEPS file corresponds to Chromium 36.0.1982.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@826b4567a5f3b01e2f52022759990dac56c14ea6',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@83b7a38f85aee4dcaba061ac8d584044207448a4',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1982@173650',
   'src/breakpad/src':
