...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@0525793e633c0894651247183068131747d3b5b4',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@be9628fda9414ed49dc935fa620e83d61597eb56',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@0a81f1ee0edff6542a3a1579277780b67669c782',
