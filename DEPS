...
#  
#  This DEPS file corresponds to Chromium 5.0.307.8
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKitLibraries':
         '/branches/WebKit/307/WebKitLibraries@39043',
      'src/third_party/WebKit/WebKit/mac':
         '/branches/WebKit/307/WebKit/mac@39043',
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/307/LayoutTests/http/tests/workers@39043',
   'src/third_party/WebKit/WebKitTools/pywebsocket':
      '/branches/WebKit/307/WebKitTools/pywebsocket@39043',
   'src/tools/gyp':
   ...
   'src/third_party/WebKit/JavaScriptCore':
      '/branches/WebKit/307/JavaScriptCore@39043',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      '/branches/WebKit/307/LayoutTests/fast/js/resources@39043',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      '/branches/WebKit/307/LayoutTests/http/tests/resources@39043',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@19546',
   'src/build/util/support':
      '/trunk/deps/support@39050',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      '/branches/WebKit/307/LayoutTests/storage/domstorage@39043',
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@490',
   'src/third_party/WebKit/LayoutTests':
      '/branches/WebKit/307/LayoutTests@39043',
   'src':
      '/branches/307/src@39041',
   'src/third_party/icu':
