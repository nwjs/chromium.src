...
#  
#  This DEPS file corresponds to Chromium 34.0.1767.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@67725ec7ddeb400d4941b192a41d975a7768f213',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1767@164391',
