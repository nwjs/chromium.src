...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@529d3908ecfe9e6f9cccdc436f42955e03f3731f',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293010',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@1f3fc940b2d59095375923f5e3da7dc803cd13a2',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@e097be50bdfac597119db2a170f96bae07dbcab1',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@254d2fcc4358280a169b48dc236e8178b02147ee',
