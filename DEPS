...
#  
#  This DEPS file corresponds to Chromium 33.0.1701.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@5672b7b736e284bb45bb021ae381f2bd07833045',
      'src/third_party/lss':
...
deps = {
   ...
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1230',
   'src/media/cdm/ppapi/api':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12124',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@524',
   'build':
      '/trunk/tools/build@233202',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
