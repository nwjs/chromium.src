...
deps = {
  'build':
    (Var("git.chromium.org")) + '/chromium/tools/build.git@33a44046936ae7cef2e165f586a52db4951913e4',
  'build/scripts/command_wrapper/bin':
    (Var("git.chromium.org")) + '/chromium/tools/command_wrapper/bin.git@2eeebba9a512cae9e4e9312f5ec728dbdad80bd0',
  'build/scripts/gsd_generate_index':
    (Var("git.chromium.org")) + '/chromium/tools/gsd_generate_index.git@d2f5d5a5d212d8fb337d751c0351644a6ac83ac8',
  'build/scripts/private/data/reliability':
    (Var("git.chromium.org")) + '/chromium/src/chrome/test/data/reliability.git@ba644102a2f81bb33582e9474a10812fef825389',
  'build/scripts/tools/deps2git':
    (Var("git.chromium.org")) + '/chromium/tools/deps2git.git@27ce444f50f3c6732982d225d3f4cf67f0979a98',
  'build/third_party/gsutil':
    (Var("git.chromium.org")) + '/external/gsutil/src.git@5cba434b828da428a906c8197a23c9ae120d2636',
  'build/third_party/gsutil/boto':
    (Var("git.chromium.org")) + '/external/boto.git@98fc59a5896f4ea990a4d527548204fed8f06c64',
  'build/third_party/lighttpd':
    (Var("git.chromium.org")) + '/chromium/deps/lighttpd.git@9dfa55d15937a688a92cbf2b7a8621b0927d06eb',
  'depot_tools':
    (Var("git.chromium.org")) + '/chromium/tools/depot_tools.git@196809e75b54763e3ddd43ab1becb94b2563cd50',
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@d7e4030ff7d38e0d88d7ca39c1c1222940bfb3b7',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@fa660d47fa1a6c649d5c29e001348447c55709e6',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@ac4a825a3a3fda9c4884c7f6c82b895b3ae6085e',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@e225147fefcd0675d53941b09299a504b02c931c',
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@6ffeb744a6b9ca6c9e73cff7365d22dff75fd639',
  'src/third_party/bidichecker':
    (Var("git.chromium.org")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@af0e32cb84f0c9cc65b9233a3414d2562642b342',
  ...
  'src/third_party/dom_distiller_js/dist':
    (Var("git.chromium.org")) + '/external/github.com/chromium/dom-distiller-dist.git@f93cf9c2817926a92f4f347b20fa840a1998d5f3',
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@0ec2f1eee82359bb9c02a912feb1914a3a169cbe',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu.git@a05f412f70489b77da0ddeb8baa31c68e3eff2c6',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@8538c304d7677f2191f97844e11640faee38d38e',
  'src/third_party/libjpeg_turbo':
    (Var("git.chromium.org")) + '/chromium/deps/libjpeg_turbo.git@f4631b6ee8b1dbb05e51ae335a7886f9ac598ab6',
  ...
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@a43631169b4200f2000c8cfa82404ce507e31486',
  'src/third_party/libyuv':
    (Var("git.chromium.org")) + '/libyuv/libyuv.git@632c50f29cdacb8c5872ce9938444b676b4a0c81',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@6f0a64a1bf18ab6636404cdfb883897459083a4d',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@0a24297be4737f5fe23b3b918b193260e64ab32d',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@6e52f2a8beb07923b042e4b6e04b211097338b04',
  ...
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@8986f8bfa84547b1a30a9256ebdd665024d68d71',
  'src/third_party/webpagereplay':
    (Var("git.chromium.org")) + '/external/github.com/chromium/web-page-replay.git@5da5975950daa7b30a6938da73fd0b3200901b0c',
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@e0cc456a6412d8cc554f4daf0ebc1836f0566663',
  ...
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@fdc7b812f99e48c00e9a487bd56751bbeae07043',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@7094b8203e99a17852de516f8d89b90acee189a2'
}
...
deps_os = {
  'android': {
    ...
    'src/third_party/android_protobuf/src':
      (Var("git.chromium.org")) + '/external/android_protobuf.git@999188d0dc72e97f7fe08bb756958a2cf090f4e7',
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@ed3dde6470c39b196c70f0c20374894d169754ec',
    ...
    'src/third_party/freetype-android/src':
      (Var("git.chromium.org")) + '/chromium/src/third_party/freetype2.git@e186230678ee8e4ea4ac4797ece8125761e3225a',
  ...
  'ios': {
    ...
    'src/ios/third_party/gcdwebserver/src':
      (Var("git.chromium.org")) + '/external/github.com/swisspol/GCDWebServer.git@3d5fd0b8281a7224c057deb2d17709b5bea64836',
    'src/native_client': None,
    'src/third_party/class-dump/src':
      (Var("git.chromium.org")) + '/external/github.com/nygard/class-dump.git@93e7c6a5419380d89656dcc511dc60d475199b67',
    'src/third_party/ffmpeg': None,
    'src/third_party/google_toolbox_for_mac/src':
      (Var("git.chromium.org")) + '/external/google-toolbox-for-mac.git@ce47a231ea0b238fbe95538e86cc61d74c234be6',
    'src/third_party/hunspell_dictionaries': None,
    'src/third_party/nss':
      (Var("git.chromium.org")) + '/chromium/deps/nss.git@aab0d08a298b29407397fbb1c4219f99e99431ed',
  ...
  'unix': {
    'build/third_party/xvfb':
      (Var("git.chromium.org")) + '/chromium/tools/third_party/xvfb.git@aebb1aadf1422e4d81e831e13746b8f7ae322e07',
    'src/chrome/tools/test/reference_build/chrome_linux':
      (Var("git.chromium.org")) + '/chromium/reference_builds/chrome_linux64.git@033d053a528e820e1de3e2db766678d862a86b36',
    'src/third_party/chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@8a83c625c57a1ad990ba8f5f95890b57d204501f',
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@ba08c21a075ab091ca9bdc783435c2aec8c6f807',
