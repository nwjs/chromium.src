...
#  
#  This DEPS file corresponds to Chromium 21.0.1143.0
#  
#  
#  
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@137925',
   },
   'mac': {
      'src/third_party/lighttpd':
...
deps = {
   ...
   'src/native_client':
      'http://src.chromium.org/native_client/trunk/src/native_client@8626',
   ...
   'src/native_client_sdk/src/site_scons':
      'http://src.chromium.org/native_client/trunk/src/native_client/site_scons@8626',
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      'http://src.chromium.org/native_client/trunk/src/native_client/tests/prebuilt@8626',
