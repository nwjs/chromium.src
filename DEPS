...
#  
#  This DEPS file corresponds to Chromium 35.0.1865.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@2045',
      'src/third_party/nss':
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@f3d9869f6ad52b16363dab90061d521d53f284c2',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@254042',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1865@168142',
   'src/third_party/icu':
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@b75fee4e9e67546dbc80b7d33cf830e65b2ceac4',
   'src/v8':
      Var("v8") + '/trunk@19589',
