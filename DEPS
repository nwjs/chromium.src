...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@e5020b46748de7216284b7248250988360233794',
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@96a857ef5a40b3d0751ec9ebaaa96d9f20b82b21',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@d863df38343f8057dbddfe5543addcf19a49ce0f',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@d625bf51aded2c12685f397ea05b0395621887ea',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@de89332f5b49965009f8182a3adfaee0f9778d55',
