...
#  
#  This DEPS file corresponds to Chromium 35.0.1895.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@1959b7f817bfcd49d0afab60b7b481b0d55430bd',
      'src/third_party/lss':
...
deps = {
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12859',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12859',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@257322',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1874',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1895@169310',
   'src/third_party/icu':
