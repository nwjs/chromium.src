...
#  
#  This DEPS file corresponds to Chromium 34.0.1840.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@720498704f4a91966dcee2b5add694000cc0661c',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1840@167147',
   'src/third_party/icu':
   ...
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@de4e7cfa2b4417021f34c2d2e573c2a5d6e1d317',
