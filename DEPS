...
#  
#  This DEPS file corresponds to Chromium 31.0.1650.22
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1650@159593',
   'src/tools/deps2git':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m31_1650/src@11662',
   'src/third_party/webpagereplay':
