vars = {
  ...
  'nacl_revision':
    'f3dcedcdb5cf72890166b9618005331bd2666e84',
  'nss_revision':
    'a676aa04ff18b30983cac03dede5861b3db62c9d',
  'openmax_dl_revision':
    '37b900ccc45cfab71faf4fd332df15369766b94c',
  'pdfium_revision':
    '34bb6c58fe60206a08dc0a1f37b7cfe83e8c762c',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '16d7e96f3700fd60d58d5903bf4d89816b411841',
  'swarming_revision':
    '8fce79620b04bbe5415ace1103db27505bdc4c06',
  'v8_revision':
    '23533853f416feadfc1b39db7501837d4bf5f7fa'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@f3dcedcdb5cf72890166b9618005331bd2666e84',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@34bb6c58fe60206a08dc0a1f37b7cfe83e8c762c',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@16d7e96f3700fd60d58d5903bf4d89816b411841',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@7ad9e661f8a035d49d049ccdb87c77ae8ecdfa35',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@23533853f416feadfc1b39db7501837d4bf5f7fa'
}
