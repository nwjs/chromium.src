...
#  
#  This DEPS file corresponds to Chromium 29.0.1510.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("native_client") + '/trunk/deps/third_party/gnu_binutils@11323',
      'src/third_party/psyco_win32':
      '/trunk/deps/third_party/psyco_win32@79861',
      'src/third_party/mingw-w64/mingw/bin':
      Var("native_client") + '/trunk/deps/third_party/mingw-w64/mingw/bin@11323',
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@1494',
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@200337',
   },
   'mac': {
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@97a529d65b4a36298c735f008eb55a8bc900e119',
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@35319f42106fab09ae8ccb639b8e74406120e1c4',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@9b913456f3f1cb52ba6885cd3b1bbfff576377af',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@b12d410c0ee23385da78e6c9f353d28fd992e0bd',
...
deps = {
   ...
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@303',
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/storage/indexeddb@150547',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/http/tests/appcache@150547',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@320',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/platform/chromium-win/http/tests/workers@150547',
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@9156',
   'src/third_party/scons-2.0.1':
      Var("native_client") + '/trunk/src/third_party/scons-2.0.1@11323',
   'src/third_party/webdriver/pylib':
      Var("selenium") + '/trunk/py@16922',
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@200553',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@189528',
   'src':
      '/branches/1510/src@200723',
   'src/third_party/libyuv':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/http/tests/workers@150547',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/fast/workers@150547',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/media@150547',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/webkit/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@181763',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/storage/domstorage@150547',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@74',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@4032',
   'src/tools/deps2git':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@200613',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@200708',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1178',
   'src/third_party/openmax_dl':
      Var("webrtc") + '/deps/third_party/openmax@3720',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/http/tests/resources@150547',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/platform/chromium-win/fast/workers@150547',
   'src/testing/gtest':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9156',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11348',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/content/test/data/layout_tests/LayoutTests/editing/pasteboard/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/editing/pasteboard/resources@150547',
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/fast/filesystem@150547',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11348',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@73',
   'build':
      '/trunk/tools/build@200675',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1626',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/platform/chromium-win/storage/domstorage@150547',
   'build/third_party/lighttpd':
      '/trunk/deps/third_party/lighttpd@58968',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/http/tests/xmlhttprequest@150547',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src/third_party/libphonenumber/src/test':
      Var("libphonenumber") + '/trunk/cpp/test@456',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/platform/chromium-win/fast/events@150547',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@200366',
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/fast/files@150547',
   'build/scripts/command_wrapper/bin':
      '/trunk/tools/command_wrapper/bin@135178',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/fast/events@150547',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@150522',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu46@199252',
   'src/third_party/speex':
      '/trunk/deps/third_party/speex@198168',
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@121',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@511',
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@455',
   'src/third_party/swig/Lib':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/http/tests/websocket/tests@150547',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1510/LayoutTests/fast/js/resources@150547',
}
