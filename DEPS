vars = {
  'angle_revision':
    'e1743f37a9844a7b315c1703d4cf94bd3fce46ca',
  'boringssl_revision':
  ...
  'v8_revision':
    '1b037e22c4cb9fc511c21aea1e32ffa31568528d'
}
...
deps = {
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@e1743f37a9844a7b315c1703d4cf94bd3fce46ca',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@afe57cb14d36f70ad4a109fc5e7765d1adc67035',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@b80c94349cc85fcc8490d2d01c32c8dbd6e794bc',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@6eb4e36a93ea695e7adb771ea9ac3326680a8e98',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@1b037e22c4cb9fc511c21aea1e32ffa31568528d'
}
