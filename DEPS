...
#  
#  This DEPS file corresponds to Chromium 7.0.503.1
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKitLibraries':
         'svn://svn.chromium.org/webkit-readonly/trunk/WebKitLibraries@65740',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@50870',
      'src/third_party/WebKit/WebKit/mac':
         'svn://svn.chromium.org/webkit-readonly/trunk/WebKit/mac@65740',
   ...
   'unix': {
      ...
      'src/third_party/cros':
         'http://src.chromium.org/git/cros.git@cc58f46',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@50870',
...
deps = {
   ...
   'src/third_party/WebKit/WebCore':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebCore@65740',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/fast/workers@65740',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium/fast/workers@65740',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/fast/js/resources@65740',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/http/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-mac/http/tests/workers@65740',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/http/tests/resources@65740',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/storage/domstorage@65740',
   'src/third_party/ppapi':
      'http://ppapi.googlecode.com/svn/trunk@207',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/fast/events@65740',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/http/tests/workers@65740',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/http/tests/xmlhttprequest@65740',
   'src/tools/gyp':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/storage/domstorage@65740',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/fast/events@65740',
   'src/third_party/WebKit/JavaScriptCore':
      'svn://svn.chromium.org/webkit-readonly/trunk/JavaScriptCore@65740',
   'src/third_party/libvpx/lib':
      '/trunk/deps/third_party/libvpx/lib@55944',
   'src/third_party/WebKit/LayoutTests':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests@65740',
   'src/chrome/test/data/layout_tests/LayoutTests/media':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/media@65740',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/fast/events':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-mac/fast/events@65740',
   'src/native_client':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-mac/storage/domstorage@65740',
   'src/third_party/WebKit/WebKit/chromium':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebKit/chromium@65740',
   'src/chrome/test/data/layout_tests/LayoutTests/websocket/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/websocket/tests/workers@65740',
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@593',
   'src/third_party/WebKit/WebKitTools/Scripts':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebKitTools/Scripts@65740',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/fast/workers@65740',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebKitTools/DumpRenderTree@65740',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu42@54982',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/http/tests/workers@65740',
