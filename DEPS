...
#  
#  This DEPS file corresponds to Chromium 36.0.1927.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@373ec88bee0a0972295cb1713b391fe2c3822b43',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1927@170925',
   'src/breakpad/src':
