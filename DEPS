...
#  
#  This DEPS file corresponds to Chromium 35.0.1916.22
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1916/public@170893',
      'src/native_client':
      None,
...
deps = {
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.51/webrtc@5818',
   'src/tools/deps2git':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1916@170893',
   'src/third_party/icu':
