  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@47cbcefccf37de45a7eb3128cedb37ce3cdb42b9',
      'src/third_party/cros_system_api':
        (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@562b63142d3028ce3803746b3afe66c1670aff54',
    ...
    'android': {
      ...
      'src/third_party/android_tools':
        (Var("git.chromium.org")) + '/android_tools.git@8301b711a9ac7de56e9a9ff3dee0b2ebfc9a380f',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@284349',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2102@178722',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@d09622e3d3826ec3e67d6b17dae6af2ed750f143',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@2cbc12487aea464730bcf60230f4d4d63d61ac51',
  ...
  'src/third_party/libaddressinput/src/testdata':
    (Var("libaddressinput")) + '/trunk/testdata@310',
  'src/testing/gmock':
    (Var("googlemock")) + '/trunk@410',
  'src/tools/grit':
    (Var("grit-i18n")) + '/trunk@171',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13506',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13506',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@11c26b9c1182c9872693bab0b1fbf0fac148ab73',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@22b31e0b3d14a50c4dd70ed22e0f24975dc1137c',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@35b6086d85dd8aa7d29c2525e11debc5937bb506',
  'build':
    '/trunk/tools/build@284825',
  ...
  'src/third_party/libaddressinput/src/cpp':
    (Var("libaddressinput")) + '/trunk/cpp@310',
  'src/third_party/icu':
  ...
  'src/third_party/snappy/src':
    (Var("snappy")) + '/trunk@80',
  'src/breakpad/src':
    (Var("google-breakpad")) + '/trunk/src@1356',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@de620d9c87293fd0ed3b0a348550833565a0b61a',
