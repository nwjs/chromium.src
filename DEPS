  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@9a5980ec6a982fae9df85758d289f4e4c8df9c55',
      'src/third_party/cros_system_api':
        (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@5e0746db937822e77288800bd8d0ca5702dcff85',
      'src/third_party/pyelftools':
        (Var("git.chromium.org")) + '/chromiumos/third_party/pyelftools.git@bdc1d380acd88d4bfaf47265008091483b0d614e',
      'src/third_party/chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@371a0a5adec10a47f6040241b574b96b9bc00fbc',
    ...
    'android': {
      ...
      'src/third_party/android_tools':
        (Var("git.chromium.org")) + '/android_tools.git@b36620e3a51939055ba871022123221a37ecdebb',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@283474',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2096@178306',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@3944a1d2374d2de8622b0192aa080dba6fb92c76',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@c8437bfa40aa3428ee7655585b6203f2cac67693',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13456',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@787fc03f15a0c4440d023659f267175fa3979808',
  'build/third_party/lighttpd':
    '/trunk/deps/third_party/lighttpd@58968',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@59b93247766e1cdac6e482637ad493df38f7aeb7',
  ...
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@7c8cb656a753b6237e50c546c31ad826373abf04',
  'src/third_party/libyuv':
    (Var("libyuv")) + '/trunk@1035',
  'src/third_party/libjingle/source/talk':
    (Var("webrtc")) + '/trunk/talk@6683',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@0ce77e3c04dd17d3086adfc8781a2155fb9ceb69',
  'src/third_party/libphonenumber/src/phonenumbers':
    (Var("libphonenumber")) + '/trunk/cpp/src/phonenumbers@621',
  'src/third_party/openssl':
    '/trunk/deps/third_party/openssl@283115',
  'src/third_party/trace-viewer':
    (Var("trace-viewer")) + '/trunk@1308',
  'src/third_party/yasm/source/patched-yasm':
    '/trunk/deps/third_party/yasm/patched-yasm@167605',
  'src/third_party/safe_browsing/testing':
    (Var("google-safe-browsing")) + '/trunk/testing@112',
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@4b7b36f956209fad838ad87d0129130713fbb00c',
  'build':
    '/trunk/tools/build@283609',
  ...
  'src/third_party/libaddressinput/src/cpp':
    (Var("libaddressinput")) + '/trunk/cpp@305',
  'src/third_party/icu':
  ...
  'src/third_party/snappy/src':
    (Var("snappy")) + '/trunk@80',
  'src/breakpad/src':
    (Var("google-breakpad")) + '/trunk/src@1345',
  ...
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@282874',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@045cc5590a214a0efb982d028a4f1f0e9dfe3314',
...
{
  'action': ['python',
  'src/third_party/clang_format/bin/rm_binaries.py'],
  'pattern':
    '.',
  'name':
    'remove_old_clang_format_binaries'
},
{
  'action': ['python',
