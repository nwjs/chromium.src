...
#  
#  This DEPS file corresponds to Chromium 25.0.1364.81
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@f1d8eca39f605ea48e7608c6e0af276c154bb388',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/branches/chrome-1364/src@273',
