...
#  
#  This DEPS file corresponds to Chromium 20.0.1090.0
#  
#  
#  
...
deps = {
   ...
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@3568',
   ...
   'src/third_party/skia/third_party/glu':
      'http://skia.googlecode.com/svn/trunk/third_party/glu@3568',
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@130189',
   ...
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@3568',
   'src/tools/grit':
