vars = {
  'angle_revision':
    '8182049470aa3ba0c9f7c54ef965bf1877df08cb',
  'boringssl_revision':
    'e189c86bc75066ce675d076375062947f7cf1217',
  'buildspec_platforms':
    'all',
  'buildtools_revision':
  ...
  'nacl_revision':
    '0f5756e09816dba8fc189ae75a55cd96fd5edeac',
  'nss_revision':
    'aab0d08a298b29407397fbb1c4219f99e99431ed',
  'openmax_dl_revision':
    '37b900ccc45cfab71faf4fd332df15369766b94c',
  'pdfium_revision':
    'f7a8b34f520f1d4892f009700972ab2995ed2681',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '3f65e93b19027e61a640a8f421dcd745146446f7',
  'swarming_revision':
    '8fce79620b04bbe5415ace1103db27505bdc4c06',
  'v8_revision':
    '277a2ae48aafc390a26bc7827d5415620628e71c'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@0f5756e09816dba8fc189ae75a55cd96fd5edeac',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@8182049470aa3ba0c9f7c54ef965bf1877df08cb',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@e189c86bc75066ce675d076375062947f7cf1217',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@e51d21d56faa4790cd20bf5ebea4a0f138a884bb',
  ...
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@2844662e1c9733c2a064b740c27accbd49e1f755',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@f7a8b34f520f1d4892f009700972ab2995ed2681',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@3f65e93b19027e61a640a8f421dcd745146446f7',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@9e6d51dbe35082c3d08718a74ad13fc4a3f2e7a7',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@277a2ae48aafc390a26bc7827d5415620628e71c'
}
