...
#  
#  This DEPS file corresponds to Chromium 13.0.749.0
#  
#  
#  
deps_os = {
   'win': {
      ...
      'src/third_party/ffmpeg/binaries/chromium/win/ia32':
         '/trunk/deps/third_party/ffmpeg/binaries/win@82962',
...
deps = {
   ...
   'src/tools/gyp':
      'http://gyp.googlecode.com/svn/trunk@915',
   ...
   'chromeos':
      '/trunk/src/tools/cros.DEPS@83128',
   'src/googleurl':
   ...
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg/source@82962',
