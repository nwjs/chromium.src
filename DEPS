...
#  
#  This DEPS file corresponds to Chromium 34.0.1809.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@de2fd12270f29ccb72fbe2f18d17ec0ae1cfb41f',
      'src/third_party/lss':
...
deps = {
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@247376',
   'src/breakpad/src':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1809@165903',
   'src/third_party/icu':
