...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@73ace60ed1efd75bd570e2aed80a812ca78b47ee',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@2e978ac9fddec368b3796ac64c38d0ca0ba64090',
