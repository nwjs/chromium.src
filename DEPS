...
deps_os = {
  ...
  'ios': {
    ...
    'src/third_party/WebKit/public':
      (Var("blink")) + '/branches/chromium/1985/public@174826',
...
deps = {
  ...
  'src/third_party/webrtc':
    (Var("webrtc")) + '/branches/3.53/webrtc@6223',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@01b4c0a0ff283e543b7fd2ec9bb3d3dd88d14566',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/1985@174826',
  'src/third_party/icu':
