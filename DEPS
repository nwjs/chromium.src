...
#  
#  This DEPS file corresponds to Chromium 36.0.1930.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e9edf120675bfb8249bae768ce40dc234d2170be',
...
deps = {
   ...
   'src/third_party/skia/include':
      Var("skia") + '/trunk/include@14070',
   'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@260965',
   'src/third_party/libc++abi/trunk':
   ...
   'src/third_party/WebKit/LayoutTests/w3c/csswg-test':
      Var("git.chromium.org") + '/external/w3c/csswg-test.git@7ce6320613b5d5153d737435a0152ea66daf9563',
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@262182',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1930@171020',
   'src/breakpad/src':
   ...
   'src/third_party/WebKit/LayoutTests/w3c/web-platform-tests':
      Var("git.chromium.org") + '/external/w3c/web-platform-tests.git@2f0f4e335e765fdfb9603f6553f466cca2686a3a',
   ...
   'src/chrome/browser/resources/pdf/html_office':
      Var("git.chromium.org") + '/chromium/html-office-public.git@c29b3dcd20a03c5cec041764d178245b7d306dec',
   'src/third_party/angle':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@261575',
   'src/third_party/swig/Lib':
