...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@544f6bbc79c64bd1ddd5960c1254920b65f9420c',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@baf880d43993ceab4e2c88c23551b4996aaeaa2d'
}
