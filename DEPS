...
#  
#  This DEPS file corresponds to Chromium 32.0.1671.4
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@f6705da2b71d0ea475d9823dce532e5eab706694',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@c2c123d9e0af78a90ecf7bff16486bacbbe20dfe',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@228565',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1671@159639',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12241',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12241',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4955',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1671/src@228769',
   'src/third_party/hunspell':
   ...
   'src/v8':
      Var("v8") + '/trunk@17178',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@227030',
   'src/third_party/sfntly/cpp/src':
      Var("sfntly") + '/trunk/cpp/src@134',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1219',
   'src/media/cdm/ppapi/api':
   ...
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@1028',
   'build/scripts/command_wrapper/bin':
      '/trunk/tools/command_wrapper/bin@135178',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu46@228516',
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@e5014a97e29c0d88d47c693ed168c00f61551e53',
   'src/tools/grit':
