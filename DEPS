...
#  
#  This DEPS file corresponds to Chromium 35.0.1910.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@844a42e5f5c7a106807b09b6c2ac6b00b166c1cc',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@fa0e6c82276912efc33d5f3d3b3add5cacc783f3',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@259338',
   'src/third_party/bidichecker':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13928',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12927',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12927',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@259446',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1880',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1910@170007',
   'src/third_party/icu':
