...
#  
#  This DEPS file corresponds to Chromium 4.1.249.1006
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKit/mac':
         '/branches/WebKit/249/WebKit/mac@38288',
      ...
      'src/third_party/WebKit/WebKitLibraries':
         '/branches/WebKit/249/WebKitLibraries@38288',
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      '/branches/WebKit/249/LayoutTests/http/tests/xmlhttprequest@38288',
   'src/third_party/protobuf2/src':
      'http://protobuf.googlecode.com/svn/trunk@219',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/249/LayoutTests/http/tests/workers@38288',
   'src/tools/gyp':
   ...
   'src/third_party/WebKit/JavaScriptCore':
      '/branches/WebKit/249/JavaScriptCore@38288',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      '/branches/WebKit/249/LayoutTests/fast/js/resources@38288',
   ...
   'src/build/util/support':
      '/trunk/deps/support@38333',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      '/branches/WebKit/249/LayoutTests/storage/domstorage@38288',
   'src/testing/gtest':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      '/branches/WebKit/249/LayoutTests/http/tests/resources@38288',
   'src/third_party/WebKit/LayoutTests':
      '/branches/WebKit/249/LayoutTests@38288',
   'src':
      '/branches/249/src@38328',
   'src/third_party/icu':
