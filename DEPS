  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@918b1ec7e71a84a86f0a4c6cffdabeb35cd84fb9',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2113@179457',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@7883132a4e93c8b5e897e271603d3b7122655a51',
