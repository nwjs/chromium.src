vars = {
  'angle_revision':
    'adf825b3ece84e629d69ec60cf2145e627f788ab',
  'boringssl_revision':
  ...
  'nacl_revision':
    '0c539908088374d1c4074e331456644b21628a65',
  'nss_revision':
    'a676aa04ff18b30983cac03dede5861b3db62c9d',
  'openmax_dl_revision':
    '7a179b97899cf33d4a12c7ef590176c519016f4d',
  'pdfium_revision':
    '94edf0c37d1ee6a03697375b9e227071ff2ee69d',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '62d3b101106602d87cad91b0ac97c10003ca33a5',
  'swarming_revision':
    '9cdd76171e517a430a72dcd7d66ade67e109aa00',
  'v8_revision':
    'd2f58f90db97b6ab2f914284631c2a83f712e7e3'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@0c539908088374d1c4074e331456644b21628a65',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@adf825b3ece84e629d69ec60cf2145e627f788ab',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@5a04232538e36bee48676aaaf6a4459da6de5e0d',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@94edf0c37d1ee6a03697375b9e227071ff2ee69d',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@62d3b101106602d87cad91b0ac97c10003ca33a5',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@d4bc8299f0539c7e4be05f595acabbbeb334a33d',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@d2f58f90db97b6ab2f914284631c2a83f712e7e3'
}
