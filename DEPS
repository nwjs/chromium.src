...
#  
#  This DEPS file corresponds to Chromium 36.0.1965.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@97ac6329e0ddf74d6be94a6f8e6960f2d30c0683',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@266682',
   'src/third_party/libc++abi/trunk':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@266908',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1965@172877',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1321',
   'src/third_party/openmax_dl':
