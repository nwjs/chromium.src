...
#  
#  This DEPS file corresponds to Chromium 5.0.314.1
#  
#  
#  
deps_os = {
   'win': {
      ...
      'src/third_party/swig/win':
         '/trunk/deps/third_party/swig/win@37274',
      'src/third_party/ffmpeg/binaries/chromium/win/ia32':
         '/trunk/deps/third_party/ffmpeg/binaries/win@34297',
   ...
   'mac': {
      ...
      'src/third_party/ffmpeg/binaries/chromium/mac/ia32_dbg':
         '/trunk/deps/third_party/ffmpeg/binaries/mac_dbg@34297',
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@54213',
      'src/third_party/ffmpeg/source/patched-ffmpeg-mt':
         '/trunk/deps/third_party/ffmpeg/patched-ffmpeg-mt@34297',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@29937',
      'src/third_party/WebKit/WebKit/mac':
         'http://svn.webkit.org/repository/webkit/trunk/WebKit/mac@54213',
      'src/third_party/swig/mac':
         '/trunk/deps/third_party/swig/mac@37274',
      'src/third_party/lighttpd':
         '/trunk/deps/third_party/lighttpd@33737',
      'src/third_party/ffmpeg/binaries/chromium/mac/ia32':
         '/trunk/deps/third_party/ffmpeg/binaries/mac@34297',
      'src/chrome/tools/test/reference_build/chrome_mac':
         '/trunk/deps/reference_builds/chrome_mac@35421',
   },
   'unix': {
      'src/third_party/ffmpeg/binaries/chromium/linux/x64_dbg':
         '/trunk/deps/third_party/ffmpeg/binaries/linux_64_dbg@34297',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@29937',
      'src/third_party/ffmpeg/binaries/chromium/linux/ia32_dbg':
         '/trunk/deps/third_party/ffmpeg/binaries/linux_dbg@34297',
      'src/third_party/ffmpeg/binaries/chromium/linux/ia32':
         '/trunk/deps/third_party/ffmpeg/binaries/linux@34297',
      'src/third_party/ffmpeg/source/patched-ffmpeg-mt':
         '/trunk/deps/third_party/ffmpeg/patched-ffmpeg-mt@34297',
      'src/third_party/swig/linux':
         '/trunk/deps/third_party/swig/linux@37274',
      'src/third_party/xdg-utils':
         '/trunk/deps/third_party/xdg-utils@29103',
      'src/third_party/ffmpeg/binaries/chromium/linux/x64':
         '/trunk/deps/third_party/ffmpeg/binaries/linux_64@34297',
...
deps = {
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/events@54213',
   'src/third_party/WebKit/WebKit/chromium':
      'http://svn.webkit.org/repository/webkit/trunk/WebKit/chromium@54213',
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@475',
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/trunk/WebCore@54213',
   'src/breakpad/src':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/websocket/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/websocket/tests/workers@54213',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/xmlhttprequest@54213',
   'src/third_party/protobuf2/src':
      'http://protobuf.googlecode.com/svn/trunk@305',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/workers@54213',
   'src/third_party/WebKit/WebKitTools/pywebsocket':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/pywebsocket@54213',
   'src/tools/gyp':
      'http://gyp.googlecode.com/svn/trunk@776',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/workers@54213',
   'src/sdch/open-vcdiff':
      'http://open-vcdiff.googlecode.com/svn/trunk@28',
   'src/third_party/WebKit/JavaScriptCore':
      'http://svn.webkit.org/repository/webkit/trunk/JavaScriptCore@54213',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/js/resources@54213',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/resources@54213',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@19546',
   'src/build/util/support':
      '/trunk/deps/support@37906',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/storage/domstorage@54213',
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@475',
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests@54213',
   'src':
      '/branches/314/src@37891',
   'src/third_party/icu':
   ...
   'src/third_party/swig/Lib':
      '/trunk/deps/third_party/swig/Lib@37274',
   'src/native_client':
