...
#  
#  This DEPS file corresponds to Chromium 31.0.1610.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@a909e687540f9e23f7b276b695e2bf02145d48d8',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1610@156669',
   'src/third_party/cld2':
      Var("cld2") + '/trunk@19',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4595',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1610/src@219425',
   'src/third_party/hunspell':
