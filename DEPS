vars = {
  ...
  'nacl_revision':
    '63ed0a8776dbf2930be23821f9939dfa1fad0f53',
  'nss_revision':
  ...
  'skia_revision':
    '7d974f5e4f8ded8834b58f560ac6e03aed370310',
  'swarming_revision':
    '3db878084b52a5e4eac0a32095e490e1b6ef9526',
  'v8_revision':
    'eebe48ecba96468d91b97aae65f75b50f0e45e33'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@63ed0a8776dbf2930be23821f9939dfa1fad0f53',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@7d974f5e4f8ded8834b58f560ac6e03aed370310',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@eebe48ecba96468d91b97aae65f75b50f0e45e33'
}
