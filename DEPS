vars = {
  ...
  'pdfium_revision':
    '3a3849176aa6e2db8baf2f9367b2d96c71815319',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    '5ac42ea8079c9368430971943192772984da5fce',
  'swarming_revision':
    '2866a22530cb65feae5d9f64c83636aed5391d06',
  'v8_revision':
    'eb3955e25b36712f0e9fb116c90ce6e4041f0f03',
  'webkit_revision':
    'bdbfd8cbacd6e9817077151d491a434b9f69514b'
}
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@a336fd3d1c16c54380f7707fcece973139d7821b',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@3a3849176aa6e2db8baf2f9367b2d96c71815319',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@5ac42ea8079c9368430971943192772984da5fce',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@eb3955e25b36712f0e9fb116c90ce6e4041f0f03'
}
