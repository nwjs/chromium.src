...
#  
#  This DEPS file corresponds to Chromium 24.0.1309.0
#  
#  
#  
...
deps = {
   ...
   'src/tools/gyp':
      'http://gyp.googlecode.com/svn/trunk@1523',
   'src/third_party/libyuv':
   ...
   'src/third_party/webrtc':
      'http://webrtc.googlecode.com/svn/stable/webrtc@2985',
   'src/third_party/ffmpeg':
