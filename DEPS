...
#  
#  This DEPS file corresponds to Chromium 34.0.1847.78
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.50/webrtc@5618',
   'src/tools/deps2git':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1847@169409',
   'src/third_party/icu':
