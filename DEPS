...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      (Var("git.chromium.org")) + '/chromium/deps/nss.git@258342ecf9c65105189092ef6339dc4e7779a7ae'
  },
  'mac': {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@63b4808f9493902aaafee106198db6c6a82e1ae3',
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@6137749888584b497e2e4282bac985bb1dd29291',
  ...
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@ea50cccc11657404ce22cf928062ed1a3927eb39',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293085',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@d7e49cee0878197012a417608ee86dcf2ede0660',
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@38233e7aa56ce21f6c48b4fd6c4dda0265c5a174',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@b1bd38998b21db00a44ac3ab62d03a8d8af94534',
  ...
  'build/third_party/oauth2client':
    (Var("git.chromium.org")) + '/external/github.com/google/oauth2client.git@00c4c8057a34ee142e9729dbeb51855e0282f82e',
  'build':
    '/trunk/tools/build@293095',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@2ce6e93a9c06f537686ce9347952abb69364ad5f',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@93188ae19c18cfe47244d5c1198ea8262381a93f',
