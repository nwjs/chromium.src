...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@d0a840d4d8bb6ebc9981cc331b1b231a6c6e0928',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@f7fd532293561de21a5ecd27edac120b1a9e94c5',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@c31ed491bdaab96fc7e21837f0516d205ed9b952',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@f80cf581e6e56ec3b28b118aebf98499b6bc156d',
