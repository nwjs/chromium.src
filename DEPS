...
#  
#  This DEPS file corresponds to Chromium 36.0.1945.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@959dd2a46598a168af54c0a715d1e56c8e208535',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@264331',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1945@171840',
   'src/breakpad/src':
   ...
   'src/third_party/webgl/src':
      Var("git.chromium.org") + '/external/khronosgroup/webgl.git@8f445334c2f13a6be762fbdc90c4d80397d31788',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@14202',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13018',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13018',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@264370',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1892',
   'src/chrome/test/data/perf/canvas_bench':
