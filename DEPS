vars = {
  'angle_revision':
    'cc54ab3635320660216cf0e6eff17fa80dbe1abc',
  'boringssl_revision':
    '1d128f369c797b8bae996d5e973fc0b8a099a1b8',
  'buildspec_platforms':
    'all',
  'buildtools_revision':
  ...
  'nacl_revision':
    '2bc21a8056f49f45d183d58481277d889097ad06',
  'nss_revision':
    'aab0d08a298b29407397fbb1c4219f99e99431ed',
  'openmax_dl_revision':
    '2eb98d819bed3082071a09268b886bc4496c6fb5',
  'pdfium_revision':
    '6f34355e9d091fd4e031e9354fdfa778000b0d4a',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    '2fd18f2cd0ac307bfa6f6c50b21a8b0027385769',
  'swarming_revision':
    '1d87b2fd3c2e024ef769699682b29ab839b4434b',
  'v8_revision':
    'aa06153c83bfaa44216e19412d333295b5c31c11',
  'webkit_revision':
    'cbc50161a29af95096e5e3731f048eba5baa8851'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@f7310ee61725e68b1c8921e381830362cf4f0999',
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@2bc21a8056f49f45d183d58481277d889097ad06',
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@cbc50161a29af95096e5e3731f048eba5baa8851',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@cc54ab3635320660216cf0e6eff17fa80dbe1abc',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@1d128f369c797b8bae996d5e973fc0b8a099a1b8',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@7bdbcba774b0b906b413be4c2f083958ffefa481',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@90294bd3b9efff9738119befe3294fbf049b65c3',
  ...
  'src/third_party/libvpx':
    (Var("chromium_git")) + '/chromium/deps/libvpx.git@ac1772e3db5c885b554f6a72ca9dbac4245cb0e2',
  'src/third_party/libwebm/source':
    (Var("chromium_git")) + '/webm/libwebm.git@75a6d2da8b63e0c446ec0ce1ac942c2962d959d7',
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@fcacbfb27f4cdc71a4b8f636a16235f6b9af465c',
  'src/third_party/mesa/src':
    (Var("chromium_git")) + '/chromium/deps/mesa.git@3918dbd3bced7843af396a0ee9f9da081d968806',
  'src/third_party/openmax_dl':
    (Var("chromium_git")) + '/external/webrtc/deps/third_party/openmax.git@2eb98d819bed3082071a09268b886bc4496c6fb5',
  'src/third_party/opus/src':
    (Var("chromium_git")) + '/chromium/deps/opus.git@cae696156f1e60006e39821e79a1811ae1933c69',
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@6f34355e9d091fd4e031e9354fdfa778000b0d4a',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@2fd18f2cd0ac307bfa6f6c50b21a8b0027385769',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@3e255235dad7c9f591ee82dedffb7f7c9b636338',
  'src/third_party/yasm/source/patched-yasm':
    (Var("chromium_git")) + '/chromium/deps/yasm/patched-yasm.git@4671120cd8558ce62ee8672ebf3eb6f5216f909b',
  'src/tools/deps2git':
    (Var("chromium_git")) + '/chromium/tools/deps2git.git@f04828eb0b5acd3e7ad983c024870f17f17b06d9',
  'src/tools/grit':
    (Var("chromium_git")) + '/external/grit-i18n.git@15d48e32cc9f346245c823ce48c54209d02ea983',
  'src/tools/gyp':
    (Var("chromium_git")) + '/external/gyp.git@5d01a8cda53bfa23f1dcbe0c31c33aa30f50cf4c',
  'src/tools/page_cycler/acid3':
    (Var("chromium_git")) + '/chromium/deps/acid3.git@6be0a66a1ebd7ebc5abc1b2f405a945f6d871521',
  'src/tools/swarming_client':
    (Var("chromium_git")) + '/external/swarming.client.git@1d87b2fd3c2e024ef769699682b29ab839b4434b',
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@aa06153c83bfaa44216e19412d333295b5c31c11'
}
