...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@9820166663c9ab7ec7ae6d25fd39a5e82cb01a3d',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292640',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@976386b75d883eebaa4d2f19c4ae0222f3f85c0a',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@bcb3bc30328c38441d3f7656cb649b123803726c',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@4415bacc16e429ee132e9759ba6880043b61cbdd',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@c4102cf8b31a545d4fba47108a45affdf92f6fa1',
  ...
  'build':
    '/trunk/tools/build@292646',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@a61e860884929dd46cb55de7916a7ba067a8a655',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@d2f756be4fd198d630b64dc6c3568184363e6d14',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@2ce4efe64e83181207479911164695a41302276a',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@767aebbef641a89498deebc29369a078207b4dcc',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu52.git@d8b2a9d7b0039a4950ee008c5b1d998902c44c60',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@bcef85c11a242b73acd026e807bec5ccd1e8bc52',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@26db57054e04a5b35e7ad88aecb3e05895491a5c',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@751e889b1d791d2b91c1437248454fa1d4e101a5',
