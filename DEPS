...
#  
#  This DEPS file corresponds to Chromium 36.0.1964.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@ab58318da04cb1ddbc2702f198e78516d49ec4b0',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@c9390198d02bf6f52b9a46b519badaf1c565261a',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@266667',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1964@172836',
   'src/breakpad/src':
   ...
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@b19319e0bc258985a01760c4260fcfb2b338db2b',
