...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@b1abbce38c87a49f16b8df6dc52682b1592f7abb',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@880f927216c2f0666f69155da0ffc732747fafb8',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@134e541ad149b9732bc4fee6fe6952cf669703a7'
}
