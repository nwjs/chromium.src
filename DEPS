...
#  
#  This DEPS file corresponds to Chromium 35.0.1909.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@258808',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@473f7ab6baf1781618f379a7680b56048b5e0ec1',
      'build/third_party/xvfb':
      '/trunk/tools/third_party/xvfb@125214',
      'src/third_party/mtpd/source':
      Var("git.chromium.org") + '/chromiumos/platform/mtpd.git@f9759da3a7cd95080414a7da0d899c47cad794f2',
      'src/third_party/undoview':
      '/trunk/deps/third_party/undoview@119694',
      'src/third_party/cros_system_api':
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@67c14ecd9f00a574abc59d45516dc35289c4119c',
      ...
      Var("git.chromium.org") + '/chromiumos/third_party/dbus-cplusplus.git@f78453e0ba9f3d1584e8873aa3c7437cec861ce0',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@ddd5cb0252387e6f1499586d11c20b86bd16d877',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@ca35676f4f652fa97964c488313720f55efd4405',
...
deps = {
   ...
   'src/third_party/brotli/src':
      Var("git.chromium.org") + '/external/font-compression-reference.git@494c85cebbaaa0db345df69ffa1b639aa4652022',
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@330',
   'src/chrome/test/data/perf/third_party/octane':
      Var("octane-benchmark") + '/trunk@19',
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@13904',
   'src/third_party/scons-2.0.1':
   ...
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@157',
   'src':
      '/branches/1909/src@259195',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@986',
   'src/third_party/hunspell':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@259164',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@249148',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1289',
   'src/third_party/openmax_dl':
   ...
   'src/third_party/webgl/src':
      Var("git.chromium.org") + '/external/khronosgroup/webgl.git@b6bce42c2484666d3e28dc25b12f27eb06f39f27',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13904',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12892',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@151',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@544',
   'build/scripts/tools/deps2git':
      '/trunk/tools/deps2git@256696',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12892',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@259192',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1880',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1909@169947',
   'src/third_party/icu':
   ...
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@156',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@8472efa59518a6e28db6da249685d65f49ce8244',
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@28b4790916c70dff3cee85ba351ab46299a1af97',
   'src/v8':
      Var("v8") + '/trunk@20174',
   'src/third_party/libwebm/source':
      Var("git.chromium.org") + '/webm/libwebm.git@0f7815b036651e242ec8c2fcfb59fe54f69be1a8',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@257501',
   'src/third_party/swig/Lib':
