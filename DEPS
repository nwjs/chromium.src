  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@a6c86a0b80139eb513207e2a7590311a54031214',
      'src/third_party/cros_system_api':
        (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@0256bf857f64361b47353928087586ba261efb99',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2091@178022',
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@8e5430c72df4f1482eb8cae5cdb9fe963d5a50c4',
