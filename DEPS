...
#  
#  This DEPS file corresponds to Chromium 35.0.1871.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@a1d9baaa05c271a07b5825488ef7ec013edd3ee5',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1871@168392',
   'src/third_party/icu':
