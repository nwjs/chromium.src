...
#  
#  This DEPS file corresponds to Chromium 34.0.1823.2
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("native_client") + '/trunk/deps/third_party/gnu_binutils@12655',
      'src/third_party/psyco_win32':
      '/trunk/deps/third_party/psyco_win32@237949',
      'src/third_party/mingw-w64/mingw/bin':
      Var("native_client") + '/trunk/deps/third_party/mingw-w64/mingw/bin@12655',
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@2000',
      'src/third_party/nss':
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@6637dcd35a8b9f02ba54d2a369118306cee88432',
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@6445c9773efbcbcbc4077c349f846b18c525b3eb',
      'src/third_party/pyelftools':
      Var("git.chromium.org") + '/chromiumos/third_party/pyelftools.git@bdc1d380acd88d4bfaf47265008091483b0d614e',
      'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@244037',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e62a96208da19c855e7e55feac331767eafa0887',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@13293',
   'src/third_party/scons-2.0.1':
      Var("native_client") + '/trunk/src/third_party/scons-2.0.1@12655',
   'src/third_party/webdriver/pylib':
      Var("selenium") + '/trunk/py@18337',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src':
      '/branches/1823/src@248845',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@978',
   'src/third_party/hunspell':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@248821',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@248624',
   'src/breakpad/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13293',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12687',
   'src/third_party/smhasher/src':
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12687',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@78',
   'build':
      '/trunk/tools/build@248832',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1846',
   'src/chrome/test/data/perf/canvas_bench':
      '/trunk/deps/canvas_bench@122605',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@246718',
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/trunk/talk@5444',
   'src/third_party/usrsctp/usrsctplib':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1823@166450',
   'src/third_party/icu':
   ...
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@148',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@f9538eebbc82bdfed4768cde388c8ae8a1ac3209',
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@17918f9a0ba4deca8818b4e11d03e244c631a8e4',
   'src/v8':
      Var("v8") + '/trunk@19045',
   'src/third_party/libwebm/source':
      Var("git.chromium.org") + '/webm/libwebm.git@0f7815b036651e242ec8c2fcfb59fe54f69be1a8',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@248011',
   'src/third_party/swig/Lib':
