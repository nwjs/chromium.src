...
#  
#  This DEPS file corresponds to Chromium 30.0.1587.2
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@1689',
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@bdc1cbea55e787b27628156f7e96e5c7eacc95f4',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1587@155501',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11912',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11912',
   'src/third_party/leveldatabase/src':
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4462',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1587/src@215563',
   'src/third_party/hunspell':
   ...
   'src/third_party/accessibility-developer-tools':
      Var("git.chromium.org") + '/external/accessibility-developer-tools.git@03a584c1b3b9c164cd3c7747c6bd3c2f291aabb2',
   'src/third_party/scons-2.0.1':
