...
deps_os = {
  ...
  'unix': {
    ...
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@58e64ad700fb0e9d182feba37fa02af612d4179e',
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@afc296a9659a0b38d0fd31ef2aac738c25f54f16',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291975',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@49005bf8929dd8ca86431e13414d683b509cd538',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@9a52f504918a75e4c864ac661bce1e934adba7b1',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@d4f6ba5e0cd805c6f8085f5f69d06a5e17341d16',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@a258a1548860c7a58007ad6a371fb05730e84c30',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@d4006f48015b5df018a892d95b7a2ad45290cd02',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@301233289ba0bcefa3f9d5841426f3b541c45c12',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@a2b6094b526729ca0c4e4126c628e218cd98163f',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@b376fed08cb9d90a3f67f655adf63c4b35feb106',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@4947d55857acf2bf968016a7a00fe2b10fd52131',
