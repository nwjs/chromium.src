...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      (Var("git.chromium.org")) + '/chromium/deps/nss.git@4a442d04bfa2659a888c6e110f3043cecdba12cf'
  },
  'mac': {
    ...
    'src/third_party/google_toolbox_for_mac/src':
      (Var("git.chromium.org")) + '/external/google-toolbox-for-mac.git@704fb56df6a9a0884801045a158e021945d9d991',
  ...
  'unix': {
    ...
    'src/third_party/chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@1ae4638a4cd3313799f2d2598c39ff0e8941aef6',
    ...
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@e59913eb5a1562e23256b0527fb709be967bedc9',
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@62d1a0e95d10bfdd53992fb7ff440f43610bcf97',
    'src/third_party/lss':
  ...
  'android': {
    ...
    'src/third_party/aosp':
      (Var("git.chromium.org")) + '/chromium/deps/aosp.git@bbafe5155dff86bbba1e92b42a073ffcfcfbf28c',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291586',
  ...
  'src/third_party/libc++/trunk':
    (Var("git.chromium.org")) + '/chromium/llvm-project/libcxx.git@e785ef19637f88c5e3e9926fabd8a64cd7eac49d',
  'src/third_party/libwebm/source':
    (Var("git.chromium.org")) + '/webm/libwebm.git@0d4cb404ea4195e5e21d04db2c955615535ce62e',
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@04b6022fdfb31a848d67683b58cd785aaeba9a69',
  'src/third_party/openssl':
    (Var("git.chromium.org")) + '/chromium/deps/openssl.git@c9613e3123ff035683f45163af142817b38d03b6',
  'src/third_party/openmax_dl':
    (Var("git.chromium.org")) + '/external/webrtc/deps/third_party/openmax.git@79e64bc9243e5ff11822434cf39b9fabefff3bfb',
  'src/third_party/libc++abi/trunk':
    (Var("git.chromium.org")) + '/chromium/llvm-project/libcxxabi.git@062ba40d41870a04e0aefb64f8122e91aa824147',
  ...
  'src/third_party/WebKit/LayoutTests/w3c/csswg-test':
    (Var("git.chromium.org")) + '/external/w3c/csswg-test.git@0b12ea22689ee2179f3e9bff389db22f4efd6ed5',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@3e42a4638559d71481ba598857f2d0c715c8d4b3',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@b8aeeaef087fa2571aaaf64a8a8dbec06a0e0e41',
  ...
  'src/third_party/WebKit/LayoutTests/w3c/web-platform-tests':
    (Var("git.chromium.org")) + '/external/w3c/web-platform-tests.git@3e0f28376857901b2d3eefda82a3b622bbcabd41',
  'build/scripts/gsd_generate_index':
    '/trunk/tools/gsd_generate_index@164784',
  'src/third_party/cacheinvalidation/src':
    (Var("git.chromium.org")) + '/external/google-cache-invalidation-api/src.git@50c0a8563b62f6e3b780da14f82246d192f9c1e0',
  'src/testing/gmock':
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@c49fcd263ff91bc8acba3118b22b71345488896e',
  ...
  'build':
    '/trunk/tools/build@291585',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@b38e5f2f93fa5b31a6001bd21b9d8dcbf73e44e7',
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@f79f8ef8691cb0c91ecf36392f6defabd824af60',
  ...
  'src/third_party/libaddressinput/src':
    (Var("git.chromium.org")) + '/external/libaddressinput.git@b52a2aeb63a28914850f3ed81cd7fd26ecdd4cdc',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@635e82ec20b3d5ffcb24f9a1b1be9f1f24d8a3f4',
  'src/third_party/libyuv':
    (Var("git.chromium.org")) + '/external/libyuv.git@455c66b4375d72984b79249616d0a708ad568894',
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@9460de62505246d2f0a8b89319b946457c9ef086',
  ...
  'src/third_party/libsrtp':
    (Var("git.chromium.org")) + '/chromium/deps/libsrtp.git@662d81de5cbf3667f1baaafe051b8b4ab0b12fe2',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@e99ce9ec59a7b8bcd13fdf62e51c2cfa285a2a94',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu52.git@fdf0bb34eaddce23811770b987ecf95ee18572d6',
  'src/third_party/speex':
    (Var("git.chromium.org")) + '/chromium/deps/speex.git@5260621c36c227209c7ba64ea71ca3418cf9e2b4',
  'src/third_party/opus/src':
    (Var("git.chromium.org")) + '/chromium/deps/opus.git@cae696156f1e60006e39821e79a1811ae1933c69',
  'src/tools/grit':
    (Var("git.chromium.org")) + '/external/grit-i18n.git@6a46b04d35eade32b1270392317dca516c9dd56d',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@f854f30d7981795f687f9b4379100c037934535d',
  'src/tools/deps2git':
    (Var("git.chromium.org")) + '/chromium/tools/deps2git.git@f04828eb0b5acd3e7ad983c024870f17f17b06d9',
  'src/third_party/usrsctp/usrsctplib':
    (Var("git.chromium.org")) + '/external/usrsctplib.git@e6e18333da18c5bb7de7e9189e53403e2ffa7023',
  'src/third_party/libjpeg_turbo':
    (Var("git.chromium.org")) + '/chromium/deps/libjpeg_turbo.git@7a076b517c739af5197cad380b110f0ffc085d89',
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@bc75f36b04c8bab99bcecf8cdca16ecee3ac58ee',
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@f1a5a1dc668380a183184ee7629703846eefcfae',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@ace65784417788374f0b19ce5a8abd06c9ccd007',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@5213df4e9ed9ca130c40f142893cb91f2e18eee1',
  'src/third_party/swig/Lib':
    (Var("git.chromium.org")) + '/chromium/deps/swig/Lib.git@f2a695d52e61e6a8d967731434f165ed400f0d69',
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@e44dae1d413514e3a632838449fe317713b6f0af'
}
