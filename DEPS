...
#  
#  This DEPS file corresponds to Chromium 30.0.1569.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@59a6e103fd972817e3bb69a65b91170ea40d877f',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@6ddc7f1ec9dc990f793df54c058e7bccffbc1752',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@212426',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1569@154561',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11782',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11782',
   'src/third_party/leveldatabase/src':
   ...
   'src/v8':
      Var("v8") + '/trunk@15756',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@211873',
   'src/third_party/sfntly/cpp/src':
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@211397',
