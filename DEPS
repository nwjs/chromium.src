...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@577b94747445ae71a1c707a2f77bd95fe351418e',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@9598c222b325015a8732000a08cb627835a0d89a',
