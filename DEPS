...
#  
#  This DEPS file corresponds to Chromium 32.0.1680.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("native_client") + '/trunk/deps/third_party/gnu_binutils@12279',
      'src/third_party/pefile':
      Var("pefile") + '/trunk@63',
      'src/third_party/psyco_win32':
      '/trunk/deps/third_party/psyco_win32@79861',
      'src/third_party/mingw-w64/mingw/bin':
      Var("native_client") + '/trunk/deps/third_party/mingw-w64/mingw/bin@12279',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@0be3036f55a52d274d547d6be0d0b8ab201d7d24',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@0d6dff8b82b622b93a4a4307f53532df57f4aefa',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@230499',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1680@160414',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12284',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12284',
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@229791',
   'src/third_party/opus/src':
   ...
   'src/third_party/scons-2.0.1':
      Var("native_client") + '/trunk/src/third_party/scons-2.0.1@12279',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@230589',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11911',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@522',
   'build':
      '/trunk/tools/build@230605',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
