...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@77990af40b258b3e17cdb0a812dd7880b520082e',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@e6716a300970387285a6620dc637ebd199563643',
