...
deps = {
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@c7c7309d2da5f4498109274d10d8bc42483c2a4a',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@261f0b48c062734a6f88ae6bde7f23aede550728',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@dc1ad444a4eff301c3a4829ad7e2c3fbdaac457c'
}
