...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@9886df22c4ff8fbc6efc724541c43eb003637f8d',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@b04b0eada17b5c00446ab1d915d7a4dd2242f45c',
