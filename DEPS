...
#  
#  This DEPS file corresponds to Chromium 34.0.1847.49
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@249179',
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1847@168605',
   'src/third_party/icu':
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@92db5082ac33403d7dbd98471c8dbe2b681ce315',
   'src/v8':
      Var("v8") + '/branches/3.24@19671',
