  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@6cd7846257e6bbe0ad2faad4d5c1ac8e33e2325b',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@285434',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2104@178891',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@57493ba62a7ec6a6038e64afa891b3c98a7cc15d',
  ...
  'src/third_party/libaddressinput/src/testdata':
    (Var("libaddressinput")) + '/trunk/testdata@316',
  'src/testing/gmock':
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@bfdea66b45dd1b98a565e767533361ef728731ce',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@a08cf99d066b16e4e16393efc15174193e002371',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@11cc55f45980d8bcf78992e68d5c60809d24f449',
  'build':
    '/trunk/tools/build@285452',
  ...
  'src/third_party/libaddressinput/src/cpp':
    (Var("libaddressinput")) + '/trunk/cpp@316',
  'src/third_party/icu':
  ...
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@285378',
