...
#  
#  This DEPS file corresponds to Chromium 32.0.1679.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@6b7042454efc63d22637180025cdcb555914f2d0',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@230108',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1679@160290',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@230173',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11899',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@522',
   'build':
      '/trunk/tools/build@230291',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
