...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@3c47f8be0fdea2ec1453efd7e62d08bb18a43cac',
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@75502d403cfbc60ab1e1c81e8cbe7d45afb6bd0e',
  ...
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@36bf7ac9a608f95f642ec64a743feea3b2e5a8d5',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292513',
  ...
  'src/third_party/usrsctp/usrsctplib':
    (Var("git.chromium.org")) + '/external/usrsctplib.git@7accb99da6264405fd546d98af91e4f2969002c5',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@d12af70baf08c90491d11b4c55d5f6499fa84a0e',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@a57d7db4026bca8e0fab9aadd4953503e8d74e74',
  ...
  'src/third_party/cld_2/src':
    (Var("git.chromium.org")) + '/external/cld2.git@f765c467ca5a525639ba16f006056c763a64bd98',
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@34ac01c7aae98e74fbe14a6eb73297babb17c443',
  'src/testing/gmock':
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@0c748ef307bf64ef4f5cf1da22283cbc633b1820',
  'build/scripts/tools/deps2git':
    '/trunk/tools/deps2git@292431',
  'src/third_party/hunspell_dictionaries':
    (Var("git.chromium.org")) + '/chromium/deps/hunspell_dictionaries.git@4560bdd463a3500e2334e85c8a0e9e5d5d6774e7',
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@b1243719f015e44f8031fd104402cfca59accefb',
  ...
  'build':
    '/trunk/tools/build@292529',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@9202573e476f9f61341aec21b585cdc984141916',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@8e92923010c568a445c0f22e1a36f462fcabc8f3',
  ...
  'src/third_party/libyuv':
    (Var("git.chromium.org")) + '/external/libyuv.git@9107460c7f76a10cc4122d91e62b0580eacd376e',
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@1f6d92bb25f108ee5ec418811d95ca757bf228f9',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@cbd8e1a584e2c0ffcb7aaf49d89a7696f5ebc916',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@3bf3f6d734fc2ff47a756450c5d69dfbaf7d917a',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@4bc3dc1af71c98bb257fba5e442303f68b4ff8fc',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu52.git@8ac906faf7b66180f2208380c35ae1e07136c5cc',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@f0080877ecf410ddfd6453352f62798d6977f35c',
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@e15ba2c4d7d3b10c8c2818aa14ab66ad9a383ff6',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@b287d3641c8169c74f83a44b33ada13cf3cefaf2',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@7ea848165b89577c6e9a1ef12a2cdff9d1beb71f',
