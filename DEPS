...
deps_os = {
  ...
  'unix': {
    ...
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@b24b4f8d7cf8b0b680cedc384965b7b91e65b055',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@294179',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@1a9600f2537ad62e85529801a634167f2913bc24',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@de41287e2e18ab6859359f03f8cbdeceee1d0fe2',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@88ba65170891fb499ae83699f96567aab8b30fd5',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@0366d0b6d9dddb3d775d7ed8919c56a729cfe82f',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@d0a603a2abaa88be693d813c162ae0745cbd606c',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@e087c85d28582160723443b601040a2011d20cfc',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@6a19aa1e1f636f40eda73a1378586e0b514fb9cd',
