...
#  
#  This DEPS file corresponds to Chromium 37.0.1990.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@0ee2ce9eb9a6a4ccc63683768fb669f8939b05f3',
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@c55817f448cf0ec31a7932777a6ee3496349e0a1',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@270011',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1990@173961',
   'src/breakpad/src':
