...
#  
#  This DEPS file corresponds to Chromium 7.0.517.10
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/WebCore@67742',
   ...
   'src/v8':
      'http://v8.googlecode.com/svn/branches/2.3@5487',
   'src/breakpad/src':
   ...
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/LayoutTests@67742',
