...
#  
#  This DEPS file corresponds to Chromium 32.0.1685.3
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@228205',
   },
   'mac': {
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      '/trunk/deps/third_party/openssl@230364',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@a79d56b36aee7037255114cb49f060e045d19879',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@231387',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1685@160783',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12306',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12306',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4982',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1685/src@232155',
   'src/third_party/hunspell':
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@230741',
   'src/third_party/opus/src':
   ...
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@1040',
   'build/scripts/command_wrapper/bin':
      '/trunk/tools/command_wrapper/bin@135178',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu46@228516',
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@b992a7d282a996d15da3e194695ddebff50fd956',
   'src/tools/grit':
