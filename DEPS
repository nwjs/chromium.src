...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@dfe1f486eb3e5299038057e695681dcfbd70f617',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@c7c1de24364372731e9f9e28279a122565caf702',
  'src/breakpad/src':
