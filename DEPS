...
#  
#  This DEPS file corresponds to Chromium 6.0.424.0
#  
#  
#  
deps_os = {
   'win': {
      ...
      'src/third_party/ffmpeg/binaries/chromium/win/ia32':
         '/trunk/deps/third_party/ffmpeg/binaries/win@48686',
      ...
      'src/third_party/mingw-w64/mingw/bin':
         'http://nativeclient.googlecode.com/svn/trunk/src/third_party/mingw-w64/mingw/bin@2407',
      'src/third_party/nss':
...
deps = {
   ...
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg/source@48686',
   ...
   'src/native_client':
      'http://nativeclient.googlecode.com/svn/trunk/src/native_client@2407',
