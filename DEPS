vars = {
  ...
  'skia_revision':
    '56da02502019cfbb817898e37e320539b9838e2b',
  'swarming_revision':
    '8fce79620b04bbe5415ace1103db27505bdc4c06',
  'v8_revision':
    '0106735c54f0585473c958a4c49a51a70f2b35c7'
}
...
deps = {
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@638b658655d2e04ba19540f50b73af15f33add32',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@4274ea205ca2219f6a4cfc54025284c1aa3b14b8',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@56da02502019cfbb817898e37e320539b9838e2b',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@3492dab59a1ae6f25c31a688ad3232a08ce05b8d',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@0106735c54f0585473c958a4c49a51a70f2b35c7'
}
