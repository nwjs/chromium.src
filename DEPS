...
#  
#  This DEPS file corresponds to Chromium 33.0.1729.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@cec5e3c17d0ba24372a3fad09ccc66ec4f5d6ef2',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@95ac5b0a0cfd688aa9cf50a2155f0092d23400b3',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@238631',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1729@163218',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@238860',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12472',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@238889',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
