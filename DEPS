...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@294699',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@ff271c29a64f59d538e644210b0f207666f856b5',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@51a1db16d7c7ea92686a16ee324f7fc0687ad095',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@83830d59560f8d0f85876b2b12eb7df5496ccaea',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@d073ccb05861e4e561cd6bad6fc7e207752583f9',
