...
#  
#  This DEPS file corresponds to Chromium 35.0.1852.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@dd0f13a56b369f079424e3e3eebbccd3da03648f',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1852@167602',
   'src/third_party/icu':
