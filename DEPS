  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@3980632c376c6c289b7a2a5e1fb829e26e9ad186',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@279843',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2070@176956',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@4809e4d796a97d407970e224f1519b41638ab897',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@961d5e9878ddb892b650b6e14f2362b26ce34b40',
  'build/third_party/lighttpd':
    '/trunk/deps/third_party/lighttpd@58968',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@a072c5b27726c359a1e86b43ef5589194179a121',
