  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@15099cde8e63dbaaee355746e16a7174c54f2a42',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@283834',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2097@178418',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@3f376a55002c205aacacc4cb16ed745e3afbad31',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@a1851e8fbb596b5cd8da1ba585ce69641f7f3337',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@8f75c67f4e724ba44eb3d90e4033f8cc90522273',
