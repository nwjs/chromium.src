...
#  
#  This DEPS file corresponds to Chromium 36.0.1976.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@66e51e90bb700d7bfdd5632cb04b7f8f8ef0cd4f',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1976@173359',
   'src/breakpad/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@14573',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13137',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13137',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@80',
   'build':
      '/trunk/tools/build@268374',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1911',
   'src/chrome/test/data/perf/canvas_bench':
