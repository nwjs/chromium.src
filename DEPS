...
#  
#  This DEPS file corresponds to Chromium 34.0.1778.4
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      '/trunk/deps/third_party/openssl@243334',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e0ef3bdff151ecd18e4b9f8262d2f07ffc161208',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@244017',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1778@164841',
