...
#  
#  This DEPS file corresponds to Chromium 36.0.1928.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("native_client") + '/trunk/deps/third_party/gnu_binutils@12970',
      'src/third_party/psyco_win32':
      '/trunk/deps/third_party/psyco_win32@237949',
      'src/third_party/mingw-w64/mingw/bin':
      Var("native_client") + '/trunk/deps/third_party/mingw-w64/mingw/bin@12970',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@3d15f19f981f84606e8a09fc21c33fa929912213',
...
deps = {
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@14058',
   'src/third_party/scons-2.0.1':
      Var("native_client") + '/trunk/src/third_party/scons-2.0.1@12970',
   'src/third_party/webdriver/pylib':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@261783',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1928@170926',
   'src/breakpad/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@14058',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12992',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12992',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@261970',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1880',
   'src/chrome/test/data/perf/canvas_bench':
