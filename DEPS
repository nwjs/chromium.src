...
#  
#  This DEPS file corresponds to Chromium 29.0.1536.5
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@1570',
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@205313',
   },
   'mac': {
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@f893cdefbf398e65270b9f8a5aa924dfb1e74342',
      'src/third_party/pyelftools':
      Var("git.chromium.org") + '/chromiumos/third_party/pyelftools.git@bdc1d380acd88d4bfaf47265008091483b0d614e',
      'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@203545',
      'build/xvfb':
      ...
      'https://git.chromium.org/chromiumos/chromite.git@1279331624a4255239f5d109889809a9fddc0cce',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@308',
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/storage/indexeddb@152260',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/http/tests/appcache@152260',
   'src/webkit/renderer/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@181763',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/platform/chromium-win/http/tests/workers@152260',
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/http/tests/workers@152260',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/fast/workers@152260',
   'build/third_party/gsutil':
      Var("gsutil") + '@5cba434b828da428a906c8197a23c9ae120d2636',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/media@152260',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/storage/domstorage@152260',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@74',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@4197',
   'src/tools/deps2git':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@205692',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@204525',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1182',
   'src/third_party/openmax_dl':
      Var("webrtc") + '/deps/third_party/openmax@4148',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/http/tests/resources@152260',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/platform/chromium-win/fast/workers@152260',
   'src/testing/gtest':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9499',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11501',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/content/test/data/layout_tests/LayoutTests/editing/pasteboard/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/editing/pasteboard/resources@152260',
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/fast/filesystem@152260',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11501',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@73',
   'build':
      '/trunk/tools/build@205690',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1644',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/platform/chromium-win/storage/domstorage@152260',
   'build/third_party/lighttpd':
      '/trunk/deps/third_party/lighttpd@58968',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/http/tests/xmlhttprequest@152260',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src/third_party/libphonenumber/src/test':
      Var("libphonenumber") + '/trunk/cpp/test@456',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/platform/chromium-win/fast/events@152260',
   'src/third_party/yasm/source/patched-yasm':
   ...
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/fast/files@152260',
   'build/scripts/command_wrapper/bin':
      '/trunk/tools/command_wrapper/bin@135178',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@204510',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/fast/events@152260',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536@152260',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu46@199252',
   'src/third_party/speex':
      '/trunk/deps/third_party/speex@198168',
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@126',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@513',
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@579',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@338',
   'src/third_party/swig/Lib':
      '/trunk/deps/third_party/swig/Lib@69281',
   'src/third_party/angle':
      Var("angleproject") + '/trunk@2249',
   'src/v8':
      Var("v8") + '/trunk@15068',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@197977',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/http/tests/websocket/tests@152260',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1536/LayoutTests/fast/js/resources@152260',
}
