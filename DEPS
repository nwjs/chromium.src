...
#  
#  This DEPS file corresponds to Chromium 30.0.1574.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@59eb95c458f1bed035af543ec43e73fadda3529a',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@213265',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1574@154808',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@212802',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10239',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@213330',
   'src/third_party/libsrtp':
