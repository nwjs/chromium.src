...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@c7eb911f6e952fc1180c8f46401baaa3b5a30269',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@288205',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@0aeea6d344f12e35e29a79f4bbc48af88f913204',
  ...
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@2cd3af21647cb0ff368106d88188046675baf52d'
}
