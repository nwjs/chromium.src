vars = {
  'angle_revision':
    '4a693565dcfaba92f053db5c95e9338eac949245',
  'boringssl_revision':
  ...
  'pdfium_revision':
    '89d8b4681ce98894a1ee1a6cf4bae77e00d28797',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    '5dd918bb6f56dd0a4e400b5107fcfff1e4dcc3c1',
  'swarming_revision':
    '49f046853671bbd5ab65509a8049d36ac0224714',
  'v8_revision':
    'd22619367ed37be9741b44502c26ea64ba620e9d',
  'webkit_revision':
    'c8359a7e631f0136805a29601c4aaac22a689665'
}
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@c4ca917c2360eec0759a1e1c7e3a65d13b696904',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@4a693565dcfaba92f053db5c95e9338eac949245',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@1d128f369c797b8bae996d5e973fc0b8a099a1b8',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@4582fa970cdc43607c9ef2fcef6a45bf99fdea68',
  ...
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@602fdbef9408f496dbf55481fb467aa9fb462929',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@89d8b4681ce98894a1ee1a6cf4bae77e00d28797',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@5dd918bb6f56dd0a4e400b5107fcfff1e4dcc3c1',
  ...
  'src/tools/swarming_client':
    (Var("chromium_git")) + '/external/swarming.client.git@49f046853671bbd5ab65509a8049d36ac0224714',
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@d22619367ed37be9741b44502c26ea64ba620e9d'
}
