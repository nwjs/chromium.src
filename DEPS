  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@826eaf2baab20eaaee0e0d82f0745a16ef75154b',
    ...
    'android': {
      'src/third_party/android_webview_glue/src':
        (Var("git.chromium.org")) + '/external/android_webview_glue.git@6ec46f2bd3243d042d9641d7f87863bc20f8c745',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292407',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@a5305a110ab5201d5dadd40cbe711582d5ac4996',
  ...
  'build/scripts/tools/deps2git':
    '/trunk/tools/deps2git@292399',
  'src/third_party/hunspell_dictionaries':
    (Var("git.chromium.org")) + '/chromium/deps/hunspell_dictionaries.git@4560bdd463a3500e2334e85c8a0e9e5d5d6774e7',
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@4d5e6cbfc85ac836d68caab0b7e725ca4d5ddc81',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@a6b106cb586f6996add9af6eb15dfb01488f587f',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@b5b912c22ac0437a761e4e9e10e4923816c42cda',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@2ca6a51fec762b55e830180e17633b1ee9b7bef1',
