...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@968c1249e5239de603ab7920923a1d40186fcaf6',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293889',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@c927918cd65cd409a265eaf789fbe5f4c3f98284',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@fea15c4d6f99f61cfbe4f4bf702d278b8243f2a1',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@531baa3ccf89f9934ae65ea757ae216ff0abe0c4',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@bb200acf7078a7a355757baa6e26922d3206c8cc',
