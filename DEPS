...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@c9a674110f5911f48cfd34462f037e888bbe6f47',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@181bb0c3be8374add599fefd745762e31137c814',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@03b2128f5e4bcd3ff04fa64a92c1236b2379dd4e',
