vars = {
  ...
  'pdfium_revision':
    '4fa0e27ba39f49ba92fb4c160ab836a6f1dd2893',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    'ab12c2715886e7f04c415028a7db49fb0b1e67f3',
  'swarming_revision':
    'e4c0e242eeec361886ed2b89591a505ebe24db43',
  'v8_revision':
    'd54bdca9cf5ac0e9ea81055695de0642def6e0db'
}
...
deps = {
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@4fa0e27ba39f49ba92fb4c160ab836a6f1dd2893',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@ab12c2715886e7f04c415028a7db49fb0b1e67f3',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@d54bdca9cf5ac0e9ea81055695de0642def6e0db'
}
