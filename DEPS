  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@292b5bf73016216e2bdd24d057abc4e702fb2e2f',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@286273',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2108@179192',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@a8f8da0500d9a9a561eb8847292c14d874a31092',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@bffe77cd01d3982fe6ba710396615824ae4559ea',
  'build':
    '/trunk/tools/build@286375',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@7e3305eebd7fb06d57e7f25b3bbf9c10d526f7d5',
