...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@0908c64a1d63a46b1f78b1b4a32febc20769a92b',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@8acddca10d927619f268576db8717cf405095a41',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@a87c3eb022ce7967bf319612761bea0b40d71518',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@4dececfea12f0b1fed5ceadcc34e9ffc609dda9c',
