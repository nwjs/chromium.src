...
#  
#  This DEPS file corresponds to Chromium 34.0.1776.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@f37e96e55cc87c785b4e43edaca4452e3bdc3841',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1776@164741',
