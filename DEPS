...
#  
#  This DEPS file corresponds to Chromium 31.0.1629.3
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@220375',
   },
   'mac': {
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@3249376077d27624c59b468726b88a4ac79c048a',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1629@157735',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12146',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12146',
   'src/third_party/leveldatabase/src':
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4699',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1629/src@223104',
   'src/third_party/hunspell':
   ...
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1211',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11190',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@222977',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@75',
   'src/third_party/libsrtp':
