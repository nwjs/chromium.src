...
#  
#  This DEPS file corresponds to Chromium 36.0.1921.11
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@be62b2e0f6d7d8fad41a280db7e88beb209e1a3f',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@9086a711deef9b1f85bf9290b7b9598be32458d5',
...
deps = {
   ...
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@157',
   'src':
      '/branches/1921/src@265368',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@994',
   'src/third_party/hunspell':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@261002',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@249148',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1292',
   'src/third_party/openmax_dl':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@14002',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12952',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12952',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@261036',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1880',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1921@170629',
   'src/third_party/icu':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@260583',
   'src/third_party/swig/Lib':
