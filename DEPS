...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@2732046a77b0cf30d7d5533781ebe618814412c6',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@743be194eda4c1f37c4a5f62f38ef88f09f30649',
