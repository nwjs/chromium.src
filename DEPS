...
#  
#  This DEPS file corresponds to Chromium 30.0.1565.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@90e2e064c1e3a95fead7c4c235ee68b2b02a6a1a',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1565@154183',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9979',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@211585',
...
include_rules =  ['+base', '+build', '+googleurl', '+ipc', '+library_loaders', '+testing', '+third_party/icu/public', '+url']