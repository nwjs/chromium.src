...
#  
#  This DEPS file corresponds to Chromium 36.0.1936.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@926038efc28089447a2f9292d7dc8cdc7eff7a36',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@0c8aac5305afaa93c897d06747e2cc225d2eb9ca',
      ...
      'src/third_party/lss':
      Var("linux-syscall-support") + '/trunk/lss@25',
   },
   'android': {
      'src/third_party/libaddressinput/src/testdata':
      None,
      ...
      Var("git.chromium.org") + '/android_tools.git@f1adc927bf3fb00bbff98bf1ec5885c96b80bd81',
...
deps = {
   ...
   'src/third_party/skia/include':
      Var("skia") + '/trunk/include@14102',
   'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@262509',
   'src/third_party/libc++abi/trunk':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@263252',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1936@171355',
   'src/breakpad/src':
