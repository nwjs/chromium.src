...
#  
#  This DEPS file corresponds to Chromium 27.0.1450.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@59a0a2b487eebaa5cd53ecab222b8554b3d35c79',
      'src/third_party/lss':
...
deps = {
   ...
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@189888',
   'src':
      '/branches/1450/src@189999',
   'src/third_party/libyuv':
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@189897',
   'src/breakpad/src':
