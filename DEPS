...
#  
#  This DEPS file corresponds to Chromium 35.0.1884.1
#  
#  
#  
vars = {
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@256131',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1884@168925',
   'src/third_party/icu':
