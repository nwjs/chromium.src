...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@2c6b8297448273b8af2db319142a9583c89f07f5',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292129',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@b5fae93d72c7b6480f83fd8a7b534cd1fdfcd49a',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@291035ed1d8ec308ffbc81e9cd119e2f53f92f86',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@1aa681ea3b0f5cde94edc8c707848ca05e88a538',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@47740f2c26aea1b3b7830abdcba063a12a61d009',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@ed8ea3dad8b6b27b118081ead680d251d22ab24d',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@06b2696801712948b665372a38f96b1f10be6997',
