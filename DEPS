...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@5a0a75b2558058e9588a8cdf524ef4d2adf4b926',
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@d53a82706ebd227bc0e4dd535118cdd8298131bd',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@41dfaf088013a1206a0afb576dfbd6c6b9c929e1',
  'src/breakpad/src':
