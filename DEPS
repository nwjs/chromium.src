...
#  
#  This DEPS file corresponds to Chromium 33.0.1731.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@235242',
   },
   'mac': {
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@adf1233840c68bf03dfd55693b4580929d586445',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/ots':
      Var("ots") + '/trunk@107',
   'src/third_party/libaddressinput/src/testdata':
      Var("libaddressinput") + '/trunk/testdata@167',
   'src/third_party/mesa/src':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@239057',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1731@163301',
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12488',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12488',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@77',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1806',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@5122',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1731/src@239121',
   ...
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1240',
   'src/media/cdm/ppapi/api':
   ...
   'src/third_party/libaddressinput/src/cpp':
      Var("libaddressinput") + '/trunk/cpp@167',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@5122',
   'src/third_party/libjpeg_turbo':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12494',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@239081',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
