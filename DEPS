...
#  
#  This DEPS file corresponds to Chromium 35.0.1861.1
#  
#  
#  
vars = {
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@253347',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1861@167930',
   'src/third_party/icu':
