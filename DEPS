...
#  
#  This DEPS file corresponds to Chromium 35.0.1913.0
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@259440',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@2065c159d8253dbf9d454e49a48277bfb25ba71e',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@170112',
   'src/third_party/webrtc':
