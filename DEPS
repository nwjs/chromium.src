...
#  
#  This DEPS file corresponds to Chromium 31.0.1622.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@1762',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@4447b75d58d0491ca39c4d0a0da423519e73f6a8',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@221051',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1622@157269',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12098',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12098',
   'src/third_party/leveldatabase/src':
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@219802',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11067',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@520',
   'build':
      '/trunk/tools/build@221293',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@74',
   'src/third_party/libsrtp':
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@41159326ab429bb88262f80118e79bb5a108f0db',
   'src/tools/grit':
