...
deps = {
  ...
  'depot_tools':
    '/trunk/tools/depot_tools@294894',
  'src/breakpad/src':
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@0b569328ca1be9e82c2127642d7a708ce31b2542',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@d13444acf2d6cdc13f9916309cfd3cfa314b6725',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@48a8a7443322ba5288ebc6dd12040bbfaa850506'
}
