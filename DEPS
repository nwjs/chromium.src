...
#  
#  This DEPS file corresponds to Chromium 7.0.537.0
#  
#  
#  
deps_os = {
   ...
   'unix': {
      ...
      'src/third_party/cros':
         'http://src.chromium.org/git/cros.git@81677aa2',
...
deps = {
   ...
   'src/third_party/ppapi':
      'http://ppapi.googlecode.com/svn/trunk@264',
