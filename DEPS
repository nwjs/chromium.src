...
#  
#  This DEPS file corresponds to Chromium 32.0.1657.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@6a5cb2e7957499466582abd4de7f09eff9ccc7f5',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1657@158585',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11515',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@226075',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
