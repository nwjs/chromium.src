...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@4c47796d861a581a5322a06a566b4e79b10d0f04',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@73bd7f4d2e1a67fe3d024318bb43429a05597f50',
  'src/breakpad/src':
