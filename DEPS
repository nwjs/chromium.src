vars = {
  'angle_revision':
    'e73a1e847bbb984ae7c93bceee56b000fd1067f2',
  'boringssl_revision':
    '63fa118f3a3d065adb6ca17227bb9e407ffadccb',
  'buildspec_platforms':
    'all',
  'buildtools_revision':
    'ef7f1f539cff0441c4401d8c052e54cfd01bff07',
  'chromium_git':
  ...
  'nacl_revision':
    '71fa851c91658c498758494b790ddba548aae7be',
  'nss_revision':
    'aab0d08a298b29407397fbb1c4219f99e99431ed',
  'openmax_dl_revision':
    '37b900ccc45cfab71faf4fd332df15369766b94c',
  'pdfium_revision':
    '9ddafc82bddb984ae46ee0df801ba20b446d5158',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    'c752badbe3e4af84ca4c2b1d10adabbe4096e204',
  'swarming_revision':
    'b64f0423ee66e730b0ceb88de8b9b89a98d7b61a',
  'v8_revision':
    '80b2548442609a90887af4806623bcf805e1d5bc'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@ef7f1f539cff0441c4401d8c052e54cfd01bff07',
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@71fa851c91658c498758494b790ddba548aae7be',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@e73a1e847bbb984ae7c93bceee56b000fd1067f2',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@63fa118f3a3d065adb6ca17227bb9e407ffadccb',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@710beadeea593bcd416c1ca07042069b818f57a0',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@7c372af1ff87f1f3dfca2b4292c7c538a03b06e8',
  ...
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@e6a54f223a01bca6489139c211b2905e1deaaacf',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@9ddafc82bddb984ae46ee0df801ba20b446d5158',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@c752badbe3e4af84ca4c2b1d10adabbe4096e204',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@1183eb64e60bd7f40f63ac946f24df4f11091b73',
  'src/third_party/yasm/source/patched-yasm':
    (Var("chromium_git")) + '/chromium/deps/yasm/patched-yasm.git@4671120cd8558ce62ee8672ebf3eb6f5216f909b',
  'src/tools/deps2git':
    (Var("chromium_git")) + '/chromium/tools/deps2git.git@f04828eb0b5acd3e7ad983c024870f17f17b06d9',
  'src/tools/grit':
    (Var("chromium_git")) + '/external/grit-i18n.git@4066463928d64337e6d70046aa4f18b833a2d0e3',
  'src/tools/gyp':
    (Var("chromium_git")) + '/external/gyp.git@01528c7244837168a1c80f06ff60fa5a9793c824',
  'src/tools/page_cycler/acid3':
    (Var("chromium_git")) + '/chromium/deps/acid3.git@6be0a66a1ebd7ebc5abc1b2f405a945f6d871521',
  'src/tools/swarming_client':
    (Var("chromium_git")) + '/external/swarming.client.git@b64f0423ee66e730b0ceb88de8b9b89a98d7b61a',
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@80b2548442609a90887af4806623bcf805e1d5bc'
}
