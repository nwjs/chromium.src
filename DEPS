vars = {
  ...
  'boringssl_revision':
    'ad38dc7452b6bdaf226965b88080736495ac263c',
  'buildspec_platforms':
    'win-asan,',
  'buildtools_revision':
    '4a95614772d9bcbd8bc197e1d9bd034e088fc740',
  'chromium_git':
  ...
  'pdfium_revision':
    '211cab5b58151f09fbeafe2b18da77b63664c39d',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    'fbd87d611a16d6e1397226d1c8418c810c76b598',
  'swarming_revision':
    '8fce79620b04bbe5415ace1103db27505bdc4c06',
  'v8_revision':
    '0a4246b40ef3c36b6980507ba0381cfef697100c'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@4a95614772d9bcbd8bc197e1d9bd034e088fc740',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@ad38dc7452b6bdaf226965b88080736495ac263c',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@53ddd9ffa0a29872a62b8288a4adefb7ec3f590d',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@38c50da122a671f174cb4f1f41ec7ed4c9af048c',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@211cab5b58151f09fbeafe2b18da77b63664c39d',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@fbd87d611a16d6e1397226d1c8418c810c76b598',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@ca8da3c95807a2fffb3eb3acde59ff095e89516f',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@0a4246b40ef3c36b6980507ba0381cfef697100c'
}
