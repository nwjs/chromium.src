...
#  
#  This DEPS file corresponds to Chromium 34.0.1847.104
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("native_client") + '/trunk/deps/third_party/gnu_binutils@12760',
      'src/third_party/psyco_win32':
      '/trunk/deps/third_party/psyco_win32@237949',
      'src/third_party/mingw-w64/mingw/bin':
      Var("native_client") + '/trunk/deps/third_party/mingw-w64/mingw/bin@12760',
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@2021',
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@246067',
   },
   'mac': {
      'src/third_party/google_toolbox_for_mac/src':
      Var("google-toolbox-for-mac") + '/trunk@626',
   ...
   'ios': {
      ...
      None,
      'src/third_party/google_toolbox_for_mac/src':
      Var("google-toolbox-for-mac") + '/trunk@636',
      'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      None,
      'src/third_party/smhasher/src':
      None,
      'src/third_party/WebKit/public':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1847/public@170105',
      'src/native_client':
      None,
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@1ee2901d33ae698d1f2a1d95e9f3fd5bbd5f13f9',
      'build/third_party/xvfb':
      '/trunk/tools/third_party/xvfb@125214',
      'src/third_party/mtpd/source':
      Var("git.chromium.org") + '/chromiumos/platform/mtpd.git@e4e4656e9aa710f0617dab8746ab6116c0506ceb',
      'src/third_party/undoview':
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@874a39664f1538b1855391f98bf14026a5dd2c24',
      'src/third_party/pyelftools':
      Var("git.chromium.org") + '/chromiumos/third_party/pyelftools.git@bdc1d380acd88d4bfaf47265008091483b0d614e',
      'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@250522',
      'src/third_party/cros_dbus_cplusplus/source':
      Var("git.chromium.org") + '/chromiumos/third_party/dbus-cplusplus.git@e4120532bbf3ca9f743b0be1f539381a54d16867',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@e5c5daa1a1d6ffb637f9fd3fbeb68d4ce4aa4a65',
      'src/third_party/lss':
      Var("linux-syscall-support") + '/trunk/lss@24',
   },
   'android': {
      'src/third_party/libaddressinput/src/testdata':
      None,
      ...
      Var("git.chromium.org") + '/android_tools.git@0582bdc17b4829beb522975441546a4eb99b11b5',
...
deps = {
   ...
   'src/third_party/brotli/src':
      Var("git.chromium.org") + '/external/font-compression-reference.git@dfc5a9f2151a7c88914c236c7db8fa119fee249c',
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@321',
   'src/chrome/test/data/perf/third_party/octane':
      Var("octane-benchmark") + '/trunk@19',
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@13441',
   'src/third_party/scons-2.0.1':
      Var("native_client") + '/trunk/src/third_party/scons-2.0.1@12760',
   'src/third_party/webdriver/pylib':
      Var("selenium") + '/trunk/py@18337',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src':
      '/branches/1847/src@260206',
   'src/third_party/libyuv':
      Var("libyuv") + '/branches/m34@988',
   'src/third_party/hunspell':
   ...
   'src/third_party/WebKit/LayoutTests/w3c/csswg-test':
      Var("git.chromium.org") + '/external/w3c/csswg-test.git@8c415e3215a203fa3a22dbdd1799279fdf44c81e',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.50/webrtc@5730',
   'src/tools/deps2git':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@251888',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@249148',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1271',
   'src/third_party/openmax_dl':
      Var("webrtc") + '/deps/third_party/openmax@5205',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/third_party/clang_format/script':
      'http://src.chromium.org/llvm-project/cfe/trunk/tools/clang-format@198831',
   'src/third_party/WebKit/LayoutTests/w3c/web-platform-tests':
      Var("git.chromium.org") + '/external/w3c/web-platform-tests.git@ac4322a338be82b3d8b722917d6d3d057c0a3f6a',
   'build/scripts/gsd_generate_index':
      '/trunk/tools/gsd_generate_index@164784',
   'src/third_party/webgl/src':
      Var("git.chromium.org") + '/external/khronosgroup/webgl.git@159f31dd34842c871032d97d360a9dce5153f585',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13441',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12773',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@151',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@540',
   'build/scripts/tools/deps2git':
      '/trunk/tools/deps2git@251089',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12773',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@251924',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1854',
   'src/chrome/test/data/perf/canvas_bench':
      '/trunk/deps/canvas_bench@122605',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@254527',
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/trunk/talk@5562',
   'src/third_party/usrsctp/usrsctplib':
      Var("sctp-refimpl") + '/trunk/KERN/usrsctp/usrsctplib@8723',
   'src/third_party/libexif/sources':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1847@170105',
   'src/third_party/icu':
   ...
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@151',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@5b47578a4c25b1447172c78bcfce8c1fc7a69839',
   'src/chrome/browser/resources/pdf/html_office':
      Var("git.chromium.org") + '/chromium/html-office-public.git@6451249cec79299a52083373c9a370ef25471023',
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@b6c94e1bb81a3edf885b6831bbd9056693e50828',
   'src/v8':
      Var("v8") + '/branches/3.24@20269',
   'src/third_party/libwebm/source':
      Var("git.chromium.org") + '/webm/libwebm.git@0f7815b036651e242ec8c2fcfb59fe54f69be1a8',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@251850',
   'src/third_party/swig/Lib':
...
hooks =  [{'action': ['python', 'src/build/download_nacl_toolchains.py', '--no-arm-trusted', '--keep'], 'pattern': '.', 'name': 'nacltools'}, {'action': ['python', 'src/build/linux/install-arm-sysroot.py', '--linux-only'], 'pattern': '.', 'name': 'sysroot'}, {'action': ['python', 'src/chrome/installer/linux/sysroot_scripts/install-debian.wheezy.sysroot.py', '--linux-only', '--arch=amd64'], 'pattern': '.', 'name': 'sysroot'}, {'action': ['python', 'src/chrome/installer/linux/sysroot_scripts/install-debian.wheezy.sysroot.py', '--linux-only', '--arch=i386'], 'pattern': '.', 'name': 'sysroot'}, {'action': ['python', 'src/tools/clang/scripts/update.py', '--mac-only'], 'pattern': '.', 'name': 'clang'}, {'action': ['python', 'src/build/util/lastchange.py', '-o', 'src/build/util/LASTCHANGE'], 'pattern': '.', 'name': 'lastchange'}, {'action': ['python', 'src/build/util/lastchange.py', '-s', 'src/third_party/WebKit', '-o', 'src/build/util/LASTCHANGE.blink'], 'pattern': '.', 'name': 'lastchange'}, {'action': ['download_from_google_storage', '--no_resume', '--platform=win32', '--no_auth', '--bucket', 'chromium-gn', '-s', 'src/tools/gn/bin/win/gn.exe.sha1'], 'pattern': 'src/tools/gn/bin/win/gn.exe.sha1', 'name': 'gn_win'}, {'action': ['download_from_google_storage', '--no_resume', '--platform=darwin', '--no_auth', '--bucket', 'chromium-gn', '-s', 'src/tools/gn/bin/mac/gn.sha1'], 'pattern': 'src/tools/gn/bin/mac/gn.sha1', 'name': 'gn_mac'}, {'action': ['download_from_google_storage', '--no_resume', '--platform=linux*', '--no_auth', '--bucket', 'chromium-gn', '-s', 'src/tools/gn/bin/linux/gn.sha1'], 'pattern': 'src/tools/gn/bin/linux/gn.sha1', 'name': 'gn_linux'}, {'action': ['download_from_google_storage', '--no_resume', '--platform=linux*', '--no_auth', '--bucket', 'chromium-gn', '-s', 'src/tools/gn/bin/linux/gn32.sha1'], 'pattern': 'src/tools/gn/bin/linux/gn32.sha1', 'name': 'gn_linux32'}, {'action': ['download_from_google_storage', '--no_resume', '--platform=win32', '--no_auth', '--bucket', 'chromium-clang-format', '-s', 'src/third_party/clang_format/bin/win/clang-format.exe.sha1'], 'pattern': 'src/third_party/clang_format/bin/win/clang-format.exe.sha1', 'name': 'clang_format_win'}, {'action': ['download_from_google_storage', '--no_resume', '--platform=darwin', '--no_auth', '--bucket', 'chromium-clang-format', '-s', 'src/third_party/clang_format/bin/mac/clang-format.sha1'], 'pattern': 'src/third_party/clang_format/bin/mac/clang-format.sha1', 'name': 'clang_format_mac'}, {'action': ['download_from_google_storage', '--no_resume', '--platform=linux*', '--no_auth', '--bucket', 'chromium-clang-format', '-s', 'src/third_party/clang_format/bin/linux/clang-format.sha1'], 'pattern': 'src/third_party/clang_format/bin/linux/clang-format.sha1', 'name': 'clang_format_linux'}, {'action': ['download_from_google_storage', '--no_resume', '--platform=linux*', '--no_auth', '--bucket', 'chromium-eu-strip', '-s', 'src/build/linux/bin/eu-strip.sha1'], 'pattern': 'src/build/linux/bin/eu-strip.sha1', 'name': 'eu-strip'}, {'action': ['python', 'src/build/gyp_chromium'], 'pattern': '.', 'name': 'gyp'}] 
