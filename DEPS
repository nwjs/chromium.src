  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@c540745f311550446bb2b751776c735f984fa3f3',
      'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@284272',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@6256a14279e46f1e893a32bf5102d698fe111cfa',
