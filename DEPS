...
#  
#  This DEPS file corresponds to Chromium 16.0.886.1
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'chromeos':
      '/trunk/src/tools/cros.DEPS@101727',
   ...
   'src/third_party/webrtc':
      'http://webrtc.googlecode.com/svn/trunk/src@565',
   ...
   'src/third_party/angle':
      'http://angleproject.googlecode.com/svn/trunk@751',
