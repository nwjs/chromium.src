...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@fbdb6924b754634fbdf583850f32d7d26d03de23',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@7c5fbca2ecd95a4f8c13cd996cffd00cf32496cb',
