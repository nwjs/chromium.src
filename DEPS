...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2111@179432',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@490d49c5dcc4b2242c9b25f082b23ec5e842c4e7',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@22bb031c436c352498a05cd0881575908467a742',
