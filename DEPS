...
#  
#  This DEPS file corresponds to Chromium 15.0.858.0
#  
#  
#  
deps_os = {
...
deps = {
   'src/native_client':
      'http://src.chromium.org/native_client/trunk/src/native_client@6490',
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      'http://src.chromium.org/native_client/trunk/src/native_client/tests/prebuilt@6490',
   ...
   'chromeos':
      '/trunk/src/tools/cros.DEPS@97576',
