...
#  
#  This DEPS file corresponds to Chromium 35.0.1864.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@75081c92379e048b3ffd6f1a14f6f9b2d6ec41d9',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@253929',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1864@168078',
   'src/third_party/icu':
