  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@a41c200f5c040319f4960eb5850e70164152ee98',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@280921',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2079@177351',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@4a2489f7bbaccfe588597193561526d579004653',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@4fd75c1c991e86ed1d1c1e43ef0220c5491605b1',
