...
#  
#  This DEPS file corresponds to Chromium 31.0.1640.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@4cd01f48698570bb2df3cd031f4265cbdc279991',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1640@158160',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4794',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1640/src@224664',
   'src/third_party/hunspell':
   ...
   'src/v8':
      Var("v8") + '/trunk@16822',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@223974',
   'src/third_party/sfntly/cpp/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11409',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@224609',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
