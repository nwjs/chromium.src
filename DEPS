  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@638e3f2cdabfa3867357e71b474c4461e1f94543',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@273675',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2022@175139',
