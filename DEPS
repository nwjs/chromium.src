...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291840',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@a1ae66d252edf6da932caed1fe43d11216e56c0e',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@86ce4af33b763b24cf2365d8cd19a2ebade676c3',
  'src/breakpad/src':
