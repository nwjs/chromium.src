...
#  
#  This DEPS file corresponds to Chromium 15.0.874.117
#  
#  
#  
deps_os = {
   ...
   'mac': {
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/branches/chromium/874/WebKitLibraries@98743',
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      'src/third_party/WebKit/Tools/gdb':
         'http://svn.webkit.org/repository/webkit/branches/chromium/874/Tools/gdb@98743',
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/fast/workers@98743',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/http/tests/xmlhttprequest@98743',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/platform/chromium-cg-mac/storage/domstorage@98743',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/platform/chromium/fast/workers@98743',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/fast/js/resources@98743',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/http/tests/resources@98743',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/filesystem':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/http/tests/filesystem@98743',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/fast/events@98743',
   'src/third_party/bidichecker':
      'http://bidichecker.googlecode.com/svn/trunk/lib@4',
   'src/third_party/ots':
      'http://ots.googlecode.com/svn/trunk@69',
   'src/third_party/WebKit/Source':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/Source@98743',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/http/tests/workers@98743',
   'src/testing/gmock':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/fast/filesystem/workers@98743',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/platform/chromium-win/storage/domstorage@98743',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@19546',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/fast/filesystem/resources@98743',
   'src/build/util/support':
      '/trunk/deps/support@20411',
   'src/third_party/libjingle/source':
      'http://libjingle.googlecode.com/svn/trunk@77',
   'src':
      '/branches/874/src@108040',
   'src/third_party/WebKit/Tools/DumpRenderTree':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/Tools/DumpRenderTree@98743',
   'src/third_party/hunspell':
      '/trunk/deps/third_party/hunspell@96723',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/appcache':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/http/tests/appcache@98743',
   'src/testing/gtest':
      'http://googletest.googlecode.com/svn/trunk@560',
   'src/v8':
      'http://v8.googlecode.com/svn/branches/3.5@9797',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/platform/chromium-win/fast/events@98743',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/fast/events':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/platform/chromium-cg-mac/fast/events@98743',
   ...
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests@98743',
   'src/third_party/snappy/src':
      'http://snappy.googlecode.com/svn/trunk@37',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/http/tests/websocket/tests@98743',
   'src/third_party/webrtc':
      'http://webrtc.googlecode.com/svn/trunk/src@521',
   'src/chrome/test/data/layout_tests/LayoutTests/media':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/media@98743',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/platform/chromium-win/fast/workers@98743',
   'src/third_party/WebKit/Tools/Scripts':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/Tools/Scripts@98743',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/storage/domstorage@98743',
   'src/third_party/icu':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/platform/chromium-cg-mac/http/tests/workers@98743',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/874/LayoutTests/platform/chromium-win/http/tests/workers@98743',
