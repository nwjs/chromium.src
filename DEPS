...
#  
#  This DEPS file corresponds to Chromium 16.0.912.6
#  
#  
#  
deps_os = {
   ...
   'mac': {
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/branches/chromium/912/WebKitLibraries@98019',
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      'src/third_party/WebKit/Tools/gdb':
         'http://svn.webkit.org/repository/webkit/branches/chromium/912/Tools/gdb@98019',
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/fast/workers@98019',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/http/tests/xmlhttprequest@98019',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/platform/chromium-cg-mac/storage/domstorage@98019',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/platform/chromium/fast/workers@98019',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/fast/js/resources@98019',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/http/tests/resources@98019',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/filesystem':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/http/tests/filesystem@98019',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/fast/events@98019',
   'src/third_party/bidichecker':
      'http://bidichecker.googlecode.com/svn/trunk/lib@4',
   'src/third_party/ots':
      'http://ots.googlecode.com/svn/trunk@74',
   'src/third_party/WebKit/Source':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/Source@98019',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/http/tests/workers@98019',
   'src/testing/gmock':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/fast/filesystem/workers@98019',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/platform/chromium-win/storage/domstorage@98019',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@102714',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/fast/filesystem/resources@98019',
   'src/build/util/support':
      '/trunk/deps/support@20411',
   'src/third_party/libjingle/source':
      'http://libjingle.googlecode.com/svn/trunk@88',
   'src':
      '/branches/912/src@106674',
   'src/third_party/WebKit/Tools/DumpRenderTree':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/Tools/DumpRenderTree@98019',
   'src/third_party/hunspell':
      '/trunk/deps/third_party/hunspell@96723',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/appcache':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/http/tests/appcache@98019',
   'src/testing/gtest':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/platform/chromium-win/fast/events@98019',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/fast/events':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/platform/chromium-cg-mac/fast/events@98019',
   ...
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests@98019',
   'src/third_party/snappy/src':
      'http://snappy.googlecode.com/svn/trunk@37',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/http/tests/websocket/tests@98019',
   'src/third_party/webrtc':
      'http://webrtc.googlecode.com/svn/trunk/src@711',
   'src/chrome/test/data/layout_tests/LayoutTests/media':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/media@98019',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/platform/chromium-win/fast/workers@98019',
   'src/third_party/WebKit/Tools/Scripts':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/Tools/Scripts@98019',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/storage/domstorage@98019',
   'src/third_party/icu':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/platform/chromium-cg-mac/http/tests/workers@98019',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/LayoutTests/platform/chromium-win/http/tests/workers@98019',
   'src/third_party/WebKit/Tools/TestWebKitAPI':
      'http://svn.webkit.org/repository/webkit/branches/chromium/912/Tools/TestWebKitAPI@98019',
