vars = {
  'angle_revision':
    '69bbc98eaa5dd5f9524370387980ce7f60f7fbe7',
  'boringssl_revision':
    'afe57cb14d36f70ad4a109fc5e7765d1adc67035',
  'buildspec_platforms':
    'win-asan,',
  'buildtools_revision':
    '81863fe70639e85606b541d9d36e9e98c96b957e',
  'chromium_git':
  ...
  'pdfium_revision':
    '03f5040cbe03cc93e133cb98ecce6725e2679170',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '3c1468188924ede1e6589cddee84031c16782226',
  'swarming_revision':
    '9cdd76171e517a430a72dcd7d66ade67e109aa00',
  'v8_revision':
    '5041f1758be959baaf2526f1ceb794fb7ac48ef5'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@81863fe70639e85606b541d9d36e9e98c96b957e',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@69bbc98eaa5dd5f9524370387980ce7f60f7fbe7',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@afe57cb14d36f70ad4a109fc5e7765d1adc67035',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@948e4e5deb29fe52ff22528379602f89e88c5931',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@03f5040cbe03cc93e133cb98ecce6725e2679170',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@3c1468188924ede1e6589cddee84031c16782226',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@5041f1758be959baaf2526f1ceb794fb7ac48ef5'
}
