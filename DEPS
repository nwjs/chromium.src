...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@3d3a90271898ddf3e8d6935a7ca34290f2806098',
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@528f97ff1487d1826913c39f00f8d387044b9f2f',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@c698ea2a7781c493a8e09d0e89415a4aab8e1f62',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@9e3dac822315394238e650282a43fb4aacdbc6c9',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@2b04aaec44c0e3f2c1c069b5e2938134694af578',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@5500cc86654d79fa4c4dbf0870a504cc73a45324',
