...
#  
#  This DEPS file corresponds to Chromium 33.0.1738.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@9e4236b126c00630b26409dce7e4c1858f9b5745',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@240680',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1738@163905',
   ...
   'src':
      '/branches/1738/src@240964',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@aab3a62beb7e1d7a6785dcaee707479691fd6ddf',
   'src/third_party/hunspell':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12652',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@240835',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
