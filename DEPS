...
#  
#  This DEPS file corresponds to Chromium 33.0.1712.4
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@234862',
   },
   'mac': {
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      '/trunk/deps/third_party/openssl@233017',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@8f85d94d20052d093bfe1c39d79e0dc1263a0610',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@b3b75e0951a2fcb8380d5f74144ec34a654ce6b2',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@235548',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1712@162174',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12299',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@235591',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
