...
#  
#  This DEPS file corresponds to Chromium 31.0.1627.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@0b74414918c00e0071422c298135a426578aec53',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1627@157577',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11144',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@222445',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@75',
   'src/third_party/libsrtp':
