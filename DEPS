vars = {
  'angle_revision':
    'f9ac8fea307532e31cba6240801b4a56483591f8',
  'boringssl_revision':
    '209b2562235f7dab66b8260624e7b3c5b00d14a6',
  'buildspec_platforms':
    'all',
  'buildtools_revision':
    '125d157607de4d7c95bf8b02dd580aae17962f19',
  'chromium_git':
  ...
  'pdfium_revision':
    '1ccb793f6bcf14c03cb817d0465584c81e1841f8',
  'sfntly_revision':
    '1bdaae8fc788a5ac8936d68bf24f37d977a13dac',
  'skia_revision':
    'cef14bf9ce626e6e6582f3aac18c8e176b987f3e',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    '961a65b5ccac651fbdd7db9270e3b1d1968984f4',
  'webkit_revision':
    'caf7792a3a0aa915a41f1dccf180940b03a567b7'
}
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@caf7792a3a0aa915a41f1dccf180940b03a567b7',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@f9ac8fea307532e31cba6240801b4a56483591f8',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@1ccb793f6bcf14c03cb817d0465584c81e1841f8',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@cef14bf9ce626e6e6582f3aac18c8e176b987f3e',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@961a65b5ccac651fbdd7db9270e3b1d1968984f4'
}
