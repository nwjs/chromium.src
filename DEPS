vars = {
  'angle_revision':
    '457f1d929e5fd911e0ad9ea53db43010dfae0662',
  'boringssl_revision':
  ...
  'pdfium_revision':
    '1407c979a3ba8599546468d461f5403f317bddd3',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '5d16fea9e22221be5fbe2866bbcfe8d6f4c6aeac',
  'swarming_revision':
    '9cdd76171e517a430a72dcd7d66ade67e109aa00',
  'v8_revision':
    '8311bed8649e1195de0ddeba71f876143c9a7f95'
}
...
deps = {
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@457f1d929e5fd911e0ad9ea53db43010dfae0662',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@afd565ff9cb4fe1d20f4aa2ee7339c86998aafae',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@506457cbd726324f327b80ae11f46c1dfeb8710d',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@b7037034bc843dd1e7ff8a3b40439f8ead2dd823',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@1407c979a3ba8599546468d461f5403f317bddd3',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@5d16fea9e22221be5fbe2866bbcfe8d6f4c6aeac',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@71ae2ea48a6b6c42eb79bfd70acf888056b6a711',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@8311bed8649e1195de0ddeba71f876143c9a7f95'
}
