...
#  
#  This DEPS file corresponds to Chromium 34.0.1813.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@4da4b299311f3e012b00910c461a295264477ef0',
      'src/third_party/lss':
...
deps = {
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@247767',
   'src/chrome/test/data/perf/third_party/octane':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@166035',
   'src/third_party/webrtc':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@247723',
   'src/third_party/bidichecker':
