...
#  
#  This DEPS file corresponds to Chromium 28.0.1489.4
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@801fa9dbb145e6233e0ae376edbf7062d19fa807',
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/Tools/gdb@149089',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@84e953ccee7e88a60ee9481aa7c1b7a6119a49de',
      'src/third_party/lss':
...
deps = {
   ...
   'src/tools/swarm_client':
      '/trunk/tools/swarm_client@196145',
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/storage/indexeddb@149089',
   'src/sandbox/linux/seccomp-legacy':
      Var("seccompsandbox") + '/trunk@189',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/http/tests/appcache@149089',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@308',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/platform/chromium-win/http/tests/workers@149089',
   ...
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@196145',
   'src':
      '/branches/1489/src@196505',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@678',
   'src/third_party/hunspell':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/http/tests/workers@149089',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/fast/workers@149089',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/media@149089',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/webkit/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@181763',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/storage/domstorage@149089',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@63',
   'src/content/test/data/layout_tests/LayoutTests/editing/pasteboard/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/editing/pasteboard/resources@149089',
   'src/tools/deps2git':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@196263',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit/Source':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/Source@149089',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/http/tests/resources@149089',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/platform/chromium-win/fast/workers@149089',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@8832',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11222',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@148',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@3853',
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/fast/filesystem@149089',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11222',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@72',
   'build':
      '/trunk/tools/build@196268',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1611',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/platform/chromium-win/storage/domstorage@149089',
   'build/third_party/lighttpd':
      '/trunk/deps/third_party/lighttpd@58968',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/http/tests/xmlhttprequest@149089',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@189528',
   'src/third_party/WebKit/Tools/Scripts':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/Tools/Scripts@149089',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/platform/chromium-win/fast/events@149089',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/fast/files@149089',
   'src/sdch/open-vcdiff':
      Var("open-vcdiff") + '/trunk@42',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/fast/events@149089',
   'src/third_party/WebKit':
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/Tools/DumpRenderTree@149089',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@511',
   'src/third_party/trace-viewer':
      Var("trace-viewer") + '/trunk@255',
   'src/third_party/WebKit/LayoutTests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests@149089',
   'src/third_party/swig/Lib':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/http/tests/websocket/tests@149089',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1489/LayoutTests/fast/js/resources@149089',
}
