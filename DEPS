  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@32a421d51af29263655b60c6df6279c1b18bee97',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2048@176113',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@2526f0e5fd4e0d846c5109adf71ed879f9e76f00',
