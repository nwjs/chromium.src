...
#  
#  This DEPS file corresponds to Chromium 32.0.1658.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@0a621944ed7bdc0c8c0541da54c0309c25d3b2dc',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@226002',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1658@158681',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11542',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@226380',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
