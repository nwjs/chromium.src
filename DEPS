...
#  
#  This DEPS file corresponds to Chromium 34.0.1847.87
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1847/public@169816',
      'src/native_client':
      None,
...
deps = {
   ...
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src':
      '/branches/1847/src@258830',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@979',
   'src/third_party/hunspell':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1847@169816',
   'src/third_party/icu':
