...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@309dcfbb5a4be3e72d30021b768614b78b3db732',
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@9cc2f2613a4fa27de2c6c79830433867c72d8cd5',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@4a000741221aa8f6ba09c4b299f7cdb37a34bb58',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@051d23088a02e4da2a76b32c1d5750212448bb10',
