...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@df5453a6d48af53c80922fa67d581b25fa433afc',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@f7a169e225b6c5c7e79e14f6713256b4b8b9ab7f',
