...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@475baf83a5656717933fc8d05a2b81d7c1231093',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@d7724912743363db568715e5dc006201bd8ba567',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@1cbed27edf31a8501eaf1befca20eaf05b1031ac'
}
