...
#  
#  This DEPS file corresponds to Chromium 33.0.1708.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@50571833d583d30917730bb8ae6eb9a3b8690f7d',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1708@161872',
