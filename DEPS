  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@5a6a472ba91860a0cb0f3b994bd1982acfa64221',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@277040',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2049@176149',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@afeeda9391c1f3fc0c35c04fbc448480177059d8',
