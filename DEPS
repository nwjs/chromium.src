...
#  
#  This DEPS file corresponds to Chromium 37.0.2003.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@5123874504fa13e2adec9a7d080a8b2714108d29',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@174243',
   'src/third_party/webrtc':
   ...
   'src/third_party/pdfium':
      'https://pdfium.googlesource.com/pdfium.git@5110c4743751145c4ae1934cd1d83bc6c55bb43f',
   'depot_tools':
      '/trunk/tools/depot_tools@271112',
   'src/third_party/bidichecker':
   ...
   'src/third_party/openssl':
      '/trunk/deps/third_party/openssl@269063',
