...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@b11ea175bc25e3993228257a806a784b0bef90d4',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@7dcc609c3adb8077583b8b70dece697eeae5c574',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@ef23c3ab414ef1b3bdb56314819fdd89dbeba678'
}
