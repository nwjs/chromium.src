...
#  
#  This DEPS file corresponds to Chromium 33.0.1716.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@1899',
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@b8d86367208b98613c18aa4b164ef7c637cdbf85',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@8cec34fa7ba1f7ac6fe3379b45bb4088d3797ec0',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/ots':
      Var("ots") + '/trunk@107',
   'src/third_party/libaddressinput/src/testdata':
      Var("libaddressinput") + '/trunk/testdata@163',
   'src/third_party/mesa/src':
      '/trunk/deps/third_party/mesa@229994',
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@313',
   'src/chrome/test/data/perf/third_party/octane':
      Var("octane-benchmark") + '/trunk@19',
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@12323',
   'src/third_party/webdriver/pylib':
   ...
   'src/third_party/usrsctp/usrsctplib':
      Var("sctp-refimpl") + '/trunk/KERN/usrsctp/usrsctplib@8603',
   'src/tools/deps2git':
      '/trunk/tools/deps2git@234015',
   'depot_tools':
      '/trunk/tools/depot_tools@236437',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1716@162513',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12422',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12422',
   ...
   'src/v8':
      Var("v8") + '/trunk@17953',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@232686',
   'src/third_party/sfntly/cpp/src':
      Var("sfntly") + '/trunk/cpp/src@228',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1233',
   'src/media/cdm/ppapi/api':
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@a60e0805721f62c28a55faf2df74472cc5fc91fc',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/third_party/libaddressinput/src/cpp':
      Var("libaddressinput") + '/trunk/cpp@163',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@236367',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12323',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@236687',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@214783',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@234251',
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@a60e0805721f62c28a55faf2df74472cc5fc91fc',
   'src/third_party/swig/Lib':
