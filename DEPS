  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@fb16001993613d81184418189d9b04e8bf7904d6',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@281844',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2093@178124',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@bf0b9ced0b93d9684b044e0880691768f9aa4394',
  ...
  'src/third_party/libyuv':
    (Var("libyuv")) + '/trunk@1033',
  'src/third_party/libjingle/source/talk':
    (Var("webrtc")) + '/trunk/talk@6633',
