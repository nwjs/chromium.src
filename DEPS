...
#  
#  This DEPS file corresponds to Chromium 23.0.1256.1
#  
#  
#  
...
deps = {
   ...
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@5378',
   ...
   'src/third_party/skia/gyp':
      'http://skia.googlecode.com/svn/trunk/gyp@5378',
   'src/third_party/scons-2.0.1':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@154838',
   'src/third_party/bidichecker':
   ...
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@5378',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      'http://src.chromium.org/native_client/trunk/src/native_client/tests/prebuilt@9629',
   'src/third_party/smhasher/src':
      'http://smhasher.googlecode.com/svn/trunk@146',
   'src/third_party/webrtc':
      'http://webrtc.googlecode.com/svn/stable/src@2662',
   'src/native_client':
      'http://src.chromium.org/native_client/trunk/src/native_client@9629',
   'src/tools/page_cycler/acid3':
   ...
   'src/native_client_sdk/src/site_scons':
      'http://src.chromium.org/native_client/trunk/src/native_client/site_scons@9629',
   'src/third_party/libexif/sources':
