  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@16c5106779bfae35d1c326ebecf237ef5e3e6620',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@291867',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@87c4138fae37ba6b7e4de7acc3fce19524d726ea',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@68862751765ed1d204c074ef2e5b0ee855740a75',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@42ed2fc449e83fab2ccbf1b769a5e83715c9d783',
