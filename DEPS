...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      '/trunk/deps/third_party/nss@275286'
  },
  'mac': {
  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@90839443be6643594700792e9f9f53d6b622e8da',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2035@175736',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@b0b0feb71f0841497c041aa4aca2b10e032224e0',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13295',
  'src/third_party/leveldatabase/src':
    (Var("leveldb")) + '/trunk@80',
  'build':
    '/trunk/tools/build@275557',
