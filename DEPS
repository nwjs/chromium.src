...
#  
#  This DEPS file corresponds to Chromium 30.0.1599.25
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1599@156901',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m30_1599/src@11003',
   'src/third_party/webpagereplay':
