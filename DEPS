...
#  
#  This DEPS file corresponds to Chromium 34.0.1787.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@8202d475ffa3ca479b49590dada21d990472371c',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1787@165148',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@244897',
