...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@7d84b4f1359f60a24b1de3007b9d3c263a94164a',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@ea705161e275e706857c9d3ebab32044b266bfc7',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@56ae49747fb4ed9af66c3673df800abea2ecd48d'
}
