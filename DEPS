...
#  
#  This DEPS file corresponds to Chromium 35.0.1914.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@8dc26b8390ab35cfcf6d073ae877b9d660f7511d',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@170191',
   'src/third_party/webrtc':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@260049',
   'src/third_party/bidichecker':
