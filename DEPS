vars = {
  'angle_revision':
    'd561057f243629474299ee182e0bd86464d41e03',
  'boringssl_revision':
    'afd565ff9cb4fe1d20f4aa2ee7339c86998aafae',
  'buildspec_platforms':
    'win-asan,',
  'buildtools_revision':
    '68e3c238a5ab347436762cb929316aa55ca72563',
  'chromium_git':
  ...
  'nacl_revision':
    '1946a478cab0c564d050631adbd7956d89527081',
  'nss_revision':
    'a676aa04ff18b30983cac03dede5861b3db62c9d',
  'openmax_dl_revision':
    '7a179b97899cf33d4a12c7ef590176c519016f4d',
  'pdfium_revision':
    'ebc7695c60fc3e4afbfa6d9db162a71b190bf685',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '48373921917d9d9cfab71ece8f1ad3a84a5a6033',
  'swarming_revision':
    '9cdd76171e517a430a72dcd7d66ade67e109aa00',
  'v8_revision':
    '85106b6fe0060a4d28dfaa9898c0e736476da14c'
}
...
deps = {
  ...
  'src/buildtools':
    (Var("chromium_git")) + '/chromium/buildtools.git@68e3c238a5ab347436762cb929316aa55ca72563',
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@1946a478cab0c564d050631adbd7956d89527081',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@d561057f243629474299ee182e0bd86464d41e03',
  'src/third_party/bidichecker':
    (Var("chromium_git")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@afd565ff9cb4fe1d20f4aa2ee7339c86998aafae',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@97d95119247a42aa5590fcdf61a23554ad8899a4',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@f2f143fd6169378519543704aeda9621a7c6f6dc',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@ebc7695c60fc3e4afbfa6d9db162a71b190bf685',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@48373921917d9d9cfab71ece8f1ad3a84a5a6033',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@680196c92ae4a43e3d333358e610bb4ae8a33c82',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@85106b6fe0060a4d28dfaa9898c0e736476da14c'
}
