...
deps_os = {
  'win': {
    ...
    'src/third_party/nss':
      (Var("git.chromium.org")) + '/chromium/deps/nss.git@6814ecc6c409fe201a8eb2af816f037b4c5d4478'
  },
  'mac': {
  ...
  'unix': {
    ...
    'src/third_party/chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@147e93dd028bca61352fd82d59ca1fe267db187a',
    ...
    'src/third_party/cros_system_api':
      (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@de6277abbb3f88ee6c4be5bd83367772bd1c18e1',
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@4524eea83261c37badc10dd345244aa3ad4cf164',
    'src/third_party/lss':
  ...
  'android': {
    'src/third_party/android_webview_glue/src':
      (Var("git.chromium.org")) + '/external/android_webview_glue.git@4e0495ed16a0da2afa1d16bc34a71345172a258f',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293112',
  ...
  'build/third_party/google_api_python_client':
    (Var("git.chromium.org")) + '/external/github.com/google/google-api-python-client.git@49d45a6c3318b75e551c3022020f46c78655f365',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@535776eb28ce867cc173f982d8b652fb4361c0c4',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@5b827c923a90260bfd3fcd8601884b80c0c43a04',
  ...
  'build/third_party/uritemplate':
    (Var("git.chromium.org")) + '/external/github.com/uri-templates/uritemplate-py.git@1e780a49412cdbb273e9421974cb91845c124f3f',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@4b87bff882895fc945954ba07f5f80bdfc7b55e7',
  ...
  'src/third_party/leveldatabase/src':
    (Var("git.chromium.org")) + '/external/leveldb.git@803d69203a62faf50f1b77897310a3a1fcae712b',
  'build/third_party/oauth2client':
    (Var("git.chromium.org")) + '/external/github.com/google/oauth2client.git@3d3f986044f5a7870a2c272be235cb2b8b052d0b',
  'build':
    '/trunk/tools/build@293119',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@0a381c067483f37d7344b36110b31c9b14998ed1',
  'src/chrome/test/data/perf/canvas_bench':
    (Var("git.chromium.org")) + '/chromium/canvas_bench.git@a7b40ea5ae0239517d78845a5fc9b12976bfc732',
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@fed7b07985de8d293761040aa1edcdfd3c2579e4',
  'src/third_party/hunspell':
    (Var("git.chromium.org")) + '/chromium/deps/hunspell.git@c956c0e97af00ef789afb2f64d02c9a5a50e6eb1',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@6ea835db27479b9a5742e48b5e4466af7c2534ff',
  ...
  'src/third_party/libaddressinput/src':
    (Var("git.chromium.org")) + '/external/libaddressinput.git@678a7f55a2ae7ccf417b4809e602b808b56a8ddb',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@ef619d0562b39f30943cfdc4985a0df233d00e42',
  'src/third_party/libyuv':
    (Var("git.chromium.org")) + '/external/libyuv.git@d204db647e591ccf0e2589236ecea90330d65a66',
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@573741b804f39240f49ceb35d751b8a3ebd15359',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@0b1ceb837137901b6f5ae55be61c29d28b2c13a4',
  ...
  'build/third_party/httplib2':
    (Var("git.chromium.org")) + '/external/github.com/jcgregorio/httplib2.git@058a1f9448d5c27c23772796f83a596caf9188e6',
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@733baf82f626bf5d300e1db6e958f286826e9431',
  'src/third_party/icu':
  ...
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@3ea146d00576294887aed86e25c5a5f105216a35',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@5e3f6b4343bd4bfc4c16e0c746c4aab60f602d80',
  'src/tools/deps2git':
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@746d0ea79208b514e95e626310bec513fa666ca4',
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@d71ba015bc0af4af139a1032e070b058dd176b3f',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@429874c73d11608785ebcb5c2197461a9fc48306',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@69a01608f33ab6fe2c3485d94aef1fe9eacf5364',
