...
#  
#  This DEPS file corresponds to Chromium 31.0.1616.2
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1616@156954',
   'src/third_party/cld2':
      Var("cld2") + '/trunk@19',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11007',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@520',
   'build':
      '/trunk/tools/build@220468',
   'src/third_party/libsrtp':
