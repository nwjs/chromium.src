vars = {
  ...
  'boringssl_revision':
    '9f897b25800d2f54f5c442ef01a60721aeca6d87',
  'buildspec_platforms':
    'win-pgo,',
  'buildtools_revision':
  ...
  'pdfium_revision':
    '178086485892c9bb6aa0bf57ee449b33705e71c0',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    'd0e1f80d044013c988337c75c12b697b2b024f83',
  'swarming_revision':
    '9cdd76171e517a430a72dcd7d66ade67e109aa00',
  'v8_revision':
    'a034e083bfc590f6f80c3522459d03cd120052bb'
}
...
deps = {
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@9f897b25800d2f54f5c442ef01a60721aeca6d87',
  'src/third_party/catapult':
    (Var("chromium_git")) + '/external/github.com/catapult-project/catapult.git@5bc4bbee2423abee670b3a349d4cd3edcb148dee',
  ...
  'src/third_party/libyuv':
    (Var("chromium_git")) + '/libyuv/libyuv.git@1ccbf8fb7b1d84d37eabb26de933f841daf0ade7',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@178086485892c9bb6aa0bf57ee449b33705e71c0',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@d0e1f80d044013c988337c75c12b697b2b024f83',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@a034e083bfc590f6f80c3522459d03cd120052bb'
}
