...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@ea779ac44a5ef6974da1f11ec43fc581f73decf8',
    'src/third_party/lss':
  ...
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@aaeda3d69df4b4352e3cac7c16bea7f16bd1ec12',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293765',
  ...
  'src/third_party/openmax_dl':
    (Var("git.chromium.org")) + '/external/webrtc/deps/third_party/openmax.git@8f7bf0b9f9ac36a671ac4f76fb8c7d4eac700f6a',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@cada95ad9b8e6be9bdffe1a70968a2102cc3f09d',
  'src/tools/swarming_client':
    (Var("git.chromium.org")) + '/external/swarming.client.git@e98dde9a7c9a349125179448c957606987f845a3',
  ...
  'src/third_party/webgl/src':
    (Var("git.chromium.org")) + '/external/khronosgroup/webgl.git@ff796782c581a03c5f36e547b8218a23083c8534',
  'src/testing/gmock':
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@5bcc39334adc79f1d8d2d94b596bb558b2a402b3',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@945d334190e1b965d5d3ea50981aca41df64235d',
  ...
  'build':
    '/trunk/tools/build@293776',
  'src/tools/gyp':
    (Var("git.chromium.org")) + '/external/gyp.git@adb7d24b9fc166f01ab2da50478556b518a9218f',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@dd806c2b58aac61f010c7b1c6831f9541209f490',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/talk.git@bf56cdc4f274c76ba3afc6b9c7dad591704cb112',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@aa7b4ede03764a5701a477b601720a32c88d8e42',
  ...
  'src/third_party/trace-viewer':
    (Var("git.chromium.org")) + '/external/trace-viewer.git@3470cc939061a9238695747557adc41eb35ed267',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@3a43b481b78e54009e293c6c6172fc6c68990d8c',
  ...
  'src/third_party/icu':
    (Var("git.chromium.org")) + '/chromium/deps/icu.git@4e3266f32c62d30a3f9e2232a753c60129d1e670',
  ...
  'src/third_party/webpagereplay':
    (Var("git.chromium.org")) + '/external/web-page-replay.git@818d4271650f4f83d1635e94549e8457584dfac4',
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@f640bc4a10123be21214c21c77cecd8bab909284',
  'src/breakpad/src':
    (Var("git.chromium.org")) + '/external/google-breakpad/src.git@58aca2ddf2f7d873b8705886c8cce1b3f68c2bc9',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@51ea1f8d2304265bd9840aaf4234e052f4b5527b',
  'src/third_party/pywebsocket/src':
    (Var("git.chromium.org")) + '/external/pywebsocket/src.git@cb349e87ddb30ff8d1fa1a89be39cec901f4a29c',
  'src/third_party/libvpx':
    (Var("git.chromium.org")) + '/chromium/deps/libvpx.git@cc9c0c5198e416173f480fb1f11e052f5c29a95b',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@5fa3eba03d1912424decc885e72da20a6a08d8e7',
