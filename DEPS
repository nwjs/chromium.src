...
#  
#  This DEPS file corresponds to Chromium 30.0.1578.3
#  
#  
#  
vars = {
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@214023',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1578@155046',
