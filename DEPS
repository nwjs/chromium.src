...
#  
#  This DEPS file corresponds to Chromium 35.0.1874.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@096d48842a57dbb7c8043201576424f34eb5609c',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@5923ea47cf7ebfb29118407e7384c4dc6cd97b2e',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@255138',
   'src/third_party/bidichecker':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13662',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12810',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@151',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@544',
   'build/scripts/tools/deps2git':
      '/trunk/tools/deps2git@253688',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12810',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@255237',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1860',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1874@168563',
   'src/third_party/icu':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@254609',
   'src/third_party/swig/Lib':
