...
deps = {
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@9dad519abcba6a39915e5f27ac9145370fab3263',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@e70cc95b95d704f82061d1ca3e9ddafaaa407974'
}
