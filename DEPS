...
#  
#  This DEPS file corresponds to Chromium 37.0.1992.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@81820654cedcb55fb755410e1bf4bba6daab82f8',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@270205',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1992@174033',
   'src/breakpad/src':
