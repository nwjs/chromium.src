...
#  
#  This DEPS file corresponds to Chromium 34.0.1847.97
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1847/public@169933',
      'src/native_client':
      None,
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1847@169933',
   'src/third_party/icu':
