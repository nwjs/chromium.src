  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@8826fbfdc9ddef4673df9c1810adeb1da052f16b',
      'src/third_party/cros_system_api':
        (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@7837af4f429eb20ca62f32a8dc6019b5b8b9078e',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@274393',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2029@175431',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@1940df968da44ef95ddb332270aa23481552ca65',
  ...
  'src/third_party/libaddressinput/src/testdata':
    (Var("libaddressinput")) + '/trunk/testdata@258',
  'src/testing/gmock':
  ...
  'src/third_party/webrtc':
    (Var("webrtc")) + '/trunk/webrtc@6261',
  'build/scripts/tools/deps2git':
    '/trunk/tools/deps2git@271672',
  'src/third_party/hunspell_dictionaries':
    '/trunk/deps/third_party/hunspell_dictionaries@255132',
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13267',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13267',
  'src/third_party/leveldatabase/src':
    (Var("leveldb")) + '/trunk@80',
  'build':
    '/trunk/tools/build@274708',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@96481cb9163681998d1407b0c951a4c951be1b04',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@dbd4c06036f42d8dffe033ba112d6d7085dfe475',
  ...
  'src/third_party/libaddressinput/src/cpp':
    (Var("libaddressinput")) + '/trunk/cpp@258',
  'src/third_party/icu':
  ...
  'src/third_party/webpagereplay':
    (Var("git.chromium.org")) + '/external/web-page-replay.git@d1447899a2176bc8700865e76ed70da329628abd',
