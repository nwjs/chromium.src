...
#  
#  This DEPS file corresponds to Chromium 30.0.1590.3
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@96649402e2d2105a06af1162be4e2651bb48b292',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1590@155733',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10602',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@216358',
   'src/third_party/libsrtp':
