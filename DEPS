...
#  
#  This DEPS file corresponds to Chromium 36.0.1955.2
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@2126',
      'src/third_party/nss':
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@04e6762f22f966de851b464d71c9fc1cd99912bf',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@265799',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1955@172451',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1318',
   'src/third_party/openmax_dl':
