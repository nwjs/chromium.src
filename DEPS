...
#  
#  This DEPS file corresponds to Chromium 37.0.2000.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@5af1d26a8fed0718203ca1e789e0cf0128cd5e63',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/2000@174237',
   'src/breakpad/src':
