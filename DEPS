...
#  
#  This DEPS file corresponds to Chromium 29.0.1509.3
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@199075',
   },
   'mac': {
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@031ad0b3326d9cd4f27b27cf9aa31dad3ad7c7a4',
      'src/third_party/lss':
...
deps = {
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/storage/indexeddb@150528',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/http/tests/appcache@150528',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@316',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/platform/chromium-win/http/tests/workers@150528',
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/http/tests/workers@150528',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/fast/workers@150528',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/media@150528',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/webkit/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@181763',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/storage/domstorage@150528',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@74',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@3990',
   'src/tools/deps2git':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@200358',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@200068',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1178',
   'src/third_party/openmax_dl':
      Var("webrtc") + '/deps/third_party/openmax@3720',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/http/tests/resources@150528',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/platform/chromium-win/fast/workers@150528',
   'src/testing/gtest':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9130',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11338',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/content/test/data/layout_tests/LayoutTests/editing/pasteboard/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/editing/pasteboard/resources@150528',
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/fast/filesystem@150528',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11338',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@73',
   'build':
      '/trunk/tools/build@200404',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1626',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/platform/chromium-win/storage/domstorage@150528',
   'build/third_party/lighttpd':
      '/trunk/deps/third_party/lighttpd@58968',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/http/tests/xmlhttprequest@150528',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src/third_party/libphonenumber/src/test':
      Var("libphonenumber") + '/trunk/cpp/test@456',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/platform/chromium-win/fast/events@150528',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@198257',
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/fast/files@150528',
   'build/scripts/command_wrapper/bin':
      '/trunk/tools/command_wrapper/bin@135178',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/fast/events@150528',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@150434',
   'src/third_party/icu':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/http/tests/websocket/tests@150528',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1509/LayoutTests/fast/js/resources@150528',
}
