vars = {
  'angle_revision':
    'daa8c27f57c16cfc574ec6e4b32d56396f70c4bd',
  'boringssl_revision':
  ...
  'pdfium_revision':
    '8840ec9b5c54da9dc9aae3afb8585a2ff80758d9',
  'sfntly_revision':
    '130f832eddf98467e6578b548cb74ce17d04a26d',
  'skia_revision':
    '211df380655d3fd0c76b9b7f8be399040ca0b7a5',
  'swarming_revision':
    '05e17879accce360bee999cd9ec891d761056bc2',
  'v8_revision':
    '3c19105e9c418a135a205c37c2c51e443e76650f'
}
...
deps = {
  ...
  'src/native_client':
    (Var("chromium_git")) + '/native_client/src/native_client.git@b6ec17db8c2958f3455043e29000f17354336fb8',
  ...
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@daa8c27f57c16cfc574ec6e4b32d56396f70c4bd',
  ...
  'src/third_party/libjingle/source/talk':
    (Var("chromium_git")) + '/external/webrtc/trunk/talk.git@eddf34f4a9ddd5bdac8d85125a4ed04eff704638',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@8840ec9b5c54da9dc9aae3afb8585a2ff80758d9',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@211df380655d3fd0c76b9b7f8be399040ca0b7a5',
  ...
  'src/third_party/webrtc':
    (Var("chromium_git")) + '/external/webrtc/trunk/webrtc.git@dba3e4553cbe4aa286dda6074fdb004fb1eb652f',
  ...
  'src/tools/swarming_client':
    (Var("chromium_git")) + '/external/swarming.client.git@05e17879accce360bee999cd9ec891d761056bc2',
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@3c19105e9c418a135a205c37c2c51e443e76650f'
}
