...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@0bf824b06c16665b4846d70f4264af32b036a04f',
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@4b203c6222ebcd3f6e00629c8a047d68bb2ba913',
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@ded32942a1ebfddff0ba1231898fc4f6c7faacec',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@f54ececb7a94558258e07cf16198f672cac9d249',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@ca03c62e3a6f32098dbc97bdef36553c49730569',
