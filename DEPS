...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@56b25256f1f7b5102579731ce5b119b13dc29aaa',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293334',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@3054be16dfdb0d06233770cbfc338958edef44ea',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@a15c3024d298d651474ad5f92df75a516f365fb5',
  'src/breakpad/src':
