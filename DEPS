...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@7898a0f73edf5d55fce441885f6cb81ea981de19',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@c240e719b2bebd3711ade4e6fe056921aa7b0521',
