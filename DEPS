...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@8b4936f4f71fa1bdf861b2e23a44690f525d83fa',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@cb32524edb055a8262b015116dd06c09f1893066',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@71d2ce6b04113387360b4814b817ed046b14ebcf'
}
