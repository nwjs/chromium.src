...
#  
#  This DEPS file corresponds to Chromium 32.0.1687.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@da9244772d606558ae49ad95ff188745b33c771b',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@231888',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1687@161014',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12012',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@522',
   'build':
      '/trunk/tools/build@231956',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
