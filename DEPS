...
#  
#  This DEPS file corresponds to Chromium 31.0.1625.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@6f5a66422e0e7c0d10305b32c2c15618524f1830',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1625@157413',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12120',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12120',
   'src/third_party/leveldatabase/src':
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/stable/talk@4650',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1625/src@221970',
   'src/third_party/hunspell':
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@4650',
   'src/third_party/libjpeg_turbo':
      '/trunk/deps/third_party/libjpeg_turbo@177737',
   'src/third_party/pywebsocket/src':
      Var("pywebsocket") + '/trunk/src@662',
   'commit-queue':
      '/trunk/tools/commit-queue@221847',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11121',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@520',
   'build':
      '/trunk/tools/build@221842',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@75',
   'src/third_party/libsrtp':
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@0bd6d117785f689aaa367bca4dc761f561e5b666',
   'src/tools/grit':
