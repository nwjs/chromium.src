...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@f6c40d49e1bb27c0643f7e298fe359b8e78e92d1',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@288c6babb0b6ccdfc1eb4c5ea9a58cdf7b40b653',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@ff223e5a24342a6567c1e57ac58f8a2ec134f50f'
}
