...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@280971',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2080@177395',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@dc1cf66483e93c2d12d938bc1ce3b8c60cc68da5',
