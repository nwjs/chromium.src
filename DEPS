  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@e0505bdd4731e7924cc4ae90d363d0c6d0a71d04',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@280386',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2073@177123',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@0766931dc44a0d5da67b732d4a69967abcc235c9',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13398',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13398',
