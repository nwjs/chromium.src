...
#  
#  This DEPS file corresponds to Chromium 35.0.1880.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@5e6dd71a4c058915a5ecd7fa57710ef93f96e874',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1880@168799',
   'src/third_party/icu':
   ...
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@254786',
   'src/third_party/swig/Lib':
