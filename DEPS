...
#  
#  This DEPS file corresponds to Chromium 18.0.1025.36
#  
#  
#  
...
deps_os = {
   ...
   'unix': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/Tools/gdb@107711',
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/fast/workers@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/http/tests/xmlhttprequest@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/platform/chromium-win/fast/events@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/platform/chromium/fast/workers@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/fast/js/resources@107711',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/http/tests/resources@107711',
   'src/third_party/libyuv':
      'http://libyuv.googlecode.com/svn/trunk@159',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/filesystem':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/http/tests/filesystem@107711',
   ...
   'src/third_party/WebKit/Source':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/Source@107711',
   ...
   'src/third_party/WebKit/LayoutTests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests@107711',
   'src/third_party/WebKit':
      '/trunk/deps/third_party/WebKit@76115',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/http/tests/websocket/tests@107711',
   'src/third_party/webrtc':
      'http://webrtc.googlecode.com/svn/trunk/src@1538',
   'src/chrome/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/media@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/fast/events@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/storage/indexeddb@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/http/tests/workers@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/fast/filesystem/workers@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/platform/chromium-win/storage/domstorage@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/platform/chromium-win/fast/workers@107711',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/fast/filesystem/resources@107711',
   ...
   'src/third_party/WebKit/Tools/Scripts':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/Tools/Scripts@107711',
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/Tools/DumpRenderTree@107711',
   'src/seccompsandbox':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/platform/chromium-win/http/tests/workers@107711',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/http/tests/appcache@107711',
   'src/third_party/WebKit/Tools/TestWebKitAPI':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/Tools/TestWebKitAPI@107711',
   'src/third_party/angle':
      'http://angleproject.googlecode.com/svn/branches/chrome_m18@988',
   'src/v8':
      'http://v8.googlecode.com/svn/branches/3.8@10693',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@117975',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1025/LayoutTests/storage/domstorage@107711',
