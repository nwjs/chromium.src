...
#  
#  This DEPS file corresponds to Chromium 23.0.1271.84
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m23_1271/src@6180',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@9768',
   'src/tools/page_cycler/acid3':
