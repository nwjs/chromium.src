...
#  
#  This DEPS file corresponds to Chromium 34.0.1764.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@7feda35bcd784bb15eb474adcdd1c946d0cc4311',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1764@164367',
