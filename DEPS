...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@e125bfd201e2866c55ab29a2519a966143c9cb1f',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@288da5c7788134004a4b34a4ba0cb4814428cf7c'
}
