...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@72bed180c259c4069696a2388460d803dcf9e57c',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@790ffe3feb90370318f42b28eb9c6af6e38cd4f9',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@edbf8ac5c5381a9e0dcc32032eafb823f571d7df',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@a1f6307669c32a40076d299272d220343ff74bb9',
  'src/breakpad/src':
