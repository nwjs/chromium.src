...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@4eec977b9b11494c9337dd3ac2aa4dc08649ee4d',
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@792c80f5a7b66e75d42664ccb298f31962c6654c',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@9e7aa26b2489e45a6d73a4329656c500e6d5b0de',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@3dfd929ea07487f2295553df397720d8d75d227c',
