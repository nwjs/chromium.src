...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@d51d75088f75d4ca63991d304633c7d09415861f',
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@8059eb9f6e24ed609393fbda4ad71edea03ac258',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@a1fb9be5102612890229bc2c0a2d60ed2431f3d7',
  'src/breakpad/src':
