  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@abea80b1d3cbb0317a30422a489f1a439640fd4a',
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@17bfe0d670678b705a08532008a6145c1fb69a63',
  ...
  'build/scripts/tools/deps2git':
    '/trunk/tools/deps2git@292377',
  'src/third_party/hunspell_dictionaries':
    (Var("git.chromium.org")) + '/chromium/deps/hunspell_dictionaries.git@4560bdd463a3500e2334e85c8a0e9e5d5d6774e7',
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@9f5f997f61621a320bbd94a7b3c55e0453bb0ded',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@e0a2d1c5a8e55f26f1bff6b514733605f20b9f82',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@8a9b96a9acf15f7f24dc6241c4f6cd3dffda4616',
  'src/breakpad/src':
