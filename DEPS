...
#  
#  This DEPS file corresponds to Chromium 33.0.1727.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@8e489734ea440bb3db9b8c212584de3f35f4fcd3',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@238268',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1727@163056',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12430',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@238240',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
