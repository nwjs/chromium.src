vars = {
  'angle_revision':
    'bc4acb4ee5bbbc638c32a58494ebb572a105a23e',
  'boringssl_revision':
  ...
  'skia_revision':
    'ff0ca5ed825d9106edc2df6ab3865e1c17c326bf',
  'swarming_revision':
    'b39a448d8522392389b28f6997126a6ab04bfe87',
  'v8_revision':
    '70699cde1149c2efa9bad5a85f0910a477a3f911',
  'webkit_revision':
    'a0cd882972ed96ef751ce53e491551bc1be935e0'
}
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("chromium_git")) + '/chromium/blink.git@f220eacaf32b865955bf317b31ba5ca8e4e82d19',
  'src/third_party/angle':
    (Var("chromium_git")) + '/angle/angle.git@bc4acb4ee5bbbc638c32a58494ebb572a105a23e',
  ...
  'src/third_party/skia':
    (Var("chromium_git")) + '/skia.git@ff0ca5ed825d9106edc2df6ab3865e1c17c326bf',
  ...
  'src/v8':
    (Var("chromium_git")) + '/v8/v8.git@70699cde1149c2efa9bad5a85f0910a477a3f911'
}
