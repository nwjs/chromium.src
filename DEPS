...
#  
#  This DEPS file corresponds to Chromium 7.0.517.25
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/WebCore@68486',
   ...
   'src/v8':
      'http://v8.googlecode.com/svn/branches/2.3@5539',
   'src/breakpad/src':
   ...
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/LayoutTests@68486',
