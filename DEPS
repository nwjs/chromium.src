...
#  
#  This DEPS file corresponds to Chromium 34.0.1792.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@d1442630d5ea80e03a9565665cae94d85a1ccc1a',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1792@165363',
   'src/third_party/icu':
