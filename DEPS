...
deps = {
  ...
  'depot_tools':
    '/trunk/tools/depot_tools@295075',
  'src/breakpad/src':
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@538889441dad5b95a82488b25078caaad35109fe',
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@2e295e23e8f7c3a6a4dd12e8b9d9f3d51f799081',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@dbc3cefb0b624808ddb86d444e6103f216e12fa5',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@d5ebf1114df73b97834a184723048bb8f747fc29'
}
...
deps_os = {
  'android': {
    ...
    'src/third_party/android_tools':
      (Var("git.chromium.org")) + '/android_tools.git@ee8ce3d2993954640854bdb27b4015a85a55b049',
