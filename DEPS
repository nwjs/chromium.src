...
#  
#  This DEPS file corresponds to Chromium 31.0.1617.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@ade27ce41bb1814faf0a2ce6ffd2dc09471068db',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1617@157031',
   'src/third_party/cld2':
      Var("cld2") + '/trunk@19',
