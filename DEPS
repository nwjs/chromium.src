...
#  
#  This DEPS file corresponds to Chromium 35.0.1898.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@256695',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@f5a15cd055c066c026ec0f495c875bc9426eb24c',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@932ee5bf1af5178c3404e25ca1e40cfadfb9142a',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@257841',
   'src/third_party/bidichecker':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13850',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12889',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12889',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@257840',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1874',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1898@169512',
   'src/third_party/icu':
   ...
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@2808311e2ba2c19f268a58a2c0f81c967910d52f',
