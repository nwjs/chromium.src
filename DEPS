...
#  
#  This DEPS file corresponds to Chromium 4.1.249.1018
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKit/mac':
         '/branches/WebKit/249/WebKit/mac@39981',
      ...
      'src/third_party/WebKit/WebKitLibraries':
         '/branches/WebKit/249/WebKitLibraries@39981',
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      '/branches/WebKit/249/LayoutTests/http/tests/xmlhttprequest@39981',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/249/LayoutTests/http/tests/workers@39981',
   'src/tools/gyp':
   ...
   'src/third_party/WebKit/JavaScriptCore':
      '/branches/WebKit/249/JavaScriptCore@39981',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      '/branches/WebKit/249/LayoutTests/fast/js/resources@39981',
