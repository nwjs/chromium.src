...
#  
#  This DEPS file corresponds to Chromium 20.0.1093.0
#  
#  
#  
...
deps_os = {
   ...
   'unix': {
      ...
      'http://git.chromium.org/chromiumos/platform/system_api.git@33ccbba1',
   },
}
...
deps = {
   ...
   'chromeos':
      '/trunk/src/tools/cros.DEPS@131021',
   ...
   'src/tools/gyp':
      'http://gyp.googlecode.com/svn/trunk@1309',
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@130677',
