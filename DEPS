...
#  
#  This DEPS file corresponds to Chromium 36.0.1933.4
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@8f0ccfa9943b37c1efdee8da482dfe1b7d29a128',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@262832',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1933@171224',
   'src/breakpad/src':
