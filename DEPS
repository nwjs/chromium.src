...
#  
#  This DEPS file corresponds to Chromium 32.0.1667.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@53d5f855b22fc75e7d81d8577ce4bb06e80c2fab',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@227982',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1667@159417',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11688',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@228054',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
