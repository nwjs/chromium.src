...
#  
#  This DEPS file corresponds to Chromium 36.0.1932.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@4173941b2a30a9f984eddd2057bce481647625e0',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@262506',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1932@171101',
   'src/breakpad/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@14088',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13006',
   ...
   'build/scripts/tools/deps2git':
      '/trunk/tools/deps2git@261680',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13006',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@262588',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1880',
   'src/chrome/test/data/perf/canvas_bench':
