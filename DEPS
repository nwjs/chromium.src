...
#  
#  This DEPS file corresponds to Chromium 35.0.1887.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@185a40a27c15a6187328b00159f2b42047a66572',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@3446e7097fdb9e476ed2fa047320a26fbb9af776',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@256721',
   'src/third_party/bidichecker':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1887@169083',
   'src/third_party/icu':
