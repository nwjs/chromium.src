...
#  
#  This DEPS file corresponds to Chromium 5.0.396.0
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKit/mac':
         'http://svn.webkit.org/repository/webkit/trunk/WebKit/mac@58726',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@29937',
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@58726',
...
deps = {
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/storage/domstorage@58726',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/events@58726',
   'src/third_party/WebKit/WebKit/chromium':
      'http://svn.webkit.org/repository/webkit/trunk/WebKit/chromium@58726',
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@560',
   'src/third_party/ots':
      'http://ots.googlecode.com/svn/trunk@30',
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/trunk/WebCore@58726',
   'src/breakpad/src':
      'http://google-breakpad.googlecode.com/svn/trunk/src@568',
   'chromeos':
      '/trunk/cros_deps@46450',
   'src/third_party/WebKit':
      '/trunk/deps/third_party/WebKit@33467',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/workers@58726',
   'src/googleurl':
      'http://google-url.googlecode.com/svn/trunk@131',
   'src/chrome/test/data/layout_tests/LayoutTests/websocket/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/websocket/tests/workers@58726',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/xmlhttprequest@58726',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/fast/events@58726',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/http/tests/workers@58726',
   'src/tools/gyp':
      'http://gyp.googlecode.com/svn/trunk@818',
   'src/third_party/WebKit/WebKitTools/Scripts':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/Scripts@58726',
   'src/sdch/open-vcdiff':
      'http://open-vcdiff.googlecode.com/svn/trunk@28',
   'src/third_party/WebKit/JavaScriptCore':
      'http://svn.webkit.org/repository/webkit/trunk/JavaScriptCore@58726',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/js/resources@58726',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/http/tests/workers@58726',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/resources@58726',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/fast/workers@58726',
   'src/build/util/support':
      '/trunk/deps/support@46454',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/storage/domstorage@58726',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/storage/domstorage@58726',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      'http://svn.webkit.org/repository/webkit/trunk/WebKitTools/DumpRenderTree@58726',
   'src/testing/gtest':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/workers@58726',
   'src':
      '/trunk/src@46416',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu42@43139',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium/fast/workers@58726',
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests@58726',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-mac/fast/events@58726',
