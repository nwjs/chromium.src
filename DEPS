...
#  
#  This DEPS file corresponds to Chromium 34.0.1802.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@a82301108a837e531f9e3821c1f45017cd706ca5',
      'src/third_party/lss':
...
deps = {
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@246483',
   'src/breakpad/src':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1802@165647',
   'src/third_party/icu':
