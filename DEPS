...
#  
#  This DEPS file corresponds to Chromium 36.0.1981.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@73f10f16e050ee82e61a8248e3120c3fdbd9b1e6',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@268944',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1981@173598',
   'src/breakpad/src':
