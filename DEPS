...
#  
#  This DEPS file corresponds to Chromium 30.0.1558.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@1222289c4c98f133683918c4ec4fdd97545b7604',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@8862aea10c019cac029d6b48abf06ae1c61590ba',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@210223',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1558@153608',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11624',
   'src/third_party/smhasher/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9901',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@516',
   'build':
      '/trunk/tools/build@210228',
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@210194',
   'src/third_party/libsrtp':
      '/trunk/deps/third_party/libsrtp@189528',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@203786',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11624',
   'src/third_party/libphonenumber/src/test':
