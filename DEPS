...
#  
#  This DEPS file corresponds to Chromium 5.0.335.4
#  
#  
#  
deps_os = {
   'win': {
      ...
      'src/third_party/ffmpeg/binaries/chromium/win/ia32':
         '/trunk/deps/third_party/ffmpeg/binaries/win@38862',
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@55033',
      'src/third_party/WebKit/WebKit/mac':
         'http://svn.webkit.org/repository/webkit/trunk/WebKit/mac@55033',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@29937',
      'src/third_party/ffmpeg/source/patched-ffmpeg-mt':
         '/trunk/deps/third_party/ffmpeg/patched-ffmpeg-mt@38862',
...
deps = {
   ...
   'src/build/util/support':
      '/trunk/deps/support@40209',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/storage/domstorage@55033',
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@490',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/resources@55033',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/workers@55033',
   'src':
      '/branches/335/src@40199',
   'src/third_party/icu':
   ...
   'src/third_party/WebKit/LayoutTests':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests@55033',
}
