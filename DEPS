...
#  
#  This DEPS file corresponds to Chromium 34.0.1815.2
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      '/trunk/deps/third_party/lighttpd@248005',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@247914',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'commit-queue':
      '/trunk/tools/commit-queue@247963',
   'src/breakpad/src':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1815@166186',
   'src/third_party/icu':
   ...
   'src/third_party/angle':
      Var("git.chromium.org") + '/angle/angle.git@e1590b895ba9289e91271c901dd6ee46db1ed053',
   'src/v8':
      Var("v8") + '/trunk@18865',
