  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@93f3aad20f55f25d091b7d198cf569d1758dac8b',
    ...
    'android': {
      ...
      'src/third_party/android_tools':
        (Var("git.chromium.org")) + '/android_tools.git@fbd4205a1da1939ba1dc470b33cb5b3b1acf235d',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@280451',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2074@177163',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@479fbaf3bd65346c8dba2363aadde3b57bddd195',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13407',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13407',
