...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@e6cb48382db869f8e194b83aec80fd495be76db7',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@5d9e52cd4bbcac190a35bb9a7df95408bc3ffae5',
  'src/breakpad/src':
