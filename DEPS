...
deps_os = {
  'win': {
    ...
    'src/third_party/syzygy/binaries':
      (Var("sawbuck")) + '/trunk/syzygy/binaries@2154',
    'src/third_party/bison':
      '/trunk/deps/third_party/bison@147303',
    'src/third_party/nss':
      '/trunk/deps/third_party/nss@271760'
  },
  'mac': {
  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@f756df6b2364a96b09e6711bcd4eb6df18c9d79c',
      'src/third_party/cros_system_api':
        (Var("git.chromium.org")) + '/chromiumos/platform/system_api.git@2e8df283540037cba6243de9e53b7c18842cd8ce',
      'src/third_party/pyelftools':
        (Var("git.chromium.org")) + '/chromiumos/third_party/pyelftools.git@bdc1d380acd88d4bfaf47265008091483b0d614e',
      'src/third_party/chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@ff441bf434f22888b09cd65daa86d9aa2982f650',
    ...
    'android': {
      ...
      'src/third_party/android_tools':
        (Var("git.chromium.org")) + '/android_tools.git@ac519ee39778f7a1f2aac797a941a6b3db9d3882',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@275244',
  ...
  'src/third_party/libwebm/source':
    (Var("git.chromium.org")) + '/webm/libwebm.git@acf788bedd1ddc0f4a8553c28a8b4e2266accbc9',
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2034@175671',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@4962140c9e6623b29417a2fb9ad903641fb0159c',
  ...
  'src/third_party/libaddressinput/src/testdata':
    (Var("libaddressinput")) + '/trunk/testdata@265',
  'src/testing/gmock':
    (Var("googlemock")) + '/trunk@410',
  'src/tools/grit':
    (Var("grit-i18n")) + '/trunk@168',
  'src/third_party/mesa/src':
    '/trunk/deps/third_party/mesa@265279',
  'src/third_party/smhasher/src':
    (Var("smhasher")) + '/trunk@152',
  'src/third_party/webrtc':
    (Var("webrtc")) + '/trunk/webrtc@6333',
  'build/scripts/tools/deps2git':
    '/trunk/tools/deps2git@274952',
  'src/third_party/hunspell_dictionaries':
    '/trunk/deps/third_party/hunspell_dictionaries@255132',
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13281',
  'src/third_party/brotli/src':
    (Var("git.chromium.org")) + '/external/font-compression-reference.git@c75ed764ef2a74bf3ab645ca7a73c0c692477755',
  'src/tools/page_cycler/acid3':
    '/trunk/deps/page_cycler/acid3@171600',
  'src/third_party/cacheinvalidation/src':
    (Var("google-cache-invalidation-api")) + '/trunk/src@331',
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13281',
  'src/third_party/leveldatabase/src':
    (Var("leveldb")) + '/trunk@80',
  'build':
    '/trunk/tools/build@275403',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@d7e7d735ec75a6b0ff855447b20691c7fbb6c97e',
  'build/third_party/lighttpd':
    '/trunk/deps/third_party/lighttpd@58968',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@5d89977ce55240995d1596fe420b818468f5ec37',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@d68f9a3e646555e292a1f184560149e8a3e629ac',
  'src/third_party/libphonenumber/src/phonenumbers':
    (Var("libphonenumber")) + '/trunk/cpp/src/phonenumbers@621',
  'src/third_party/openssl':
    '/trunk/deps/third_party/openssl@271781',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@9caa384561d53a85b4d86bf6ab7426c1362914cf',
  ...
  'src/third_party/libaddressinput/src/cpp':
    (Var("libaddressinput")) + '/trunk/cpp@265',
  'src/third_party/icu':
  ...
  'src/third_party/snappy/src':
    (Var("snappy")) + '/trunk@80',
  'src/breakpad/src':
    (Var("google-breakpad")) + '/trunk/src@1331',
