...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@fe653a5d6cabf2563749aebc456f3f49227fb91c',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293525',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@6b0f701687edcdfc4fc996aed085054912866aff',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@a90ad3a6563e6cfd8ee7caf9d5e5cfba037e2ada',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@799ad2fac3f6fc13094d3ea9d729c461bd26b769',
