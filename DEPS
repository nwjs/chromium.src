...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@c79b7252d4eb190934519749495db95a1d208f92',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@293914',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@fef4c32bdf02f1bf3cde722cd48c4ac4cd137ab6',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@7c13b1d2cb6133e2edcf21df769e708c350b5fb0',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@b3a788e5e37955620b26be5b6e3048d37b605e00',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@1c7bc5b56323fa5a54c3eda7a0e9c057e0747fd4',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@224d14897d9b7df09e08a94e4cbc13feb339346d',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@be629e0e920ae32cca691f5e45410ff00db1a849',
