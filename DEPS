...
#  
#  This DEPS file corresponds to Chromium 7.0.517.33
#  
#  
#  
deps_os = {
...
deps = {
   ...
   'src/third_party/WebKit/WebCore':
      'http://svn.webkit.org/repository/webkit/branches/chromium/517/WebCore@69032',
