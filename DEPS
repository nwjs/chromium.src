...
#  
#  This DEPS file corresponds to Chromium 32.0.1666.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@1aae34bdc6d96a72a4d8a24cc8da0a3efaa3e3cd',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@227778',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1666@159286',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@227843',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11659',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@227829',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
