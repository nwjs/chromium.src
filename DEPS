...
#  
#  This DEPS file corresponds to Chromium 34.0.1785.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      Var("native_client") + '/trunk/deps/third_party/gnu_binutils@12526',
      'src/third_party/psyco_win32':
      '/trunk/deps/third_party/psyco_win32@237949',
      'src/third_party/mingw-w64/mingw/bin':
      Var("native_client") + '/trunk/deps/third_party/mingw-w64/mingw/bin@12526',
      ...
      Var("sawbuck") + '/trunk/syzygy/binaries@1909',
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@244274',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/external/fontconfig.git@4f944971dac3c0bbc6fdd3bf3123e3c8378a3acb',
      'src/third_party/cros_system_api':
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@cfa23a554dcb262bfac10f9f5ac624d26c8c4e38',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@ae8dfce3f88b2a7662f2178c2fba3c8a5df383dc',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@244717',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1785@165080',
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12586',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@151',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12586',
   ...
   'src/third_party/libjingle/source/talk':
      Var("webrtc") + '/trunk/talk@5300',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src':
      '/branches/1785/src@244753',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@3ae9e6e79206d6b0d530ab98ce941c9dc9a19d5b',
   'src/third_party/hunspell':
   ...
   'src/third_party/scons-2.0.1':
      Var("native_client") + '/trunk/src/third_party/scons-2.0.1@12526',
