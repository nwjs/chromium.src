...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2112@179452',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@c6f57840475cb17aa1cf2f50c181d3235b924056',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13562',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13562',
