...
#  
#  This DEPS file corresponds to Chromium 27.0.1453.15
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'ios': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/Source/Platform/chromium/public@147366',
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/Source/WebKit/chromium/public@147366',
      'src/third_party/WebKit/LayoutTests':
      None,
   ...
   'unix': {
      ...
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/Tools/gdb@147366',
...
deps = {
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/platform/chromium/fast/files@147366',
   'src/third_party/ots':
      Var("ots") + '/trunk@97',
   'src/third_party/sfntly/cpp/src':
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/storage/indexeddb@147366',
   'src/sandbox/linux/seccomp-legacy':
      Var("seccompsandbox") + '/trunk@189',
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@292',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/http/tests/appcache@147366',
   'commit-queue':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/platform/chromium/fast/events@147366',
   'src/third_party/webdriver/pylib':
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/Tools/DumpRenderTree@147366',
   'src/third_party/libphonenumber/src/phonenumbers':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/http/tests/workers@147366',
   'src/third_party/WebKit/LayoutTests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests@147366',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/fast/workers@147366',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/media@147366',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/fast/js/resources@147366',
   'src/webkit/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@181763',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/storage/domstorage@147366',
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@115',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@63',
   'src/content/test/data/layout_tests/LayoutTests/editing/pasteboard/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/editing/pasteboard/resources@147366',
   'src/tools/deps2git':
      '/trunk/tools/deps2git@181098',
   'src/third_party/libjpeg_turbo':
      '/trunk/deps/third_party/libjpeg_turbo@177737',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/platform/chromium-win/storage/domstorage@147366',
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/platform/chromium-win/http/tests/workers@147366',
   'src/breakpad/src':
      Var("google-breakpad") + '/trunk/src@1104',
   'src/third_party/WebKit/Source':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/Source@147366',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/http/tests/resources@147366',
   'src/third_party/WebKit':
      '/trunk/deps/third_party/WebKit@76115',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/platform/chromium-win/fast/workers@147366',
   ...
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@3704',
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/fast/filesystem@147366',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/http/tests/websocket/tests@147366',
   'src/third_party/angle':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/http/tests/xmlhttprequest@147366',
   ...
   'src/third_party/WebKit/Tools/Scripts':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/Tools/Scripts@147366',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/platform/chromium-win/fast/events@147366',
   'src/third_party/yasm/source/patched-yasm':
      '/trunk/deps/third_party/yasm/patched-yasm@167605',
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/fast/files@147366',
   'src/third_party/libjingle/source':
      Var("libjingle") + '/trunk@299',
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/fast/events@147366',
   'src':
      '/branches/1453_12/src@191758',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu46@182486',
   'src/third_party/pymox/src':
      Var("pymox") + '/trunk@70',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/LayoutTests/platform/chromium/fast/workers@147366',
   'src/third_party/webpagereplay':
   ...
   'src/third_party/WebKit/Tools/TestWebKitAPI':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1453/Tools/TestWebKitAPI@147366',
   'src/testing/gtest':
      Var("googletest") + '/trunk@629',
   'src/v8':
      Var("v8") + '/branches/3.17@14097',
   'src/third_party/libvpx':
