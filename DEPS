...
#  
#  This DEPS file corresponds to Chromium 36.0.1966.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@a5fcc9844e4d0b56c05d09f4b7b691fd6bf13f9a',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1966@172895',
   'src/breakpad/src':
