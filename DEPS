...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@dc6ff5b5d1195328b77af9edee9a2c32b8341a1f',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@86217d831d70949f9dde6a60f821d3f357558bdf',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@3e1901b437c3be54e5bd8666917b11f71a63358f',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@fb0f6c03710de36d4f11b8164a76c8a66008f5d9',
