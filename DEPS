...
#  
#  This DEPS file corresponds to Chromium 36.0.1959.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@265958',
   },
   'mac': {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@9becf57803ca14cb3da34ada21f9afee6a632da7',
      'src/third_party/lss':
   ...
   'android': {
      ...
      Var("git.chromium.org") + '/android_tools.git@50d57f149a184d1c7306957c8c488666466f2c8a',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@266151',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1959@172638',
   'src/breakpad/src':
