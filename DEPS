...
#  
#  This DEPS file corresponds to Chromium 32.0.1656.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@d810e51da2145145247d52e7284afdf82dac74ac',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@225756',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1656@158512',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@11494',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@521',
   'build':
      '/trunk/tools/build@225865',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
