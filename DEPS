...
#  
#  This DEPS file corresponds to Chromium 29.0.1547.49
#  
#  
#  
vars = {
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1547@155641',
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@74',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.34/webrtc@4477',
   'src/third_party/libjpeg_turbo':
