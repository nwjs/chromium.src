...
#  
#  This DEPS file corresponds to Chromium 33.0.1735.2
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@e67a489bdcde04fc5a6274bc7b531fb6652cb0d3',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@f8ec912fd89831ac4962cdd1a582062f707a961e',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/brotli/src':
      Var("git.chromium.org") + '/external/font-compression-reference.git@79e99afe468407e9ff9f0820df7190cb069eabeb',
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@314',
   'src/chrome/test/data/perf/third_party/octane':
      Var("octane-benchmark") + '/trunk@19',
   'src/third_party/skia/gyp':
      Var("skia") + '/trunk/gyp@12589',
   'src/third_party/webdriver/pylib':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1735@163669',
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@239056',
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12589',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@528',
   'build':
      '/trunk/tools/build@239958',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
