...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@21773fe7e3497a358cc86bd7f87aabce52c8c37e',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@294021',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@9e33d1dbccee9b13ac001dfc3094a503f9e84e9d',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@8387fef24018c05a6b14d3788bce5e065681c5d5',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@0c61a738d2a8bef13c8fbe08c6df0b27238960ab',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@de83f57e1f3aff829e60c90a269d3efbeac62a6d',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@c8c8160c04a8558c69b37e037f8ba4dfba28989e',
