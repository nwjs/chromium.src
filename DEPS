...
#  
#  This DEPS file corresponds to Chromium 35.0.1862.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@a8f96fa14f2e0e6f8b66ee9f9e604861c726c3a2',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1862@167977',
   'src/third_party/icu':
