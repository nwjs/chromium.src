...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@f8cc4162b253485839c9777c037fca8ffeabe2f2',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@b0a290c40d88d13f32ea0e2370c62d2316ca8638',
