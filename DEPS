...
#  
#  This DEPS file corresponds to Chromium 29.0.1533.1
#  
#  
#  
vars = {
...
deps_os = {
   'win': {
      ...
      'src/third_party/nss':
      '/trunk/deps/third_party/nss@204056',
   },
   'mac': {
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@333668eabe4f842913a4a4fe8d620c932a7a06b6',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/cacheinvalidation/src':
      Var("google-cache-invalidation-api") + '/trunk/src@307',
   ...
   'src/content/test/data/layout_tests/LayoutTests/storage/indexeddb':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/storage/indexeddb@152081',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/appcache':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/http/tests/appcache@152081',
   'src/webkit/renderer/media/crypto/ppapi/cdm':
      '/trunk/deps/cdm@181763',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/platform/chromium-win/http/tests/workers@152081',
   ...
   'src':
      '/branches/1533/src@205099',
   'src/third_party/libyuv':
      Var("libyuv") + '/trunk@717',
   'src/third_party/hunspell':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/http/tests/workers@152081',
   'src/content/test/data/layout_tests/LayoutTests/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/fast/workers@152081',
   'build/third_party/gsutil':
      Var("gsutil") + '/trunk/src@263',
   'src/content/test/data/layout_tests/LayoutTests/media':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/media@152081',
   'src/third_party/pyftpdlib/src':
      Var("pyftpdlib") + '/trunk@977',
   'src/content/test/data/layout_tests/LayoutTests/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/storage/domstorage@152081',
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@74',
   'src/third_party/webrtc':
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@204978',
   'src/third_party/bidichecker':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/http/tests/resources@152081',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/platform/chromium-win/fast/workers@152081',
   'src/testing/gtest':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9450',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11501',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/content/test/data/layout_tests/LayoutTests/editing/pasteboard/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/editing/pasteboard/resources@152081',
   'src/content/test/data/layout_tests/LayoutTests/fast/filesystem':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/fast/filesystem@152081',
   'src/native_client':
   ...
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/platform/chromium-win/storage/domstorage@152081',
   'build/third_party/lighttpd':
      '/trunk/deps/third_party/lighttpd@58968',
   'src/content/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/http/tests/xmlhttprequest@152081',
   'src/third_party/jsoncpp/source/include':
      Var("jsoncpp") + '/trunk/jsoncpp/include@248',
   'src/third_party/libphonenumber/src/test':
      Var("libphonenumber") + '/trunk/cpp/test@456',
   'src/content/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/platform/chromium-win/fast/events@152081',
   'src/third_party/yasm/source/patched-yasm':
   ...
   'src/content/test/data/layout_tests/LayoutTests/fast/files':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/fast/files@152081',
   ...
   'src/content/test/data/layout_tests/LayoutTests/fast/events':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/fast/events@152081',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533@152081',
   'src/third_party/icu':
   ...
   'src/content/test/data/layout_tests/LayoutTests/http/tests/websocket/tests':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/http/tests/websocket/tests@152081',
   'src/content/test/data/layout_tests/LayoutTests/fast/js/resources':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1533/LayoutTests/fast/js/resources@152081',
}
