...
deps_os = {
  ...
  'ios': {
    ...
    'src/third_party/WebKit/public':
      (Var("blink")) + '/branches/chromium/1985/public@179211',
...
deps = {
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@b071b0f098e6efb9066252e751dfddf4f35f06e2',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/1985@179211',
  'src/third_party/icu':
