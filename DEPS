...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@3c29c4d36174750a13fc0db1be5584fc47737898',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@cd4f3d0ec85e1e624599fb75559a4e81635c01d1',
  'src/breakpad/src':
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/external/v8.git@22cf3f9d4c636215aa2e2a8169573d795142c328',
