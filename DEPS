...
#  
#  This DEPS file corresponds to Chromium 24.0.1290.0
#  
#  
#  
...
deps = {
   ...
   'src/third_party/skia/include':
      'http://skia.googlecode.com/svn/trunk/include@5850',
   ...
   'src/third_party/skia/gyp':
      'http://skia.googlecode.com/svn/trunk/gyp@5850',
   'src/third_party/scons-2.0.1':
   ...
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@5850',
   'src/tools/grit':
   ...
   'src/v8':
      'http://v8.googlecode.com/svn/trunk@12669',
   'src/third_party/libvpx':
