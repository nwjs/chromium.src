...
#  
#  This DEPS file corresponds to Chromium 5.0.342.7
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKitLibraries':
         '/branches/WebKit/342/WebKitLibraries@41521',
      'src/third_party/WebKit/WebKit/mac':
         '/branches/WebKit/342/WebKit/mac@41521',
...
deps = {
   ...
   'src/v8':
      'http://v8.googlecode.com/svn/trunk@4073',
   'src/third_party/WebKit/LayoutTests':
      '/branches/WebKit/342/LayoutTests@41521',
}
