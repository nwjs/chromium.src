  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@43ad52887cc1e891c760e0491d987a2f887c6ce4',
      ...
      'src/third_party/chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@b310410e13e34af7d3f3f15be98688b016f2222f',
    ...
    'android': {
      ...
      'src/third_party/android_tools':
        (Var("git.chromium.org")) + '/android_tools.git@6fc0e1a090e97805a70f0e65377a9db4db3db8f5',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@272450',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13226',
  'src/third_party/leveldatabase/src':
    (Var("leveldb")) + '/trunk@80',
  'build':
    '/trunk/tools/build@272651',
  ...
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@28bcf4ffeb49322fa019e2778c1fdd20f61d9ea6',
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@7dd6164f6fe06017970107aba531e60fcc433282',
  'src/third_party/skia/gyp':
    (Var("skia")) + '/trunk/gyp@14862',
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@8349035e86305fc9e4fd871610821336120a4bad',
  'src/third_party/scons-2.0.1':
    (Var("native_client")) + '/trunk/src/third_party/scons-2.0.1@13077',
  'src/third_party/webdriver/pylib':
    (Var("selenium")) + '/trunk/py@18337',
  'src/third_party/usrsctp/usrsctplib':
    (Var("sctp-refimpl")) + '/trunk/KERN/usrsctp/usrsctplib@8844',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@3ce25e68aa8f6d4b880ce4e0e9f123d117fcbd0c',
  'src/third_party/libphonenumber/src/phonenumbers':
    (Var("libphonenumber")) + '/trunk/cpp/src/phonenumbers@621',
  'src/third_party/openssl':
    '/trunk/deps/third_party/openssl@271781',
  'src/third_party/trace-viewer':
    (Var("trace-viewer")) + '/trunk@1275',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2012@174749',
  'src/third_party/icu':
