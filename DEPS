...
#  
#  This DEPS file corresponds to Chromium 31.0.1607.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@56ad592a5f3b0472edb822d6ed5b92b09239eafe',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1607@156436',
   'src/third_party/cld2':
      Var("cld2") + '/trunk@19',
   ...
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12029',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12029',
   'src/third_party/leveldatabase/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10787',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@519',
   'build':
      '/trunk/tools/build@218590',
   'src/third_party/libsrtp':
