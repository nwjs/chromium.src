  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@88b8d78c5da4a385ee42ca699ba400a5306ef111',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2014@174812',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@7693dbf46e9bf0159cc9032059738d418469a7ad',
  ...
  'src/third_party/ffmpeg':
    (Var("git.chromium.org")) + '/chromium/third_party/ffmpeg.git@90d4238be2656ee9d6b8f0cdfa5f96d40e6ed7ad',
