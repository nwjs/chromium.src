...
#  
#  This DEPS file corresponds to Chromium 29.0.1547.34
#  
#  
#  
vars = {
...
deps = {
   'src/third_party/skia/include':
      Var("skia") + '/branches/chrome/m29_1547/include@9950',
   ...
   'src/third_party/skia/gyp':
      Var("skia") + '/branches/chrome/m29_1547/gyp@9950',
   'src/third_party/webdriver/pylib':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1547@154930',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/branches/chrome/m29_1547/src@9950',
   'src/third_party/webpagereplay':
