  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@e5956be4cc5048f92a68ecf71993b9c0e94d3349',
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@279560',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2069@176932',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@474cef4c55818bcf6ef1f7227417833ec82c5a36',
  ...
  'src/third_party/webrtc':
    (Var("webrtc")) + '/trunk/webrtc@6496',
  'build/scripts/tools/deps2git':
    '/trunk/tools/deps2git@279149',
  ...
  'src/buildtools':
    (Var("git.chromium.org")) + '/chromium/buildtools.git@1b99ceb70085a368f560ad13500a5ea3c4c93c0d',
  ...
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@278986',
