...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@f0ef6ceec1f5ab876e828248275f210107a78af7',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@d423b2b863c9484281c547d573ae2a6f362a5277',
  'src/breakpad/src':
