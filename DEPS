...
#  
#  This DEPS file corresponds to Chromium 35.0.1858.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@c2bde514f2077e44e647f51527c271125244b0f3',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@253007',
   'src/third_party/bidichecker':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@13562',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@12794',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@12794',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@79',
   'build':
      '/trunk/tools/build@253063',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1857',
   'src/chrome/test/data/perf/canvas_bench':
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1858@167720',
   'src/third_party/icu':
   ...
   'src/tools/grit':
      Var("grit-i18n") + '/trunk@152',
   'src/tools/swarming_client':
      Var("git.chromium.org") + '/external/swarming.client.git@4196cfcee5becb6003174661b6af40cb5b1af126',
