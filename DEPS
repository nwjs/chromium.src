...
#  
#  This DEPS file corresponds to Chromium 37.0.1996.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@852550b82d6580eb5866fc637ea6aa4aeec67eb5',
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@f7749f0d61a097002510ae6271ff75fa6525d628',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@270972',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1996@174174',
   'src/breakpad/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@14755',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@13167',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@13167',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@80',
   'build':
      '/trunk/tools/build@270920',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1919',
   'src/chrome/test/data/perf/canvas_bench':
      '/trunk/deps/canvas_bench@122605',
   'src/third_party/ffmpeg':
      '/trunk/deps/third_party/ffmpeg@270146',
