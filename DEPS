...
#  
#  This DEPS file corresponds to Chromium 30.0.1583.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@c73662a7d5ab892b15f54634823ed7348f7825a4',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1583@155299',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11883',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@149',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11883',
   'src/third_party/leveldatabase/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@10447',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@518',
   'build':
      '/trunk/tools/build@214884',
   'src/third_party/libsrtp':
   ...
   'src/third_party/angle_dx11':
      Var("git.chromium.org") + '/external/angle.git@57a045443cebf1bb035bfa9cc63d392d875136ed',
   'src/tools/grit':
