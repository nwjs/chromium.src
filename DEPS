...
#  
#  This DEPS file corresponds to Chromium 33.0.1703.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@9995e9b816fe8c303e4805bec23ed209114e9893',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@233649',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1703@161581',
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@12159',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@524',
   'build':
      '/trunk/tools/build@233713',
   'src/third_party/cld_2/src':
      Var("cld2") + '/trunk@84',
   'src/third_party/libsrtp':
