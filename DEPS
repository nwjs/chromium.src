...
#  
#  This DEPS file corresponds to Chromium 33.0.1750.117
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'android': {
      ...
      'src/third_party/openssl':
      '/branches/third_party/openssl/1750@250780',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1750@167220',
   'src/tools/deps2git':
   ...
   'src/third_party/snappy/src':
      Var("snappy") + '/trunk@80',
   'src/third_party/webrtc':
      Var("webrtc") + '/branches/3.48/webrtc@5451',
   'src/third_party/libjpeg_turbo':
