...
#  
#  This DEPS file corresponds to Chromium 30.0.1549.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/platform/system_api.git@6172a6226134e6005d286573c068d7642eafd4c0',
      ...
      'https://git.chromium.org/chromiumos/chromite.git@02741688d3fc9763047125f53770589033285ec5',
      'src/third_party/lss':
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@208806',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1549@153114',
   'src/third_party/jsoncpp/source/src/lib_json':
      Var("jsoncpp") + '/trunk/jsoncpp/src/lib_json@248',
   'src/testing/gmock':
      Var("googlemock") + '/trunk@410',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@11616',
   'src/third_party/smhasher/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@9768',
   'src/third_party/webpagereplay':
      Var("web-page-replay") + '/trunk@515',
   'build':
      '/trunk/tools/build@208822',
   ...
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@11616',
   'src/third_party/libphonenumber/src/test':
