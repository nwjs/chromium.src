...
#  
#  This DEPS file corresponds to Chromium 15.0.857.0
#  
#  
#  
deps_os = {
   'win': {
      ...
      'src/third_party/ffmpeg/binaries/chromium/win/ia32':
         '/trunk/deps/third_party/ffmpeg/binaries/win@97428',
   ...
   'mac': {
      'src/third_party/WebKit/WebKitLibraries':
         'http://svn.webkit.org/repository/webkit/trunk/WebKitLibraries@93328',
      'src/third_party/GTM':
   ...
   'unix': {
      ...
      'src/third_party/WebKit/Tools/gdb':
         'http://svn.webkit.org/repository/webkit/trunk/Tools/gdb@93328',
      'src/third_party/lss':
...
deps = {
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/xmlhttprequest@93328',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-cg-mac/storage/domstorage@93328',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium/fast/workers@93328',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/js/resources@93328',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/resources@93328',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/filesystem':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/filesystem@93328',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/events@93328',
   'src/third_party/bidichecker':
      'http://bidichecker.googlecode.com/svn/trunk/lib@4',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/workers@93328',
   'src/third_party/WebKit/Source':
      'http://svn.webkit.org/repository/webkit/trunk/Source@93328',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/workers@93328',
   'src/testing/gmock':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/filesystem/workers@93328',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/storage/domstorage@93328',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@19546',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/filesystem/resources':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/fast/filesystem/resources@93328',
   ...
   'src/third_party/WebKit/Tools/DumpRenderTree':
      'http://svn.webkit.org/repository/webkit/trunk/Tools/DumpRenderTree@93328',
   'src/third_party/hunspell':
      '/trunk/deps/third_party/hunspell@96723',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/appcache':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/http/tests/appcache@93328',
   'src/testing/gtest':
      'http://googletest.googlecode.com/svn/trunk@560',
   'src/v8':
      'http://v8.googlecode.com/svn/trunk@8958',
   'src/third_party/libvpx':
      '/trunk/deps/third_party/libvpx@97420',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/storage/domstorage@93328',
   ...
   'chromeos':
      '/trunk/src/tools/cros.DEPS@97442',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/fast/events@93328',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/fast/events':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-cg-mac/fast/events@93328',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/fast/workers@93328',
   'src/third_party/WebKit/Tools/Scripts':
      'http://svn.webkit.org/repository/webkit/trunk/Tools/Scripts@93328',
   'src/third_party/icu':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-cg-mac/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-cg-mac/http/tests/workers@93328',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'http://svn.webkit.org/repository/webkit/trunk/LayoutTests/platform/chromium-win/http/tests/workers@93328',
