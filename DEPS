...
#  
#  This DEPS file corresponds to Chromium 34.0.1832.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@31ff6f944151705290dea0d3b4b69c166fcde8ad',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1832@166771',
   'src/third_party/icu':
