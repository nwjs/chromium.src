...
#  
#  This DEPS file corresponds to Chromium 26.0.1393.1
#  
#  
#  
vars = {
...
deps = {
   ...
   'commit-queue':
      '/trunk/tools/commit-queue@178078',
   'src/breakpad/src':
   ...
   'src/third_party/skia/src':
      Var("skia") + '/trunk/src@7329',
   'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
      Var("native_client") + '/trunk/src/native_client/tests/prebuilt@10633',
   'src/third_party/smhasher/src':
      Var("smhasher") + '/trunk@147',
   'src/third_party/webrtc':
      Var("webrtc") + '/stable/webrtc@3402',
   'src/native_client':
      Var("native_client") + '/trunk/src/native_client@10633',
   'src/tools/page_cycler/acid3':
      '/trunk/deps/page_cycler/acid3@171600',
   'src/third_party/leveldatabase/src':
      Var("leveldb") + '/trunk@71',
   'build':
      '/trunk/tools/build@178489',
   'src/tools/gyp':
      Var("gyp") + '/trunk@1564',
   'src/chrome/test/data/perf/canvas_bench':
