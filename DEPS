...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@b0e89dcc1d8c1c2f9f7ffb45e8609cdb4a68104b',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@bfec4f1ea2e7018358ca311a4e9a6d8553fa7358',
  'src/breakpad/src':
