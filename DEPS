...
#  
#  This DEPS file corresponds to Chromium 35.0.1904.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@a427fb0737a0e3428cb8cc16b61251059884c4c2',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1904@169772',
   'src/third_party/icu':
