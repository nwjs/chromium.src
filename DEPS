...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@e04dd479f04b504511890ed6c6feae2b3772408f',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@3d9005c0286f2dff8f3db030c4c1ad19371deebd',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@e2ee9248e7c7b2a5a2f919f593290478b5905bb7'
}
