...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@400351f5494df90ee10b3155e2f0044a6f848ad3',
    'src/third_party/lss':
...
deps = {
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@070eaeec03a86c4760af4ca99a6406cad26b5a99',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@015281f4825615248a13ce183bc555103f57f5ee',
