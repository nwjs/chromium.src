...
#  
#  This DEPS file corresponds to Chromium 36.0.1973.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@c976305af43798e366eee932772d0c403f95dd21',
...
deps = {
   ...
   'depot_tools':
      '/trunk/tools/depot_tools@267973',
   'src/third_party/bidichecker':
      Var("bidichecker") + '/trunk/lib@4',
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1973@173267',
   'src/breakpad/src':
