...
#  
#  This DEPS file corresponds to Chromium 35.0.1901.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@22fd12f0dcdfef0125e234b4d6e2aee62b8e405e',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/branches/chromium/1901@169655',
   'src/third_party/icu':
