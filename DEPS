...
deps_os = {
  ...
  'unix': {
    ...
    'build/third_party/cbuildbot_chromite':
      (Var("git.chromium.org")) + '/chromiumos/chromite.git@2633687c2d7d97ee49785e6fa24a96cb6d89ac1f',
    'src/third_party/lss':
...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@292493',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@5bb9700b7ef952f2664e059afb4f9f137f7d5a7d',
  ...
  'src/native_client':
    (Var("git.chromium.org")) + '/native_client/src/native_client.git@fb58e927098b853a04818c2809b68b55b84af78f',
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@4a320055c198d9bd2578f2bf1951c1d166d60289',
  'src/breakpad/src':
