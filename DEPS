...
#  
#  This DEPS file corresponds to Chromium 4.0.249.16
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKitLibraries':
         '/branches/WebKit/249/WebKitLibraries@33015',
      'src/third_party/WebKit/WebKit/mac':
         '/branches/WebKit/249/WebKit/mac@33015',
...
deps = {
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      '/branches/WebKit/249/LayoutTests/fast/events@33015',
   'src/third_party/WebKit/WebKit/chromium':
      '/branches/WebKit/249/WebKit/chromium@33015',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      '/branches/WebKit/249/LayoutTests/http/tests/xmlhttprequest@33015',
   'src/third_party/protobuf2/src':
      'http://protobuf.googlecode.com/svn/trunk@219',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      '/branches/WebKit/249/LayoutTests/http/tests/workers@33015',
   'src/tools/gyp':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      '/branches/WebKit/249/LayoutTests/http/tests/resources@33015',
   'src/third_party/WebKit/LayoutTests':
      '/branches/WebKit/249/LayoutTests@33015',
   'src':
      '/branches/249/src@33062',
   'src/third_party/icu':
