...
deps = {
  'depot_tools':
    '/trunk/tools/depot_tools@280690',
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2078@177313',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@10722184fddc15cb2eced53db4a47867ae1924c9',
  ...
  'src/native_client':
    (Var("native_client")) + '/trunk/src/native_client@13420',
  ...
  'src/chrome/test/data/extensions/api_test/permissions/nacl_enabled/bin':
    (Var("native_client")) + '/trunk/src/native_client/tests/prebuilt@13420',
  ...
  'src/third_party/libvpx':
    '/trunk/deps/third_party/libvpx@279590',
