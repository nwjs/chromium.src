  ...
  'ios': {
    ...
    'unix': {
      ...
      'build/third_party/cbuildbot_chromite':
        (Var("git.chromium.org")) + '/chromiumos/chromite.git@8d08bff72c5474052cb205b97188ca8e29ec7005',
...
deps = {
  ...
  'src/third_party/WebKit':
    (Var("blink")) + '/branches/chromium/2101@178616',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@ad1df153a16b7723d2d4afd13627919fc3ee87ce',
  ...
  'src/third_party/pdfium':
    'https://pdfium.googlesource.com/pdfium.git@b72977f8c3efda2ceea6d25b1e042dfd6ea49c77',
  ...
  'src/third_party/snappy/src':
    (Var("snappy")) + '/trunk@80',
  'src/breakpad/src':
    (Var("google-breakpad")) + '/trunk/src@1351',
  ...
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@09020c2f08df11179b93e6548117806a4c0d0d45',
