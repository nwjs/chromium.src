...
#  
#  This DEPS file corresponds to Chromium 37.0.2004.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      Var("git.chromium.org") + '/chromiumos/chromite.git@fbf50480edf5bf87b4e61502361d253edc70c78d',
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@174310',
   'src/third_party/webrtc':
