...
#  
#  This DEPS file corresponds to Chromium 29.0.1546.0
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@c9a31190d0e0230253c72f6a3559d729d9eb2a4f',
      'src/third_party/lss':
...
deps = {
   ...
   'src/third_party/WebKit':
      Var("webkit_trunk")[:-6] + '/trunk@152906',
