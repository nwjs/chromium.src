...
deps = {
  ...
  'depot_tools':
    '/trunk/tools/depot_tools@295465',
  'src/breakpad/src':
  ...
  'src/third_party/WebKit':
    (Var("git.chromium.org")) + '/chromium/blink.git@91f36f7b10105ddbcc6890c7b6fbd4888af67508',
  'src/third_party/angle':
    (Var("git.chromium.org")) + '/angle/angle.git@4031b99416eca8a22e3193352d39294c2a1a023d',
  'src/third_party/bidichecker':
    (Var("git.chromium.org")) + '/external/bidichecker/lib.git@97f2aa645b74c28c57eca56992235c79850fa9e0',
  'src/third_party/boringssl/src':
    'https://boringssl.googlesource.com/boringssl.git@bd15a8e74894616ca8ad04fc2942b958f99000a1',
  ...
  'src/third_party/skia':
    (Var("git.chromium.org")) + '/skia.git@19663e54c017499406036746e7689193aa6417e6',
  ...
  'src/third_party/webrtc':
    (Var("git.chromium.org")) + '/external/webrtc/trunk/webrtc.git@3ca60f3a3dba13d48adfea07c988579b819aa5a8',
  ...
  'src/v8':
    (Var("git.chromium.org")) + '/v8/v8.git@bc6574d71ebc54599f4b49773fc5cae887d5e6ee'
}
