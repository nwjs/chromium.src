...
#  
#  This DEPS file corresponds to Chromium 27.0.1445.1
#  
#  
#  
vars = {
...
deps_os = {
   ...
   'unix': {
      ...
      'https://git.chromium.org/chromiumos/chromite.git@98f2a37a11ad03c0d1fa8ad7adc9b4ee916f5de5',
      'src/third_party/lss':
...
deps = {
   ...
   'build/third_party/swarm_client':
      '/trunk/tools/swarm_client@188726',
   'src':
      '/branches/1445/src@188767',
   'src/third_party/libyuv':
