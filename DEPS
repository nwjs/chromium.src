...
#  
#  This DEPS file corresponds to Chromium 6.0.467.0
#  
#  
#  
deps_os = {
   ...
   'mac': {
      ...
      'src/third_party/WebKit/WebKit/mac':
         'svn://svn.chromium.org/webkit-readonly/trunk/WebKit/mac@63323',
      'src/third_party/yasm/source/patched-yasm':
         '/trunk/deps/third_party/yasm/patched-yasm@50870',
      'src/third_party/WebKit/WebKitLibraries':
         'svn://svn.chromium.org/webkit-readonly/trunk/WebKitLibraries@63323',
...
deps = {
   ...
   'src/third_party/WebKit/WebCore':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebCore@63323',
   'src/third_party/ots':
      'http://ots.googlecode.com/svn/trunk@31',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium/fast/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium/fast/workers@63323',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/js/resources':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/fast/js/resources@63323',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/http/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-mac/http/tests/workers@63323',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/resources':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/http/tests/resources@63323',
   'src/chrome/test/data/layout_tests/LayoutTests/storage/domstorage':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/storage/domstorage@63323',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/fast/events':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/fast/events@63323',
   'src/chrome/test/data/layout_tests/LayoutTests/fast/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/fast/workers@63323',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/http/tests/workers@63323',
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/xmlhttprequest':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/http/tests/xmlhttprequest@63323',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/storage/domstorage':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/storage/domstorage@63323',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/http/tests/appcache':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/http/tests/appcache@63323',
   'src/testing/gtest':
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/events':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/fast/events@63323',
   'src/third_party/WebKit/JavaScriptCore':
      'svn://svn.chromium.org/webkit-readonly/trunk/JavaScriptCore@63323',
   'src/third_party/libvpx/lib':
      '/trunk/deps/third_party/libvpx/lib@50313',
   'src/third_party/WebKit/LayoutTests':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests@63323',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/fast/events':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-mac/fast/events@63323',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-mac/storage/domstorage':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-mac/storage/domstorage@63323',
   'src/tools/gyp':
      'http://gyp.googlecode.com/svn/trunk@836',
   'src/third_party/WebKit/WebKit/chromium':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebKit/chromium@63323',
   'src/chrome/test/data/layout_tests/LayoutTests/websocket/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/websocket/tests/workers@63323',
   'src/third_party/skia/src':
      'http://skia.googlecode.com/svn/trunk/src@583',
   'src/third_party/WebKit/WebKitTools/Scripts':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebKitTools/Scripts@63323',
   ...
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/fast/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/fast/workers@63323',
   'src/third_party/WebKit/WebKitTools/DumpRenderTree':
      'svn://svn.chromium.org/webkit-readonly/trunk/WebKitTools/DumpRenderTree@63323',
   'src/third_party/icu':
      '/trunk/deps/third_party/icu42@51076',
   'src/chrome/test/data/layout_tests/LayoutTests/platform/chromium-win/http/tests/workers':
      'svn://svn.chromium.org/webkit-readonly/trunk/LayoutTests/platform/chromium-win/http/tests/workers@63323',
