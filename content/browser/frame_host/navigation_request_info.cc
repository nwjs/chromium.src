...
NavigationRequestInfo::NavigationRequestInfo(
    ...
    const base::UnguessableToken& devtools_frame_token, bool nw_trusted)
    : common_params(common_params),
      ...
      devtools_frame_token(devtools_frame_token), nw_trusted(nw_trusted) {}
...
NavigationRequestInfo::NavigationRequestInfo(const NavigationRequestInfo& other)
    : common_params(other.common_params),
      ...
      devtools_frame_token(other.devtools_frame_token), nw_trusted(other.nw_trusted) {}
