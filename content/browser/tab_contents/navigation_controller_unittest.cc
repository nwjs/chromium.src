...
TEST_F(NavigationControllerTest, CopyStateFromAndPrune) {
  ...
  EXPECT_EQ(0, other_controller.GetEntryAtIndex(0)->page_id());
  EXPECT_EQ(1, other_controller.GetEntryAtIndex(1)->page_id());
  EXPECT_EQ(0, other_controller.GetEntryAtIndex(2)->page_id());
