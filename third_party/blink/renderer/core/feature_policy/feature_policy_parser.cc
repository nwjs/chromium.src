...
ParsedFeaturePolicy FeaturePolicyParser::ParseHeader(
    ...
    ExecutionContext* execution_context) {
  internal::ParsingContext context(logger, origin, nullptr, GetDefaultFeatureNameMap(),
                         execution_context);
  auto policy_ir =
...
ParsedFeaturePolicy FeaturePolicyParser::ParseAttribute(
    ...
    PolicyParserMessageBuffer& logger,
    ExecutionContext* execution_context) {
  internal::ParsingContext context(logger, self_origin, src_origin,
...
ParsedFeaturePolicy FeaturePolicyParser::ParseFeaturePolicyForTest(
    ...
    const FeatureNameMap& feature_names,
    ExecutionContext* execution_context) {
  internal::ParsingContext context(logger, self_origin, src_origin, feature_names,
                         execution_context);
  return context.ParseIR(context.ParseFeaturePolicyToIR(policy));
}
