...
#endif
  case base::MessageLoop::Type::NODE:
    return mojo_base::mojom::MessageLoopType::kNode;
  }
  NOTREACHED();
  return mojo_base::mojom::MessageLoopType::kDefault;
}
  ...
  switch (input) {
    ...
    case mojo_base::mojom::MessageLoopType::kUiWithWmQuitSupport:
      *output = base::MessageLoop::Type::UI_WITH_WM_QUIT_SUPPORT;
      return true;
#endif
  case mojo_base::mojom::MessageLoopType::kNode:
    *output = base::MessageLoop::Type::NODE;
    return true;
  }
  return false;
}
