...
bool ChromeContentBrowserClient::ShouldTryToUseExistingProcessHost(
  ...
  // other extensions loading before nw app: case 6324 broken after
  // https://chromium-review.googlesource.com/c/chromium/src/+/6691579
  // https://chromium-review.googlesource.com/c/chromium/src/+/6006321
  // as the url is empty
  if (url.is_empty() && !content::RenderProcessHostImpl::main_host())
    return false;
