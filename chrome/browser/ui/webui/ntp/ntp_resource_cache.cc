...
// The URL for the "Learn More" link that appears in the Other Devices menu when
// there is no foreign session data.
const char kOtherSessionsLearnMoreUrl[] =
    "http://support.google.com/chrome/bin/answer.py?answer=185277";
...
void NTPResourceCache::CreateNewTabHTML() {
  ...
  localized_strings.SetString("otherSessionsLearnMoreUrl",
      GetUrlWithLang(GURL(kOtherSessionsLearnMoreUrl)));
