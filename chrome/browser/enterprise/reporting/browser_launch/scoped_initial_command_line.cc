...
//
// NW: mark this fallback weak. libnw.so links chrome_main.cc together with this
// object via a --whole-archive solink, which force-loads this fallback and
// collides with chrome_main.cc's strong definition. The weak attribute lets the
// strong definition win, matching the fallback semantics described above.
__attribute__((weak))
